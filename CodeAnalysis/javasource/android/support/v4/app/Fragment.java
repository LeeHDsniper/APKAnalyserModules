  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  {
    if (mIFragmentLifecycleCallback != null) {
      mIFragmentLifecycleCallback.onFragmentHiddenChanged(this, paramBoolean);
    }
  }
  ...
  {
    mCalled = true;
    if ((!mHidden) && (mIFragmentLifecycleCallback != null)) {
      mIFragmentLifecycleCallback.onFragmentHiddenChanged(this, true);
    }
  }
  ...
  public void onResume()
  {
    mCalled = true;
    if ((!mHidden) && (mIFragmentLifecycleCallback != null)) {
      mIFragmentLifecycleCallback.onFragmentHiddenChanged(this, mHidden);
    }
  }
  ...
  {
    mIFragmentLifecycleCallback = paramIFragmentLifecycleCallback;
  }
