...
public class AdobeAssetDrawPage
  extends AdobeAssetFile
{
  public AdobeAssetPackagePages _package;
  public int pageNumber;
  
  public AdobeAssetDrawPage(String paramString, int paramInt, AdobeDCXComponent paramAdobeDCXComponent, AdobeAssetPackagePages paramAdobeAssetPackagePages)
  {
    name = paramString;
    pageNumber = paramInt;
  ...
  {
    if ((paramObject instanceof AdobeAssetDrawPage)) {
