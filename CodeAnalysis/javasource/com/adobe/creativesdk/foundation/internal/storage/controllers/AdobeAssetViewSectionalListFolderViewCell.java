...
public class AdobeAssetViewSectionalListFolderViewCell
  extends AdobeAssetViewListBaseCellView
{
  private boolean _isSharedFolder = false;
  
  public AdobeAssetViewSectionalListFolderViewCell() {}
  
  protected void handleOnFinishInflate()
  {
    _titleView = ((TextView)findViewById(R.id.assetview_assetlist_foldercell_title));
    _imageViewAssetPicture = ((ImageView)findViewById(R.id.assetview_assetlist_foldercell_image));
  }
