...
public class AdobeAssetCompFile
  extends AdobeAssetPackagePages
{
  public AdobeAssetCompFile() {}
  
  public AdobeAssetCompFile(AdobeStorageResourceCollection paramAdobeStorageResourceCollection1, AdobeStorageResourceCollection paramAdobeStorageResourceCollection2)
  {
  ...
  {
    if ((paramObject instanceof AdobeAssetCompFile)) {
        ...
        for (;;)
        {
          if (((Iterator)localObject).hasNext())
          {
            ...
            if ((localAdobeDCXComponent.getRelationship() != null) && (localAdobeDCXComponent.getRelationship().equals("rendition")) && (localAdobeDCXComponent != null)) {
              localArrayList.add(new AdobeAssetCompPage(localAdobeDCXComponent.getName(), i, localAdobeDCXComponent, jdField_this));
            }
          }
          else
          {
