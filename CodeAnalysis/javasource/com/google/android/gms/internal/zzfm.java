...
public abstract interface zzfm
  extends IInterface
{
    ...
    implements zzfm
  {
    ...
    public static zzfm zzO(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzfm))) {
        return (zzfm)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      zza(zzfl.zza.zzN(paramParcel1.readStrongBinder()));
      ...
      implements zzfm
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzfm$zza$zza:zznI	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
