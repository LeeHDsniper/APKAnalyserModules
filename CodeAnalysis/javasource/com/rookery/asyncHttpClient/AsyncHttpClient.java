...
public class AsyncHttpClient
{
      ...
      try
      {
        ...
        for (;;)
        {
          try
          {
            ...
            ((SSLSocketFactory)localObject2).setHostnameVerifier(new ezy(this));
            ...
            jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient = new DefaultHttpClient((ClientConnectionManager)localObject1, localBasicHttpParams);
            jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient.addRequestInterceptor(new ezz(this));
            jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient.addResponseInterceptor(new faa(this));
            jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient.setHttpRequestRetryHandler(new fae(3));
  ...
  public static String a(String paramString, List paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        ((List)localObject).add(new BasicNameValuePair((String)first, (String)second));
      }
  ...
  public void a(Context paramContext, String paramString, Header[] paramArrayOfHeader, List paramList, AsyncHttpResponseHandler paramAsyncHttpResponseHandler)
  {
    ...
    a(jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient, jdField_a_of_type_OrgApacheHttpProtocolHttpContext, paramString, null, paramAsyncHttpResponseHandler, paramContext);
  }
  ...
  public void a(Context paramContext, String paramString1, Header[] paramArrayOfHeader, HttpEntity paramHttpEntity, String paramString2, AsyncHttpResponseHandler paramAsyncHttpResponseHandler)
  {
    ...
    a(jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient, jdField_a_of_type_OrgApacheHttpProtocolHttpContext, paramString1, paramString2, paramAsyncHttpResponseHandler, paramContext);
  }
  
  public void a(Context paramContext, boolean paramBoolean)
  {
    Object localObject = (List)jdField_a_of_type_JavaUtilMap.get(paramContext);
    if (localObject != null)
    {
    ...
    jdField_a_of_type_JavaUtilMap.remove(paramContext);
  }
  ...
  protected void a(DefaultHttpClient paramDefaultHttpClient, HttpContext paramHttpContext, HttpUriRequest paramHttpUriRequest, String paramString, AsyncHttpResponseHandler paramAsyncHttpResponseHandler, Context paramContext)
  {
    ...
    paramHttpUriRequest = jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor.submit(new fac(paramDefaultHttpClient, paramHttpContext, paramHttpUriRequest, paramAsyncHttpResponseHandler));
    if (paramContext != null)
    {
      paramHttpContext = (List)jdField_a_of_type_JavaUtilMap.get(paramContext);
      paramDefaultHttpClient = paramHttpContext;
      if (paramHttpContext == null)
      {
        paramDefaultHttpClient = new LinkedList();
        jdField_a_of_type_JavaUtilMap.put(paramContext, paramDefaultHttpClient);
      }
