...
public class d
{
  ...
  private void c(String paramString)
  {
    ...
    {
      l = paramString;
      k = Base64.encodeToString(f.a(paramString), 2);
      return;
    }
    finally
    {
  ...
  public final boolean f()
  {
    if (g != null)
    {
      String str = (String)g.get("updateQimei");
  ...
  public final int g()
  {
    if (g != null)
    {
      String str = (String)g.get("maxQIMEIQueryOneDay");
  ...
  public final int h()
  {
    if (g != null)
    {
      String str = (String)g.get("maxStrategyQueryOneDay");
      if ((str != null) && (!str.trim().equals("")))
      {
        int n = e;
        try
