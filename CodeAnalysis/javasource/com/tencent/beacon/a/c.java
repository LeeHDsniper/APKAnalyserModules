...
public abstract class c
{
    ...
    extends c
  {
    ...
    public final void a(int paramInt)
    {
      try
      {
        ScheduledFuture localScheduledFuture = (ScheduledFuture)c.get(paramInt);
    ...
    public final void a(int paramInt, Runnable paramRunnable, long paramLong1, long paramLong2)
    {
      ...
      {
        a(paramInt);
        paramRunnable = b.scheduleAtFixedRate(paramRunnable, l, paramLong1, TimeUnit.MILLISECONDS);
        if (paramRunnable == null) {
          break;
        }
        a.b("add a new future! taskId: %d , periodTime: %d", new Object[] { Integer.valueOf(paramInt), Long.valueOf(paramLong1) });
        c.put(paramInt, paramRunnable);
        break;
        paramLong2 = 10000L;
        break label128;
    ...
    public final void a(Runnable paramRunnable, long paramLong)
    {
      ...
      for (;;)
      {
        b.schedule(paramRunnable, paramLong, TimeUnit.MILLISECONDS);
        break;
        paramLong = 0L;
      }
    }
