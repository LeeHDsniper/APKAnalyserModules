...
public final class b
{
  ...
  {
    b = paramContext;
    k.a(Byte.valueOf((byte)0));
    com.tencent.beacon.a.c.a().a(q);
  }
    ...
    if ((c != null) && (c.size() > 0))
    {
      ...
      if (localIterator1.hasNext())
      {
        ...
        if (localIterator2.hasNext())
        {
          ...
          localStringBuilder2 = localStringBuilder1.append(a).append(",").append(b).append(",");
          if (!c) {
            break label242;
          }
        }
        ...
        {
          localStringBuilder2.append(str).append(",").append(d).append(",").append(e).append(",").append(f).append(",").append(g).append(",").append(h).append(",").append(i).append(",").append(j).append(";");
          break label74;
          break;
        }
      }
  ...
  public final void a()
  {
    ...
    {
      f();
      long l1 = ((Long)f.a()).longValue();
      f.a(Long.valueOf(l1 + 1L));
      e();
      return;
    }
    catch (Exception localException)
  ...
  public final void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        f();
        long l1 = ((Long)h.a()).longValue();
        h.a(Long.valueOf(l1 + paramInt));
        if (paramInt > 1)
        {
          com.tencent.beacon.a.c.a().a(p);
          return;
  ...
  public final void b()
  {
    ...
    {
      f();
      long l1 = ((Long)g.a()).longValue();
      g.a(Long.valueOf(l1 + 1L));
      e();
      return;
    }
    catch (Exception localException)
  ...
  public final void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        f();
        long l1 = ((Long)i.a()).longValue();
        i.a(Long.valueOf(l1 + paramInt));
        if (paramInt > 1)
        {
          com.tencent.beacon.a.c.a().a(p);
          return;
  ...
  public final void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        f();
        long l1 = ((Long)j.a()).longValue();
        j.a(Long.valueOf(l1 + paramInt));
        if (paramInt > 1)
        {
          com.tencent.beacon.a.c.a().a(p);
          return;
