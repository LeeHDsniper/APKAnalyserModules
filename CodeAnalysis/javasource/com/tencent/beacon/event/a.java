...
public final class a
{
  ...
  public a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt)
  {
    ...
    if (c)
    {
      paramContext = com.tencent.beacon.a.b.b(a, g, "");
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          if ((processName.startsWith("android")) || (processName.startsWith("com.android."))) {
            continue;
          }
          if (uid >= 10000) {
            continue;
  ...
  private List<String> c(boolean paramBoolean)
  {
    ...
    //   107	156	6	localStringBuilder	StringBuilder
    // Exception table:
    //   from	to	target	type
