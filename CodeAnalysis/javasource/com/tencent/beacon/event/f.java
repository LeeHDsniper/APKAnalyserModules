  ...
  implements Runnable
{
  ...
  private void a()
  {
    try
    {
      if (!d)
      {
        ...
        e = b.b(b, "on_ua_date", "");
        f.set(b.b(b, "on_normal_ua_times"));
        g.set(b.b(b, "on_sdk_ua_times"));
        h.set(b.b(b, "on_specified_ua_times"));
        a.a("load serial from sp, normalesn: %d, sdkesn: %d, spesn: %d", new Object[] { Long.valueOf(f.get()), Long.valueOf(g.get()), Long.valueOf(h.get()) });
        c();
        d = true;
      }
      return;
  ...
  private void b()
  {
    try
    {
      if (!com.tencent.beacon.a.f.n().equals(e))
      {
        f.set(0L);
        g.set(0L);
        h.set(0L);
        e = com.tencent.beacon.a.f.n();
        c();
        if (!j)
        {
          j = true;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString.startsWith("rqd_"))
        {
          ...
          {
            localStringBuilder.append(h.addAndGet(1L));
            if (!j)
            {
              j = true;
              c.a().a(this);
      ...
      localStringBuilder.append(g.addAndGet(1L));
      continue;
      label150:
      localStringBuilder.append(f.addAndGet(1L));
    }
  }
  ...
  public final void run()
  {
    if (j)
    {
      SharedPreferences.Editor localEditor = b.k(b);
      localEditor.putString("on_ua_date", e);
      localEditor.putLong("on_normal_ua_times", f.get());
      localEditor.putLong("on_sdk_ua_times", g.get());
      localEditor.putLong("on_specified_ua_times", h.get());
      localEditor.commit();
      j = false;
    }
  }
