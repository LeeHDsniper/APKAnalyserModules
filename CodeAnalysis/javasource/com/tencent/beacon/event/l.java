  ...
  implements j
{
  ...
  {
    c = paramContext;
    b = Collections.synchronizedList(new ArrayList(25));
  }
  ...
  private void d()
  {
    ...
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      ...
      localObject = f.a(c, (List)localObject);
      if (localObject != null) {
        dd.b(localObject.length);
      }
    }
  }
  ...
  protected final void a()
  {
    ...
    localH.a(new a(c, (List)localObject));
  }
  ...
  public final boolean a(k paramK)
  {
    ...
    for (;;)
    {
      ...
      b.add(paramK);
      if (b.size() >= i) {
        com.tencent.beacon.d.a.c(" err BF 3R! num:" + b.size(), new Object[0]);
      }
    ...
    extends com.tencent.beacon.upload.a
  {
    ...
    public a(Context paramContext, List<k> paramList)
    {
      ...
      g = paramContext;
      e = f.size();
      if ((f.size() == 1) && ("rqd_heartbeat".equals(((k)f.get(0)).d()))) {
        i = true;
      }
      d = f.b(paramContext, 2);
      com.tencent.beacon.d.a.a("real rid:%s", new Object[] { d });
    }
