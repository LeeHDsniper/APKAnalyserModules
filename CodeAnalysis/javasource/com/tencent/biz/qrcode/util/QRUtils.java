...
public class QRUtils
{
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramContext)
        {
          try
          {
            ...
            paramContext = BitmapFactory.decodeResource(paramContext.getResources(), 2130838381);
  ...
  public static String a(Context paramContext, String paramString, Bitmap paramBitmap)
  {
    ...
    //   4: aconst_null
    //   5: areturn
    //   6: getstatic 453	android/os/Build$VERSION:SDK_INT	I
    //   9: bipush 8
    //   11: if_icmplt +122 -> 133
    //   14: aload_0
    //   15: invokevirtual 457	android/content/Context:getExternalCacheDir	()Ljava/io/File;
    //   18: astore_3
    //   19: aload_3
    //   20: astore 4
    //   22: aload_3
    //   23: ifnonnull +9 -> 32
    //   26: aload_0
    //   27: invokevirtual 460	android/content/Context:getCacheDir	()Ljava/io/File;
    //   30: astore 4
    //   32: aload 4
    //   34: ifnull -30 -> 4
    //   37: aload 4
    //   39: invokevirtual 465	java/io/File:canWrite	()Z
    //   42: ifeq -38 -> 4
    //   45: new 242	java/lang/StringBuilder
    //   48: dup
    //   49: invokespecial 243	java/lang/StringBuilder:<init>	()V
    //   52: aload 4
    //   54: invokevirtual 468	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   57: invokevirtual 251	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   60: getstatic 471	java/io/File:separator	Ljava/lang/String;
    //   63: invokevirtual 251	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   66: aload_1
    ...
    //   73: astore_3
    //   74: new 462	java/io/File
    //   77: dup
    //   78: aload_3
    //   79: invokespecial 474	java/io/File:<init>	(Ljava/lang/String;)V
    //   82: astore_0
    //   83: aload_0
    //   84: invokevirtual 477	java/io/File:exists	()Z
    //   87: ifeq +8 -> 95
    //   90: aload_0
    //   91: invokevirtual 480	java/io/File:delete	()Z
    //   94: pop
    //   95: new 482	java/io/FileOutputStream
    //   98: dup
    //   99: aload_0
    //   100: invokespecial 485	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   103: astore_1
    //   104: aload_1
    //   105: astore_0
    //   106: aload_2
    //   107: getstatic 491	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   110: bipush 100
    //   112: aload_1
    //   113: invokevirtual 495	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   116: pop
    //   117: aload_1
    //   118: astore_0
    //   119: aload_1
    //   120: invokevirtual 498	java/io/FileOutputStream:flush	()V
    //   123: aload_1
    //   124: ifnull +7 -> 131
    //   127: aload_1
    //   128: invokevirtual 501	java/io/FileOutputStream:close	()V
    //   131: aload_3
    //   132: areturn
    //   133: new 462	java/io/File
    //   136: dup
    //   137: invokestatic 506	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   140: new 242	java/lang/StringBuilder
    //   143: dup
    //   144: invokespecial 243	java/lang/StringBuilder:<init>	()V
    //   147: ldc_w 508
    //   150: invokevirtual 251	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   153: aload_0
    //   154: invokevirtual 511	android/content/Context:getPackageName	()Ljava/lang/String;
    //   157: invokevirtual 251	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   160: ldc_w 513
    //   163: invokevirtual 251	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   166: invokevirtual 256	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   169: invokespecial 516	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   172: astore_3
    //   173: aload_3
    //   174: invokevirtual 519	java/io/File:mkdirs	()Z
    //   177: pop
    //   178: goto -159 -> 19
    //   181: astore_0
    //   182: aload_0
    //   183: invokevirtual 520	java/io/IOException:printStackTrace	()V
    //   186: goto -55 -> 131
    //   189: astore_2
    //   190: aconst_null
    //   191: astore_1
    ...
    //   193: astore_0
    //   194: aload_2
    //   195: invokevirtual 521	java/io/FileNotFoundException:printStackTrace	()V
    //   198: aload_1
    //   199: ifnull -195 -> 4
    //   202: aload_1
    //   203: invokevirtual 501	java/io/FileOutputStream:close	()V
    //   206: aconst_null
    //   207: areturn
    //   208: astore_0
    //   209: aload_0
    //   210: invokevirtual 520	java/io/IOException:printStackTrace	()V
    //   213: aconst_null
    //   214: areturn
    //   215: astore_2
    //   216: aconst_null
    ...
    //   219: astore_0
    //   220: aload_2
    //   221: invokevirtual 520	java/io/IOException:printStackTrace	()V
    //   224: aload_1
    //   225: ifnull -221 -> 4
    //   228: aload_1
    //   229: invokevirtual 501	java/io/FileOutputStream:close	()V
    //   232: aconst_null
    //   233: areturn
    //   234: astore_0
    //   235: aload_0
    //   236: invokevirtual 520	java/io/IOException:printStackTrace	()V
    //   239: aconst_null
    //   240: areturn
    //   241: astore_1
    //   242: aconst_null
    ...
    //   245: ifnull +7 -> 252
    //   248: aload_0
    //   249: invokevirtual 501	java/io/FileOutputStream:close	()V
    //   252: aload_1
    //   253: athrow
    //   254: astore_0
    //   255: aload_0
    //   256: invokevirtual 520	java/io/IOException:printStackTrace	()V
    //   259: goto -7 -> 252
    //   262: astore_1
    //   263: goto -19 -> 244
    //   266: astore_2
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2, String paramString3, QRCodeEncodeCallback paramQRCodeEncodeCallback)
  {
    ...
    paramString2 = new gwh(paramQRCodeEncodeCallback);
  ...
  public static boolean d(String paramString)
  {
    ...
    return paramString.startsWith("http://vac.qq.com/wallet/qrcode.htm");
  }
  ...
  {
    return (e(paramString)) && ((paramString.startsWith("http:")) || (paramString.startsWith("https:")) || (paramString.startsWith("www.")));
  }
