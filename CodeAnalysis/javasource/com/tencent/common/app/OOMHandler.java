  ...
  implements ISkinEngineLog, SkinEngineHandler
{
  ...
  public boolean onDecodeOOM(OutOfMemoryError paramOutOfMemoryError, String paramString, boolean paramBoolean)
  {
    if (jdField_a_of_type_Int == -1) {
      jdField_a_of_type_Int = ((ActivityManager)jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getSystemService("activity")).getMemoryClass();
    }
    ...
    paramOutOfMemoryError.put("param_heapSize", Integer.toString(jdField_a_of_type_Int));
    ...
    try
    {
      StatisticCollector.a(jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a(null, "report_resource_decode_OOM", false, 0L, 0L, paramOutOfMemoryError, "");
      if (BaseApplicationImpl.a != null) {
  ...
  public boolean onDecodeReturnNullBitmap(String paramString, boolean paramBoolean)
  {
    ...
    paramString.put("param_heapSize", Integer.toString(jdField_a_of_type_Int));
    paramString.put("param_apiLevel", Integer.toString(Build.VERSION.SDK_INT));
    paramString.put("param_cacheUsed", Long.toString(l));
    try
    {
      StatisticCollector.a(jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a(null, "report_resource_decode_OOM", false, 0L, 0L, paramString, "");
