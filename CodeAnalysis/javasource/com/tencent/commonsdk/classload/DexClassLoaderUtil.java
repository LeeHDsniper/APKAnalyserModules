...
public class DexClassLoaderUtil
{
    ...
    implements Runnable
  {
    ...
    CheckMD5Task(File paramFile1, String paramString1, String paramString2, File paramFile2, File paramFile3)
    {
      ...
      oldMD5 = paramString2;
      infoFile = paramFile2;
      tempInfoFile = paramFile3;
    }
    
    public void run()
    {
      String str = MD5Coding.encodeFile2HexStr(file.getAbsolutePath());
      if (oldMD5 == null) {
        DexClassLoaderUtil.saveInfo(infoFile, tempInfoFile, info, str);
      }
      while (oldMD5.equalsIgnoreCase(str)) {
        return;
      }
      file.delete();
      infoFile.delete();
