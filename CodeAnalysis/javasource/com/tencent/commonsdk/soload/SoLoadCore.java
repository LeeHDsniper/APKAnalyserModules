...
public class SoLoadCore
{
  ...
  private static String getCurProcessName(Context paramContext)
  {
    ...
    if (paramContext != null)
    {
      ...
      while (paramContext.hasNext())
      {
        ...
        if ((processName.startsWith("com.tencent.mobileqq")) && (pid == i)) {
          return processName + "_" + i;
        }
      }
    }
    return null;
  ...
  public static String getReleasedSoFilePath(Context paramContext, String paramString)
  {
    ...
    } while ((paramContext == null) || (mCrcvalue != l));
    return mSopath;
  }
  ...
  static int loadSo(Context paramContext, String paramString)
  {
    ...
    if (((File)localObject1).exists())
    {
      ...
      if (paramString != null)
      {
        if (mSopath.contains("/txlib/")) {}
        for (i = j | 0x4000;; i = j | 0x8000)
        {
          localObject2 = new File(mSopath);
          j = i | 0x2000;
          i = j;
          if (mCrcvalue != l1) {
            break;
  ...
  public static String releaseSo(Context paramContext, String paramString)
  {
    ...
    if ((localFile.exists()) && (localFile.isFile()))
    {
      ...
      if (paramString != null)
      {
        localObject1 = new File(mSopath);
        if ((mCrcvalue == l1) && (((File)localObject1).exists()))
        {
