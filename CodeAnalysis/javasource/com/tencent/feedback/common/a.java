...
public final class a
{
  ...
  public static String a(Context paramContext)
  {
    ...
    try
    {
      paramContext = getPackageManagergetApplicationInfogetPackageName128metaData.get("APPKEY_DENGTA");
      if (paramContext != null)
      {
      ...
      while (paramContext.hasNext())
      {
        ...
        if (importance == 100)
        {
          ...
          while (i < j)
          {
            ...
            {
              e.b("rqdp{  current seen pn:}%s", new Object[] { processName });
              return true;
            }
            i += 1;
          }
  ...
  private static boolean c(Context paramContext, String paramString)
  {
    ...
    try
    {
      paramContext = getPackageManagergetPackageInfogetPackageName4096requestedPermissions;
      if (paramContext != null)
      {
  ...
  public static String d(Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramContext = metaData.get("com.tencent.rdm.uuid");
        if (paramContext != null)
        {
          paramContext = paramContext.toString();
