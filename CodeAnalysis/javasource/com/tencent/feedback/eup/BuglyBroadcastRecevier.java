  ...
  extends BroadcastReceiver
{
  ...
  {
    monierHandler = paramProcessMoniterHandler;
  }
  ...
  public void addFilter(String paramString)
  {
    try
    {
      if (!mFilter.hasAction(paramString)) {
        mFilter.addAction(paramString);
      }
  ...
  protected final boolean processOtherProcessLaunched(Context paramContext, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        monierHandler.onOtherAppProcessLaunched((String)localObject, paramIntent.getString("com.tencent.feedback.P02"), paramIntent.getBoolean("com.tencent.feedback.P03"), paramIntent);
  ...
  public void regist(Context paramContext)
  {
    try
    {
      ...
      paramContext.registerReceiver(this, mFilter);
