  ...
  extends AbstractUploadDatas
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramE.c())
        {
          ...
          I localI = new I();
          a = getValueplugInId;
          c = getValueplugInUUID;
          d = getValueplugInVersion;
          n.add(localI);
          continue;
        }
        localObject1 = "101";
      ...
      else
      {
        ...
        if ((paramE.c()) && (paramE.m() > 1))
        {
          ...
          if ((paramE.l() != null) && (paramE.l().length() > 0))
          {
            ...
            o.add(new K((byte)1, "alltimes.txt", paramE.l().getBytes("utf-8")));
          }
        }
        if (paramE.n() != null)
        {
          ...
          o.add(new K((byte)1, "log.txt", paramE.n()));
        }
        ...
        try
        {
          o.add(new K((byte)1, "anrMessage.txt", paramE.s().getBytes("utf8")));
          ...
          p.put("A10", paramE.H());
          p.put("A23", paramE.N());
          p.put("A7", ((c)localObject1).d());
          p.put("A6", ((c)localObject1).w());
          p.put("A5", ((c)localObject1).v());
          p.put("A22", ((c)localObject1).h());
          p.put("A2", paramE.J());
          p.put("A1", paramE.I());
          p.put("A24", ((c)localObject1).f());
          p.put("A17", paramE.K());
          p.put("A3", ((c)localObject1).o());
          p.put("A16", ((c)localObject1).q());
          p.put("A25", ((c)localObject1).r());
          p.put("A14", ((c)localObject1).p());
          p.put("A15", ((c)localObject1).z());
          p.put("A13", ((c)localObject1).C());
          p.put("A34", paramE.q());
          p.put("A30", paramE.B());
          localObject2 = p;
        ...
        catch (UnsupportedEncodingException localUnsupportedEncodingException)
        {
          for (;;)
          {
            try
            {
              p.put("A26", URLEncoder.encode(paramE.y(), "utf-8"));
              if (a >= 0) {
                p.put("C01", a);
              }
              if (b >= 0) {
              ...
              paramContext = c.entrySet().iterator();
              if (!paramContext.hasNext()) {
                break;
              }
              localObject1 = (Map.Entry)paramContext.next();
              p.put("C03_" + (String)((Map.Entry)localObject1).getKey(), ((Map.Entry)localObject1).getValue());
              continue;
        ...
        if ((d != null) && (d.size() > 0))
        {
          paramContext = d.entrySet().iterator();
          while (paramContext.hasNext())
          {
            paramE = (Map.Entry)paramContext.next();
            p.put("C04_" + (String)paramE.getKey(), paramE.getValue());
          }
        }
        return localL;
      }
  ...
  private static ArrayList<I> b(Context paramContext)
  {
    try
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        com.tencent.feedback.common.e.b("up %s %s %s", new Object[] { b, a, c });
        continue;
        return null;
      }
    }
  ...
  public final N a()
  {
    ...
    for (;;)
    {
      ...
      finally
      {
        try
        {
          ...
          try
          {
            ...
            if (!com.tencent.feedback.common.g.a(c)) {
              break label260;
            }
          ...
          com.tencent.feedback.common.e.c("rqdp{ eup error remove} %d", new Object[] { Integer.valueOf(b.a(c, f)) });
          f = null;
          localObject2 = localObject5;
        }
      ...
      continue;
      label295:
      com.tencent.feedback.common.e.b("rqdp{  pack n:}%d ,isM:%b", new Object[] { Integer.valueOf(f.size()), Boolean.valueOf(bool) });
      Object localObject6 = a(c, f);
