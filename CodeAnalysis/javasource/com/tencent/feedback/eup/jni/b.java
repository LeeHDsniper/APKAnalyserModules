  ...
  implements NativeExceptionHandler
{
  ...
  public final void handleNativeException(int paramInt1, int paramInt2, long paramLong1, long paramLong2, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt3, String paramString5, int paramInt4, int paramInt5, int paramInt6, String paramString6, String paramString7)
  {
    ...
    bool = com.tencent.feedback.anr.b.a(a).a();
    String str1;
    String str2;
    Object localObject3;
    Object localObject2;
      ...
      do
      {
        ...
        catch (Throwable paramString6)
        {
          try
          {
            for (;;)
            {
              ...
              paramString4 = a(a, paramLong1, paramString1, paramString2, paramString3, paramString4, paramInt3, paramString5, paramInt4, str1, str2, (String)localObject1, paramString7);
        ...
        for (;;)
        {
          try
          {
            ...
            BuglyBroadcastRecevier.brocastCrash(a, paramString4);
            if (!bool) {
              break label824;
            }
          }
          ...
          try
          {
            paramString1 = com.tencent.feedback.eup.c.a(a);
