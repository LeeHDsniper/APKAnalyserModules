...
public class l
{
  ...
  public static int a(Context paramContext, Long[] paramArrayOfLong)
  {
    ...
    //   7	362	11	localStringBuffer	StringBuffer
    // Exception table:
    //   from	to	target	type
  ...
  public static ContentValues a(l paramL)
  {
    ...
    localContentValues.put("_prority", Integer.valueOf(c));
    localContentValues.put("_time", Long.valueOf(d));
    localContentValues.put("_type", Integer.valueOf(b));
    localContentValues.put("_datas", e);
    localContentValues.put("_length", Long.valueOf(f));
    localContentValues.put("_key", g);
  ...
  public static List<l> a(Context paramContext, int[] paramArrayOfInt, int paramInt1, int paramInt2, long paramLong1, int paramInt3, String paramString, int paramInt4, int paramInt5, int paramInt6, int paramInt7, long paramLong2, long paramLong3, int paramInt8)
  {
    ...
    //   1372	274	25	localStringBuffer	StringBuffer
  ...
  protected static List<l> a(Cursor paramCursor)
  {
    ...
    {
      l localL = new l();
      a = paramCursor.getLong(k);
      e = paramCursor.getBlob(i2);
      c = paramCursor.getInt(m);
      d = paramCursor.getLong(n);
      b = paramCursor.getInt(i1);
      f = paramCursor.getLong(i3);
      g = paramCursor.getString(i4);
