  ...
  implements URLDrawable.URLDrawableListener
{
  ...
  {
    if (listener != null) {
      listener.onLoadCancelled(this, paramURLDrawable);
    }
  }
  ...
  public void onLoadFialed(URLDrawable paramURLDrawable, Throwable paramThrowable)
  {
    ...
    {
      if (listener != null) {
        listener.onLoadFailed(this, paramURLDrawable, null);
      }
      return;
  ...
  {
    if (listener != null) {
      listener.onLoadProgressed(this, paramURLDrawable, paramInt);
    }
  }
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    {
      if (listener != null) {
        listener.onLoadSuccessed(this, paramURLDrawable);
      }
      return;
      if (getBackground() == paramURLDrawable)
      {
  ...
  {
    listener = paramURLDrawableDownListener;
  }
}
