  ...
  implements View.OnClickListener
{
  ...
  private Bitmap a()
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: invokevirtual 32	com/tencent/mobileqq/activity/ShortcutGuideActivity:getIntent	()Landroid/content/Intent;
    //   6: ldc 34
    //   8: invokevirtual 40	android/content/Intent:getStringExtra	(Ljava/lang/String;)Ljava/lang/String;
    //   11: astore_1
    //   12: aload_0
    //   13: getfield 24	com/tencent/mobileqq/activity/ShortcutGuideActivity:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   16: ifnonnull +24 -> 40
    //   19: aload_0
    //   20: aload_0
    //   21: ldc 42
    //   23: invokestatic 47	com/tencent/mobileqq/utils/QQUtils:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   26: putfield 24	com/tencent/mobileqq/activity/ShortcutGuideActivity:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   29: aload_0
    //   30: getfield 24	com/tencent/mobileqq/activity/ShortcutGuideActivity:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   33: ifnonnull +7 -> 40
    //   36: aconst_null
    //   37: astore_2
    //   38: aload_2
    ...
    //   52: aload_0
    //   53: getfield 24	com/tencent/mobileqq/activity/ShortcutGuideActivity:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   67: astore_3
    //   68: aload_0
    //   69: invokevirtual 66	com/tencent/mobileqq/activity/ShortcutGuideActivity:getContentResolver	()Landroid/content/ContentResolver;
    //   72: astore 4
    //   74: aload 4
    //   76: aload_3
    //   77: invokestatic 72	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   80: iconst_1
    //   81: anewarray 74	java/lang/String
    //   84: dup
    //   85: iconst_0
    //   86: ldc 76
    //   88: aastore
    ...
    //   98: aastore
    //   99: aconst_null
    //   100: invokevirtual 84	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   103: astore_1
    //   104: aload_1
    //   105: ifnull +43 -> 148
    //   108: aload_1
    //   109: invokeinterface 90 1 0
    //   114: ifeq +87 -> 201
    //   117: aload_1
    //   118: iconst_0
    ...
    //   126: ifnull +22 -> 148
    //   129: aload_2
    //   130: invokestatic 97	com/tencent/mobileqq/activity/ShortcutGuideActivity:a	([B)Landroid/graphics/Bitmap;
    //   133: astore_3
    //   134: aload_3
    //   135: astore_2
    //   136: aload_1
  ...
  private void a()
  {
    ...
    {
      findViewById(2131302123).setVisibility(8);
      findViewById(2131302124).setVisibility(8);
      ...
      if (jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null) {
        jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = new BitmapDrawable(b());
      }
      findViewById(2131297735).setBackgroundDrawable(jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
      if (localObject1 == null) {
        break label327;
      }
      ((ImageView)findViewById(2131302118)).setImageBitmap((Bitmap)localObject1);
    }
    for (;;)
    {
      localObject1 = ((Intent)localObject3).getStringExtra("uinname");
      localObject3 = (TextView)findViewById(2131302119);
      if (localObject1 != null)
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (((String)localObject2).equals("starShortcut")))
        {
          ...
          ((TextView)findViewById(2131302120)).setVisibility(8);
          ((TextView)findViewById(2131302121)).setVisibility(0);
          localObject1 = (TextView)findViewById(2131302122);
          ...
          ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(getResources().getColor(2131427539)), i, i + 2, 17);
          ((TextView)localObject1).setText((CharSequence)localObject2);
          ((TextView)localObject1).setVisibility(0);
        }
      }
      return;
      findViewById(2131302123).setOnClickListener(this);
      findViewById(2131302124).setOnClickListener(this);
      localObject1 = a(true, ((Intent)localObject3).getStringExtra("uin"));
      break;
      label327:
      ((ImageView)findViewById(2131302118)).setImageResource(2130838445);
    }
  }
  ...
  private Bitmap b()
  {
    return ImageUtil.b(BitmapManager.a(getResources(), 2130840971), 14.0F, 540, 620);
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    try
    {
      if ((!TextUtils.isEmpty(str)) && (str.equals("starShortcut")))
      {
        ...
        ((ImageView)findViewById(2131302118)).setImageBitmap(paramBundle);
      }
      for (;;)
      {
        ReportController.b((QQAppInterface)mRuntime, "CliOper", "", "", "Fast_launch", "Fast_launch_head", 0, 0, "", "", "", "");
        if ((!TextUtils.isEmpty(str)) && (str.equals("starShortcut")))
        {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      localIntent.putExtra("shotcut_forward", ChatActivity.class.getName());
      ReportController.b((QQAppInterface)mRuntime, "CliOper", "", "", "Fast_launch", "Fast_launch_msg", 0, 0, "0", "", "", "");
      continue;
      localIntent.putExtra("shotcut_forward", AVActivity.class.getName());
      ReportController.b((QQAppInterface)mRuntime, "CliOper", "", "", "Fast_launch", "Fast_launch_call", 0, 0, "", "", "", "");
    }
  }
