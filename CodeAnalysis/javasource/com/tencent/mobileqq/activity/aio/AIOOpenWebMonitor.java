...
public class AIOOpenWebMonitor
{
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidSupportV4UtilArrayMap = null;
  }
  
  public AIOOpenWebMonitor() {}
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    for (int i1 = 1;; i1 = 2)
    {
      ...
      ThreadManager.a(new kpj(paramQQAppInterface, i1, paramIntent, l1), 2, null, false);
      return;
    }
  }
