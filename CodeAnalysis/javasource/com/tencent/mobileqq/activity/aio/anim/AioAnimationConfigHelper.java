...
public class AioAnimationConfigHelper
{
  ...
  private ArrayList a(XmlPullParser paramXmlPullParser)
  {
    ...
    if (i1 != 1) {
      if (i1 == 2)
      {
        ...
        if (str1.equalsIgnoreCase("Item"))
        {
          ...
          jdField_a_of_type_Int = Integer.valueOf((String)localObject3).intValue();
        ...
        do
        {
          for (;;)
          {
            ...
            else if (str1.equalsIgnoreCase("FloorLimit"))
            {
              ...
              if (localObject4 != null)
              {
                jdField_b_of_type_Int = Integer.valueOf(str1).intValue();
                localObject2 = localObject4;
                localObject3 = localObject1;
              }
            }
    ...
    for (;;)
    {
      ...
      if (str1 != null) {
        e = AioAnimationRule.JumpImage.a(str1);
      }
      d = str2;
      if (localObject4 != null)
      {
        ...
        jdField_b_of_type_JavaUtilArrayList.add(localObject2);
      }
      i1 -= 1;
      continue;
      localObject2 = localObject4;
      ...
      if (localObject4 != null)
      {
        if ((jdField_b_of_type_Int != 0) || (c != 0)) {
          break label704;
        }
        bool = true;
      }
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "<== Item, id = " + jdField_a_of_type_Int + ",isValid = " + bool + "keywords:" + jdField_a_of_type_JavaUtilArrayList.toString());
        }
        localObject2 = null;
        break;
        label704:
  ...
  private void b(Context paramContext)
  {
    ...
    try
    {
      ...
      if (paramContext != null) {
        jdField_a_of_type_JavaUtilArrayList = paramContext;
      }
      return;
    }
