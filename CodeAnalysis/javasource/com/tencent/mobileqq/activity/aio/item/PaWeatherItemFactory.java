...
public class PaWeatherItemFactory
{
  ...
  public PaWeatherItemFactory(Context paramContext)
  {
    ...
    jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130839282);
    c = paramContext.getResources().getDrawable(2131427378);
    b = paramContext.getResources().getDrawable(2130839303);
  }
  ...
  private void a(String paramString, FrameLayout paramFrameLayout, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      localURLImageView.setImageDrawable(URLDrawableHelper.a(paramString, c, c));
    ...
    catch (Exception localException)
    {
      try
      {
        ((URLImageView)localObject1).setImageDrawable(URLDrawableHelper.a(paramString, c, c));
  ...
  public void a(int paramInt1, String paramString, FrameLayout paramFrameLayout, int paramInt2, int paramInt3, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      do
      {
        do
        {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  {
                    return;
                    localContext = (Context)jdField_a_of_type_JavaLangRefWeakReference.get();
                ...
                for (;;)
                {
                  try
                  {
                    localObject = URLDrawableHelper.a(arrayOfString[0] + arrayOfString[1] + "#10", paramInt2, paramInt3, jdField_a_of_type_AndroidGraphicsDrawableDrawable, jdField_a_of_type_AndroidGraphicsDrawableDrawable, false, 0.0F);
                  ...
                  try
                  {
                    paramFrameLayout = URLDrawableHelper.a(arrayOfString[0] + arrayOfString[2], c, c);
                  ...
                  return;
                  localObject = URLDrawableHelper.a(arrayOfString[0] + arrayOfString[1] + "#9", paramInt2, paramInt3, b, b, false, 0.0F);
                  paramString = (String)localObject;
                  ...
                  continue;
                  if (paramBoolean2) {
                    paramFrameLayout.setBackgroundDrawable(jdField_a_of_type_AndroidGraphicsDrawableDrawable);
                  } else {
                    paramFrameLayout.setBackgroundDrawable(b);
                  }
                }
          ...
          c = paramInt2;
          d = paramInt3;
          paramString.a(0.3F, 0.2F, 50, 20, 0, 2130839301);
          ...
          c = paramInt2;
          d = paramInt3;
          paramString.a(0.3F, 0.25F, 20, 3, 0, 2130839304);
          paramFrameLayout.addView(paramString);
          return;
        } while (arrayOfString.length < 4);
    ...
    c = paramInt2;
    d = paramInt3;
    paramString.a(0.5F, 0.0F, -5, 1, paramInt3 / 2, 2130839283);
    paramFrameLayout.addView(paramString);
  }
