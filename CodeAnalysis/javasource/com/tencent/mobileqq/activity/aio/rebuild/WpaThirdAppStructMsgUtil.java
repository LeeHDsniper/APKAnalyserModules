...
public class WpaThirdAppStructMsgUtil
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
    ...
    ShareMsgHelper.a(paramQQAppInterface, jdField_a_of_type_JavaLangString, jdField_a_of_type_Int, paramActivity, null);
    ReportController.b(paramQQAppInterface, "CliOper", "", jdField_a_of_type_JavaLangString, "0X8004B51", "0X8004B51", 0, 0, "", "", "", "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, SessionInfo paramSessionInfo, AbsShareMsg paramAbsShareMsg, String paramString)
  {
    ...
    String str = paramFragmentActivity.getString(2131364429);
    if (paramString != null) {}
    for (paramString = str + paramString;; paramString = str)
    {
      paramAbsShareMsg = new lmo(paramAbsShareMsg, paramFragmentActivity, paramFragmentActivity, paramQQAppInterface, paramSessionInfo);
      localShareAioResultDialog.a(paramString, paramAbsShareMsg);
      localShareAioResultDialog.a(paramFragmentActivity.getResources().getString(2131364428));
      localShareAioResultDialog.a(paramAbsShareMsg);
      localShareAioResultDialog.a(false);
      localShareAioResultDialog.show();
      ReportController.b(paramQQAppInterface, "CliOper", "", jdField_a_of_type_JavaLangString, "0X8004B54", "0X8004B54", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  {
    boolean bool = false;
    ReportController.b(paramQQAppInterface, "CliOper", "", jdField_a_of_type_JavaLangString, "0X8004B53", "0X8004B53", 0, 0, "", "", "", "");
    ...
    if (paramIntent.getBooleanExtra("from3rdApp", false))
    {
      ...
      if (paramIntent.getBooleanExtra("showFirstStructMsg", false))
      {
        ...
        if (paramIntent != null)
        {
          ...
          paramSessionInfo = MessageRecordFactory.a(paramQQAppInterface, jdField_a_of_type_JavaLangString, jdField_a_of_type_JavaLangString, jdField_a_of_type_JavaLangString, jdField_a_of_type_Int, l, paramIntent);
