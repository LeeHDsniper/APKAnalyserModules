...
public class MessageItem
{
  ...
  public MessageItem(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    if (QLog.isColorLevel()) {
      QLog.i(c, 2, "MessageItem, messageRecord.senderuin = " + senderuin);
    }
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("uniseq = ").append(jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq);
    localStringBuilder.append(", msg = ").append(jdField_a_of_type_ComTencentMobileqqDataMessageRecord.msg);
