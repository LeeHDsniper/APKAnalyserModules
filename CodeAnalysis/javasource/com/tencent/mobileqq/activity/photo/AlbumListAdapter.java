  ...
  extends BaseAdapter
{
  ...
  public AlbumListAdapter(Activity paramActivity, MediaFileFilter paramMediaFileFilter)
  {
    ...
    jdField_a_of_type_AndroidContentResResources = paramActivity.getResources();
    jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaFileFilter = paramMediaFileFilter;
    jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState = jdField_a_of_type_AndroidContentResResources.getDrawable(2130838114).getConstantState();
    jdField_a_of_type_Int = jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131493030);
    jdField_b_of_type_Int = jdField_a_of_type_Int;
    ThreadManager.a().post(new lzu(this));
  }
  ...
  {
    return (QQAlbumInfo)jdField_a_of_type_JavaUtilList.get(paramInt);
  }
  ...
  QQAlbumInfo a(Context paramContext, int paramInt1, int paramInt2, MediaFileFilter paramMediaFileFilter)
  {
    ...
    {
      mCoverInfo = ((LocalMediaInfo)localList.get(0));
      mMediaFileCount = localList.size();
    }
    if (mMediaFileCount >= paramInt2) {
    ...
    if (mMediaFileCount + paramContext.size() <= paramInt2) {
      paramInt1 = mMediaFileCount;
    }
    for (mMediaFileCount = (paramContext.size() + paramInt1);; mMediaFileCount = paramInt2) {
      return localQQAlbumInfo;
    }
  }
  ...
  public List a(Context paramContext, int paramInt, MediaFileFilter paramMediaFileFilter)
  {
    ...
    //   210	242	10	i2	int
    //   295	86	11	l	long
    //   7	535	13	localObject1	Object
    //   11	344	14	str1	String
    //   476	22	14	localException1	Exception
    //   554	1	14	localException2	Exception
    //   563	1	14	localException3	Exception
    //   307	159	15	localQQAlbumInfo	QQAlbumInfo
    //   234	204	16	localObject2	Object
    //   247	68	17	str2	String
    // Exception table:
    //   from	to	target	type
  ...
  List a(Cursor paramCursor, int paramInt, MediaFileFilter paramMediaFileFilter)
  {
    ...
    do
    {
      do
      {
        ...
        LocalMediaInfo localLocalMediaInfo = new LocalMediaInfo();
        jdField_a_of_type_Long = paramCursor.getLong(k);
        jdField_a_of_type_JavaLangString = str2;
        jdField_b_of_type_JavaLangString = str1;
        d = l;
        e = paramCursor.getLong(i1);
        jdField_b_of_type_Long = paramCursor.getLong(i3);
  ...
  List a(List paramList1, List paramList2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (_id.equals(_id)) {
          mMediaFileCount += mMediaFileCount;
        }
      }
      for (i = 1;; i = 0)
      {
        ...
        for (i = 1;; i = 0)
        {
          ...
          if (paramInt == -1)
          {
            paramList1 = c(jdField_a_of_type_AndroidAppActivity, 210, 100, jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaFileFilter);
            ((List)localObject).add(0, paramList1);
            if ((jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaFileFilter != null) && (jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaFileFilter.b()))
            {
              paramList1 = MediaStore.Video.Media.EXTERNAL_CONTENT_URI;
              paramList1 = jdField_a_of_type_AndroidAppActivity.getContentResolver().query(paramList1, new String[] { "_id" }, "_size>0 ", null, null);
              if (paramList1 == null) {
                break label550;
              }
  ...
  public void a(int paramInt)
  {
    int k = 1;
    int n = 0;
    Object localObject = jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaFileFilter;
    List localList;
    int i;
    if ((localObject != null) && (((MediaFileFilter)localObject).a()))
    {
      LogTag.a();
      localList = a(jdField_a_of_type_AndroidAppActivity, paramInt, jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaFileFilter);
    ...
    for (;;)
    {
      ...
      {
        LogTag.a();
        localObject = b(jdField_a_of_type_AndroidAppActivity, paramInt, (MediaFileFilter)localObject);
        j = i;
        if (paramInt != -1)
        {
          j = i;
      ...
      for (;;)
      {
        ...
        for (i = n;; i = localList.size() - 1)
        {
          ...
          if (paramInt != -1)
          {
            ...
            ThreadManager.a().post(new lzz(this));
          }
          return;
        }
        ThreadManager.a().post(new maa(this));
        return;
        localObject = null;
        j = i;
      }
  ...
  void a(Cursor paramCursor, List paramList, int paramInt1, int paramInt2, boolean paramBoolean, MediaFileFilter paramMediaFileFilter)
  {
    ...
    if ((str.indexOf(".jpg") != -1) || (str.indexOf(".jpeg") != -1))
    {
      ...
      else
      {
        ...
        jdField_a_of_type_JavaLangString = str;
        d = l;
        jdField_a_of_type_Int = paramCursor.getInt(i1);
        jdField_b_of_type_JavaLangString = ((String)localObject1);
        jdField_b_of_type_Long = paramCursor.getLong(i4);
  ...
  public void a(QQAlbumInfo paramQQAlbumInfo)
  {
    ...
    if (jdField_a_of_type_JavaUtilList.isEmpty()) {
      jdField_a_of_type_JavaUtilList.add(paramQQAlbumInfo);
    }
    for (;;)
    {
      if ((jdField_b_of_type_Boolean) && (jdField_a_of_type_Long > 0L))
      {
        paramQQAlbumInfo = new QQAlbumInfo();
        _id = "qzone_album";
        name = "空间相册";
        mMediaFileCount = ((int)jdField_a_of_type_Long);
        jdField_a_of_type_JavaUtilList.add(0, paramQQAlbumInfo);
      }
      notifyDataSetChanged();
      return;
      if (jdField_a_of_type_JavaUtilList.get(0))._id.equals("$RecentAlbumId")) {
        jdField_a_of_type_JavaUtilList.set(0, paramQQAlbumInfo);
      } else {
        jdField_a_of_type_JavaUtilList.add(0, paramQQAlbumInfo);
      }
    }
  ...
  void a(String paramString, BitmapFactory.Options paramOptions, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localHashMap.put(paramString, Integer.valueOf(outWidth << 16 & 0xFFFF0000 | outHeight & 0xFFFF));
        j = k;
        i = m;
      }
      catch (OutOfMemoryError paramString)
  ...
  public void a(List paramList)
  {
    ...
    notifyDataSetChanged();
    ThreadManager.a(new lzv(this), 2, null, false);
  }
  ...
  public List b(Context paramContext, int paramInt, MediaFileFilter paramMediaFileFilter)
  {
    ...
    //   176	191	9	i1	int
    //   248	92	10	l	long
    //   32	425	12	localObject1	Object
    //   260	121	13	localQQAlbumInfo	QQAlbumInfo
    //   391	22	13	localException1	Exception
    //   469	1	13	localException2	Exception
    //   478	1	13	localException3	Exception
    //   200	148	14	localObject2	Object
    //   213	55	15	str	String
    // Exception table:
    //   from	to	target	type
  ...
  public void b(QQAlbumInfo paramQQAlbumInfo)
  {
    ...
    jdField_a_of_type_AndroidOsHandler.post(new lzx(this, paramQQAlbumInfo));
  }
  ...
  void b(List paramList)
  {
    ...
    jdField_a_of_type_AndroidOsHandler.post(new lzw(this, paramList));
  }
  ...
  public void c(QQAlbumInfo paramQQAlbumInfo)
  {
    ...
    if (jdField_a_of_type_JavaUtilList.size() < 2)
    {
      jdField_a_of_type_JavaUtilList.add(paramQQAlbumInfo);
      notifyDataSetChanged();
      return;
    ...
    for (;;)
    {
      ...
      {
        if (jdField_a_of_type_JavaUtilList.get(i))._id.equals("$VideoAlbumId"))
        {
          jdField_a_of_type_JavaUtilList.set(i, paramQQAlbumInfo);
          j = 1;
        }
      }
      else
      {
        ...
        jdField_a_of_type_JavaUtilList.add(1, paramQQAlbumInfo);
        break;
      }
      i += 1;
    }
  ...
  public void d(QQAlbumInfo paramQQAlbumInfo)
  {
    ...
    jdField_a_of_type_AndroidOsHandler.post(new lzy(this, paramQQAlbumInfo));
  }
  ...
  {
    return AlbumUtil.a(jdField_a_of_type_JavaUtilList.get(paramInt)).mCoverInfo);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = jdField_a_of_type_AndroidAppActivity.getLayoutInflater().inflate(2130904006, null);
      localTextView = (TextView)localView;
      localQQAlbumInfo = a(paramInt);
      localView.setContentDescription(name + "，" + mMediaFileCount + "张照片");
      paramView = name;
      if (mMediaFileCount > 0) {
        paramView = name + String.format(" (%d)", new Object[] { Integer.valueOf(mMediaFileCount) });
      }
      ...
      if (!mCoverInfo.jdField_b_of_type_Boolean) {
        break label354;
      }
      paramView = AlbumUtil.a(mCoverInfo, "VIDEO");
      label191:
      Object localObject = mCoverInfo;
      mCoverInfo.g = 200;
      f = 200;
    ...
    for (paramViewGroup = null;; paramViewGroup = null)
    {
      ...
      {
        paramView.setTag(mCoverInfo);
        paramView.setBounds(0, 0, jdField_a_of_type_Int, jdField_b_of_type_Int);
        paramViewGroup = jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState.newDrawable(jdField_a_of_type_AndroidContentResResources);
        ...
        localView = paramView;
        break;
        paramView = AlbumUtil.a(mCoverInfo, "APP_VIDEO");
        break label191;
        paramView = AlbumUtil.a(mCoverInfo);
        break label191;
        paramViewGroup = jdField_a_of_type_AndroidContentResResources.getDrawable(2130839456);
      }
      paramView = jdField_a_of_type_AndroidContentResResources.getDrawable(2130841374);
      paramView.setBounds(0, 0, jdField_a_of_type_Int, jdField_b_of_type_Int);
      paramViewGroup = jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState.newDrawable(jdField_a_of_type_AndroidContentResResources);
      paramViewGroup.setBounds(0, 0, paramViewGroup.getIntrinsicWidth(), paramViewGroup.getIntrinsicHeight());
      localTextView.setCompoundDrawables(paramView, null, paramViewGroup, null);
