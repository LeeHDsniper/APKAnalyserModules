  ...
  extends Gallery
{
  ...
  {
    if (a != null) {
      a.a(paramInt, paramView, paramViewGroup);
    }
  }
  ...
  {
    if (a != null) {
      a.a(paramInt, paramView, paramViewGroup, paramBoolean);
    }
  }
  ...
  protected void a(int paramInt, View paramView, RegionDrawableData paramRegionDrawableData)
  {
    ...
    if (a != null) {
      a.a(paramInt, paramView, paramRegionDrawableData);
    }
  }
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          a.b(paramInt, null, paramViewGroup);
          return;
          a.a(j, null, paramViewGroup);
          i += 1;
          break label34;
        }
        a.a(j, null, paramViewGroup);
  ...
  {
    if (a != null) {
      a.c(paramInt, paramView, paramViewGroup);
    }
  }
  
  public void setOnNoBlankListener(ProGallery.OnProGalleryListener paramOnProGalleryListener)
  {
    if (paramOnProGalleryListener != a) {
      a = paramOnProGalleryListener;
    }
  }
