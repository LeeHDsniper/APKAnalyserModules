  ...
  extends BaseActivity
{
  ...
  protected void b()
  {
    new Handler().postDelayed(new mcb(this), 10L);
  }
  
  protected void c()
  {
    new Handler().postDelayed(new mcc(this), 10L);
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      jdField_a_of_type_JavaLangString = AppConstants.ai;
      paramBundle = getIntent();
      if (paramBundle != null)
      {
        jdField_a_of_type_JavaLangString = paramBundle.getStringExtra("targetUin");
        jdField_a_of_type_Int = paramBundle.getIntExtra("device_type", -1);
