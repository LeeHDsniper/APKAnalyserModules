  ...
  implements Manager
{
  ...
  public void a()
  {
    if (jdField_a_of_type_ComTencentMobileqqUtilsQQCustomSingleButtonDialog == null) {
      jdField_a_of_type_ComTencentMobileqqUtilsQQCustomSingleButtonDialog = DialogUtil.a(jdField_a_of_type_AndroidContentContext, "支付失败", "", "确定", new mdb(this), null, null);
    }
    jdField_a_of_type_ComTencentMobileqqUtilsQQCustomSingleButtonDialog.show();
  }
  ...
  public boolean a(JSONObject paramJSONObject, PublicQuickPayManager.QQWalletPayCompletionImp paramQQWalletPayCompletionImp)
  {
    ...
    if ((!TextUtils.isEmpty(str2)) && (!TextUtils.isEmpty(str3)) && (!TextUtils.isEmpty(str4)) && (!TextUtils.isEmpty(str6)) && (!TextUtils.isEmpty(str7)) && (!TextUtils.isEmpty(str5)) && (!TextUtils.isEmpty(str8)))
    {
      ...
      paramQQWalletPayCompletionImp = new Intent(jdField_a_of_type_AndroidContentContext, OpenPayActivity.class);
      paramQQWalletPayCompletionImp.putExtras(paramJSONObject);
      paramQQWalletPayCompletionImp.addFlags(268435456);
      jdField_a_of_type_AndroidContentContext.startActivity(paramQQWalletPayCompletionImp);
      if (QLog.isColorLevel()) {
