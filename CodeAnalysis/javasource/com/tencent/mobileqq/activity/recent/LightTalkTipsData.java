...
public class LightTalkTipsData
{
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 115	com/tencent/mobileqq/utils/StringUtil:b	(Ljava/lang/String;)Z
    //   4: ifne +24 -> 28
    //   7: aload_1
    //   8: invokestatic 115	com/tencent/mobileqq/utils/StringUtil:b	(Ljava/lang/String;)Z
    //   11: ifne +17 -> 28
    //   14: aload_2
    //   15: invokestatic 115	com/tencent/mobileqq/utils/StringUtil:b	(Ljava/lang/String;)Z
    //   18: ifne +10 -> 28
    //   21: aload_3
    //   22: invokestatic 115	com/tencent/mobileqq/utils/StringUtil:b	(Ljava/lang/String;)Z
    //   25: ifeq +18 -> 43
    //   28: invokestatic 92	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   31: ifeq +11 -> 42
    //   34: ldc 101
    //   36: iconst_2
    //   37: ldc 117
    //   39: invokestatic 107	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   42: return
    ...
    //   50: invokespecial 120	java/io/File:<init>	(Ljava/lang/String;)V
    //   53: invokevirtual 123	java/io/File:mkdirs	()Z
    //   56: pop
    //   57: new 47	java/io/File
    //   60: dup
    //   61: getstatic 65	com/tencent/mobileqq/activity/recent/LightTalkTipsData:b	Ljava/lang/String;
    //   64: invokespecial 120	java/io/File:<init>	(Ljava/lang/String;)V
    //   67: astore 5
    //   69: aload 5
    //   71: invokevirtual 126	java/io/File:exists	()Z
    //   74: ifeq +9 -> 83
    //   77: aload 5
    //   79: invokevirtual 129	java/io/File:delete	()Z
    //   82: pop
    //   83: aconst_null
    //   84: astore 4
    //   86: aload 5
    //   88: invokevirtual 132	java/io/File:createNewFile	()Z
    //   91: pop
    ...
    //   158: ldc -122
    //   160: invokevirtual 140	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   163: astore_2
    //   164: new 142	java/io/FileOutputStream
    //   167: dup
    //   168: aload 5
    //   170: invokespecial 145	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   173: astore_1
    //   174: aload_1
    //   175: astore_0
    //   176: aload_1
    //   177: aload_2
    //   178: invokevirtual 149	java/io/FileOutputStream:write	([B)V
    //   181: aload_1
    //   182: astore_0
    //   183: aload_1
    //   184: invokevirtual 152	java/io/FileOutputStream:flush	()V
    //   187: aload_1
    //   188: ifnull -146 -> 42
    //   191: aload_1
    //   192: invokevirtual 155	java/io/FileOutputStream:close	()V
    //   195: return
    //   196: astore_0
    //   197: aload_0
    //   198: invokevirtual 158	java/io/IOException:printStackTrace	()V
    //   201: return
    //   202: astore_2
    //   203: aconst_null
    //   204: astore_1
    ...
    //   206: astore_0
    //   207: aload_2
    //   208: invokevirtual 158	java/io/IOException:printStackTrace	()V
    //   211: aload_1
    //   212: ifnull -170 -> 42
    //   215: aload_1
    //   216: invokevirtual 155	java/io/FileOutputStream:close	()V
    //   219: return
    //   220: astore_0
    //   221: aload_0
    //   222: invokevirtual 158	java/io/IOException:printStackTrace	()V
    //   225: return
    //   226: astore_0
    //   227: aload 4
    //   229: astore_1
    ...
    //   231: ifnull +7 -> 238
    //   234: aload_1
    //   235: invokevirtual 155	java/io/FileOutputStream:close	()V
    //   238: aload_0
    //   239: athrow
    //   240: astore_1
    //   241: aload_1
    //   242: invokevirtual 158	java/io/IOException:printStackTrace	()V
    //   245: goto -7 -> 238
    //   248: astore_2
    //   249: aload_0
    //   250: astore_1
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if ((localLightTalkTipsData != null) && (((e != null) && (paramString1 != null) && (!paramString1.equals(e))) || ((f != null) && (paramString2 != null) && (!paramString2.equals(f))) || ((g != null) && (paramString3 != null) && (!paramString3.equals(g))) || ((h != null) && (paramString4 != null) && (!paramString4.equals(h))))) {}
    for (boolean bool = true;; bool = false)
    {
      if (bool) {
        b();
  ...
  {
    // Byte code:
    //   0: getstatic 71	com/tencent/mobileqq/activity/recent/LightTalkTipsData:jdField_a_of_type_ComTencentMobileqqActivityRecentLightTalkTipsData	Lcom/tencent/mobileqq/activity/recent/LightTalkTipsData;
    //   3: ifnull +18 -> 21
    //   6: invokestatic 92	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   9: ifeq +11 -> 20
    //   12: ldc 101
    //   14: iconst_2
    //   15: ldc -71
    //   17: invokestatic 107	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   20: return
    //   21: new 47	java/io/File
    //   24: dup
    //   25: getstatic 65	com/tencent/mobileqq/activity/recent/LightTalkTipsData:b	Ljava/lang/String;
    //   28: invokespecial 120	java/io/File:<init>	(Ljava/lang/String;)V
    //   31: astore_0
    ...
    //   42: astore_1
    //   43: aload_0
    //   44: invokevirtual 126	java/io/File:exists	()Z
    //   47: ifeq -27 -> 20
    //   50: aload_0
    ...
    //   56: ifle -36 -> 20
    //   59: aload_1
    //   60: invokevirtual 126	java/io/File:exists	()Z
    //   63: ifeq -43 -> 20
    ...
    //   135: putstatic 71	com/tencent/mobileqq/activity/recent/LightTalkTipsData:jdField_a_of_type_ComTencentMobileqqActivityRecentLightTalkTipsData	Lcom/tencent/mobileqq/activity/recent/LightTalkTipsData;
    //   138: aload_1
    //   139: astore_0
    //   140: getstatic 71	com/tencent/mobileqq/activity/recent/LightTalkTipsData:jdField_a_of_type_ComTencentMobileqqActivityRecentLightTalkTipsData	Lcom/tencent/mobileqq/activity/recent/LightTalkTipsData;
    //   143: aload_2
    //   144: iconst_0
    //   145: aaload
    //   146: putfield 163	com/tencent/mobileqq/activity/recent/LightTalkTipsData:e	Ljava/lang/String;
    //   149: aload_1
    //   150: astore_0
    //   151: getstatic 71	com/tencent/mobileqq/activity/recent/LightTalkTipsData:jdField_a_of_type_ComTencentMobileqqActivityRecentLightTalkTipsData	Lcom/tencent/mobileqq/activity/recent/LightTalkTipsData;
    //   154: aload_2
    //   155: iconst_1
    //   156: aaload
    //   157: putfield 169	com/tencent/mobileqq/activity/recent/LightTalkTipsData:f	Ljava/lang/String;
    //   160: aload_1
    //   161: astore_0
    //   162: getstatic 71	com/tencent/mobileqq/activity/recent/LightTalkTipsData:jdField_a_of_type_ComTencentMobileqqActivityRecentLightTalkTipsData	Lcom/tencent/mobileqq/activity/recent/LightTalkTipsData;
    //   165: aload_2
    //   166: iconst_2
    //   167: aaload
    //   168: putfield 75	com/tencent/mobileqq/activity/recent/LightTalkTipsData:g	Ljava/lang/String;
    //   171: aload_1
    //   172: astore_0
    //   173: getstatic 71	com/tencent/mobileqq/activity/recent/LightTalkTipsData:jdField_a_of_type_ComTencentMobileqqActivityRecentLightTalkTipsData	Lcom/tencent/mobileqq/activity/recent/LightTalkTipsData;
    //   176: aload_2
    //   177: iconst_3
    //   178: aaload
    //   179: putfield 77	com/tencent/mobileqq/activity/recent/LightTalkTipsData:h	Ljava/lang/String;
    //   182: aload_1
    //   183: ifnull -163 -> 20
    //   186: aload_1
    ...
    //   191: astore_0
    //   192: aload_0
    //   193: invokevirtual 158	java/io/IOException:printStackTrace	()V
    //   196: return
    //   197: astore_2
    //   198: aconst_null
    //   199: astore_1
    ...
    //   207: astore_0
    //   208: aconst_null
    //   209: putstatic 71	com/tencent/mobileqq/activity/recent/LightTalkTipsData:jdField_a_of_type_ComTencentMobileqqActivityRecentLightTalkTipsData	Lcom/tencent/mobileqq/activity/recent/LightTalkTipsData;
    //   212: aload_1
    //   213: ifnull -193 -> 20
    //   216: aload_1
    ...
    //   221: astore_0
    //   222: aload_0
    //   223: invokevirtual 158	java/io/IOException:printStackTrace	()V
    //   226: return
    //   227: astore_1
    //   228: aconst_null
    //   229: astore_0
