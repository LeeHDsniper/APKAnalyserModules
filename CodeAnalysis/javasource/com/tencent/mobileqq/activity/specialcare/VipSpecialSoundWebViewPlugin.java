  ...
  extends VasWebviewJsPlugin
{
  ...
  private static final String b = "http://i.gtimg.cn/club/moblie/special_sound/sound_config.json";
  ...
  public VipSpecialSoundWebViewPlugin()
  {
    ...
    jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager = null;
    jdField_a_of_type_ComTencentMobileqqVipDownloaderFactory = null;
    jdField_a_of_type_ComTencentMobileqqVipDownloaderInterface = null;
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
    jdField_a_of_type_ComTencentMobileqqUtilsMediaPlayerHelper = MediaPlayerHelper.a();
  }
  ...
  private void a(File paramFile, String paramString)
  {
    ...
    //   7: aconst_null
    //   8: astore_3
    //   9: new 99	java/io/FileOutputStream
    //   12: dup
    //   13: aload_1
    //   14: invokespecial 102	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   17: astore_1
    //   18: aload_1
    //   19: aload_2
    //   20: invokevirtual 108	java/lang/String:getBytes	()[B
    //   23: invokevirtual 112	java/io/FileOutputStream:write	([B)V
    //   26: aload_1
    //   27: invokevirtual 115	java/io/FileOutputStream:close	()V
    //   30: return
    //   31: astore_1
    //   32: aconst_null
    //   33: astore_1
    //   34: aload_1
    //   35: invokevirtual 115	java/io/FileOutputStream:close	()V
    //   38: return
    //   39: astore_1
    //   40: return
    //   41: astore_1
    ...
    //   43: astore_2
    //   44: aload_2
    //   45: invokevirtual 115	java/io/FileOutputStream:close	()V
    //   48: aload_1
    //   49: athrow
    //   50: astore_1
    //   51: return
  ...
  private void a(String paramString, List paramList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        mqi localMqi = (mqi)paramList.next();
        JSONObject localJSONObject3 = new JSONObject();
        localJSONObject3.put("id", jdField_a_of_type_Int);
        localJSONObject3.put("soundName", jdField_a_of_type_JavaLangString);
        localJSONObject3.put("type", jdField_b_of_type_Int);
        localJSONObject3.put("soundVersion", jdField_b_of_type_JavaLangString);
        localJSONObject3.put("soundUrl", jdField_c_of_type_JavaLangString);
        localJSONObject3.put("whiteList", jdField_d_of_type_JavaLangString);
        localJSONObject3.put("isShow", jdField_c_of_type_Int);
        localJSONObject3.put("backgroundUrl", jdField_e_of_type_JavaLangString);
        localJSONObject3.put("access", f);
        localJSONObject3.put("useNum", jdField_d_of_type_Int);
        localJSONObject3.put("classify", jdField_e_of_type_Int);
        localJSONObject3.put("classifyName", g);
        localJSONObject3.put("limitFreeStart", h);
        localJSONObject3.put("limitFreeEnd", i);
        if ((jdField_c_of_type_JavaLangString != null) && (!TextUtils.isEmpty(jdField_c_of_type_JavaLangString)) && (f(jdField_c_of_type_JavaLangString)))
        {
          localJSONObject3.put("isDownload", true);
          localJSONObject2.put(String.valueOf(jdField_a_of_type_Int), localJSONObject3);
        }
        else
        {
  ...
  private boolean a(int paramInt, String paramString1, String paramString2)
  {
    ...
    if (!NetworkUtil.e(mRuntime.a().getApplicationContext()))
    {
      a("-->no network");
    ...
    sendRemoteReq(DataFactory.a("sepcial_care_delete_ring", paramString2, mOnRemoteResp.key, localBundle), false, false);
    return true;
  }
  ...
  private boolean a(int paramInt, String paramString1, boolean paramBoolean, String paramString2)
  {
    ...
    if (paramBoolean)
    {
      mRuntime.a().getApplicationContext().getSharedPreferences("com.tencent.mobileqq_preferences", 4).edit().putInt("special_care_id_cache" + paramString1, paramInt).commit();
      paramString1 = new JSONObject();
    ...
    localBundle.putInt("id", paramInt);
    localBundle.putString("uin", paramString1);
    sendRemoteReq(DataFactory.a("special_care_set_ring", paramString2, mOnRemoteResp.key, localBundle), false, false);
    return true;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    if (!jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a()) {
      jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a(new mri(this, paramString));
    }
    for (;;)
    {
      return true;
      String str = "key_special_sound_list" + mRuntime.a().a();
  ...
  private boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    Object localObject = new File(mRuntime.a().getApplicationContext().getFilesDir(), paramString1);
    ...
    for (;;)
    {
      ...
      return true;
      mrm localMrm = new mrm(this);
      jdField_a_of_type_JavaLangString = paramString3;
      jdField_b_of_type_JavaLangString = paramString1;
      paramString3 = new mrk(this, localMrm, paramString3);
      ThreadManager.a(localMrm, 5, null, true);
      paramString1 = new DownloadTask(paramString1, (File)localObject);
      a = 1;
      jdField_a_of_type_ComTencentMobileqqVipDownloaderInterface.a(paramString1, paramString3, null);
    }
  }
  ...
  private boolean a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      int i = mRuntime.a().getApplicationContext().getSharedPreferences("com.tencent.mobileqq_preferences", 4).getInt("special_care_id_cache" + paramString1, 1);
      paramString1 = new JSONObject();
    ...
    sendRemoteReq(DataFactory.a("special_care_get_ring", paramString2, mOnRemoteResp.key, (Bundle)localObject), false, false);
    return true;
  }
  
  private boolean a(String paramString, JSONObject paramJSONObject)
  {
    File localFile = new File(mRuntime.a().getApplicationContext().getFilesDir(), "http://i.gtimg.cn/club/moblie/special_sound/new_config.json");
  ...
  {
    File localFile = new File(mRuntime.a().getApplicationContext().getFilesDir(), "http://i.gtimg.cn/club/moblie/special_sound/sound_config.json");
    if ((localFile.exists()) && (!localFile.delete())) {
      a("-->can't delete file!");
    }
    jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a(new mrj(this, paramString));
  }
  ...
  private boolean b(String paramString)
  {
    ...
    sendRemoteReq(DataFactory.a("special_care_get_friend_count", paramString, mOnRemoteResp.key, null), false, false);
    return true;
  }
  ...
  private boolean b(String paramString1, String paramString2)
  {
    ...
    sendRemoteReq(DataFactory.a("is_special_friend", paramString2, mOnRemoteResp.key, localBundle), false, false);
    return true;
  }
  ...
  private boolean b(String paramString1, String paramString2, String paramString3)
  {
    ...
    JSONObject localJSONObject = new JSONObject();
    if (jdField_a_of_type_ComTencentMobileqqUtilsMediaPlayerHelper.d()) {}
    for (boolean bool1 = jdField_a_of_type_ComTencentMobileqqUtilsMediaPlayerHelper.b();; bool1 = true)
    {
      jdField_a_of_type_ComTencentMobileqqUtilsMediaPlayerHelper.a(new mrl(this, paramString1, paramString2));
      boolean bool2 = jdField_a_of_type_ComTencentMobileqqUtilsMediaPlayerHelper.a(mRuntime.a().getApplicationContext(), paramString1);
      boolean bool3 = jdField_a_of_type_ComTencentMobileqqUtilsMediaPlayerHelper.a();
  ...
  private boolean c(String paramString)
  {
    ...
    for (;;)
    {
      callJs(paramString, new String[] { localJSONObject.toString() });
      return true;
      bool = jdField_a_of_type_ComTencentMobileqqUtilsMediaPlayerHelper.b();
      break;
      label105:
      localJSONObject.put("code", 0);
    }
  ...
  private boolean d(String paramString)
  {
    ...
    sendRemoteReq(DataFactory.a("special_care_get_switch_state", paramString, mOnRemoteResp.key, null), false, false);
    return true;
  }
  ...
  {
    paramString = new File(mRuntime.a().getApplicationContext().getFilesDir(), paramString);
    if (paramString != null) {
  ...
  {
    super.onCreate();
    jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager = new QvipSpecialSoundManager(mRuntime.a().getApplicationContext(), mRuntime.a());
    jdField_a_of_type_ComTencentMobileqqVipDownloaderFactory = new DownloaderFactory(mRuntime.a());
  ...
  {
    super.onDestroy();
    jdField_a_of_type_ComTencentMobileqqUtilsMediaPlayerHelper.a();
    jdField_a_of_type_ComTencentMobileqqVipDownloaderFactory.onDestroy();
  }
  ...
  protected void onResponse(Bundle paramBundle)
  {
    if (paramBundle != null)
    {
      ...
      try
      {
        if (paramBundle.getInt("respkey", 0) != mOnRemoteResp.key) {
          return;
        }
