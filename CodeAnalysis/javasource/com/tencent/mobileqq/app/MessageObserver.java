    ...
    for (Object localObject1 = (Object[])paramObject;; localObject1 = null)
    {
      ...
      case 6003: 
        do
        {
          ...
          paramInt = extraData.getInt("system_msg_action_type");
          localObject1 = extraData.getString("system_msg_action_resp_key");
          localObject2 = extraData.getString("system_msg_action_resp_error_key");
          i = extraData.getInt("system_msg_action_resp_result_code_key");
          j = extraData.getInt("system_msg_action_resp_type_key");
          str1 = extraData.getString("system_msg_action_resp_invalid_decided_key");
          int k = extraData.getInt("system_msg_action_resp_remark_result_key");
