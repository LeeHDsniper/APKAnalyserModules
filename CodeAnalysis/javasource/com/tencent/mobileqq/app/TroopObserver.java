                  ...
                  do
                  {
                    do
                    {
                      do
                      {
                        ...
                        return;
                        paramObject = (ngi)paramObject;
                        a(jdField_a_of_type_Int, jdField_a_of_type_Boolean, b, jdField_a_of_type_JavaUtilList);
                        return;
                        paramObject = (ngi)paramObject;
                        a(jdField_a_of_type_Int, jdField_a_of_type_Boolean, b, jdField_a_of_type_Long, jdField_a_of_type_JavaUtilList);
                        return;
                        b(paramBoolean, (ArrayList)paramObject);
                        return;
                        paramObject = (ngh)paramObject;
                        a(jdField_a_of_type_Long, jdField_a_of_type_Int, jdField_a_of_type_Boolean, jdField_a_of_type_JavaLangString, b, c);
                        return;
                        paramObject = (Object[])paramObject;
