  ...
  extends FullCache
{
  ...
  public RoamMessagePreloadInfo a(String paramString, Calendar paramCalendar, int paramInt)
  {
    ...
    preloadType = paramInt;
    List localList = a();
    if (paramInt == 0) {
      if (a(paramString, paramCalendar, localList)) {
        curday = paramCalendar;
      }
    }
    for (;;)
    {
      if ((curday != null) && (paramInt != 0))
      {
        previousday = a(paramString, curday, localList);
        nextday = b(paramString, curday, localList);
      }
      return localRoamMessagePreloadInfo;
      paramCalendar = null;
      break;
      if (paramInt == 1) {
        curday = a(paramString, paramCalendar, localList);
      } else if (paramInt == 2) {
        curday = b(paramString, paramCalendar, localList);
      }
    }
  }
  ...
  public List a()
  {
    ArrayList localArrayList = new ArrayList(jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.entrySet());
    Collections.sort(localArrayList, new nhd(this));
  ...
  public void a(String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(a(localRoamDate), localRoamDate);
      }
    }
    if (QLog.isColorLevel())
    {
  ...
  {
    if ((jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) && (!jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.isEmpty()))
    {
