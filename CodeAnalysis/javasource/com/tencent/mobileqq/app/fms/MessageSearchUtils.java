    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 63525)
        {
          ...
          paramString1 = paramString2;
          bool = a(String.valueOf(mMsgServiceID));
          paramString1 = paramString2;
          if ((!(localObject instanceof AbsShareMsg)) || (!bool)) {
            break label611;
          }
          paramString1 = paramString2;
          paramString2 = mContentTitle;
          paramQQAppInterface = paramString2;
        }
      }
      ...
      if (paramInt == 60527)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localArrayList1.size() > 0)
          {
            ...
            secondPageList = localArrayList1;
            secondPageMessageUniseq = localArrayList2;
          }
          paramString1 = a;
          ...
          c += localArrayList1.size();
          c += localArrayList2.size();
