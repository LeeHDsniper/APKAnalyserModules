...
public abstract class BaseMessageProcessor
{
  ...
  public BaseMessageProcessor(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
    ...
    jdField_a_of_type_ComTencentMobileqqAppMessageHandler = paramMessageHandler;
  ...
  public void a(ProcessorObserver paramProcessorObserver)
  {
    synchronized (jdField_a_of_type_JavaUtilList)
    {
      jdField_a_of_type_JavaUtilList.add(paramProcessorObserver);
      return;
    }
  }
  ...
  {
    extraData.putLong("msgSeq", paramLong);
    if (paramBoolean1)
    {
      if (paramBoolean2) {
  ...
  {
    int i = MsgProxyUtils.a(???, jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    synchronized (jdField_a_of_type_JavaUtilList)
    {
      Iterator localIterator = jdField_a_of_type_JavaUtilList.iterator();
      if (localIterator.hasNext()) {
  ...
  protected void a(ArrayList paramArrayList1, ArrayList paramArrayList2, boolean paramBoolean)
  {
    if (paramArrayList1.size() > 0)
    {
      ...
      while (paramArrayList1.hasNext())
      {
        ...
        if (!MessageHandlerUtils.a(jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, paramBoolean)) {
  ...
  public void a(msg_svc.PbMsgReadedReportReq paramPbMsgReadedReportReq)
  {
    ...
    a(true, true, false, 0L, new njh(this, paramPbMsgReadedReportReq));
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, long paramLong, BaseMessageProcessor.RequestBuilder paramRequestBuilder)
  {
    ...
    for (;;)
    {
      ...
      jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramLong, localSendMessageHandler);
      i = 0;
      while (i < 9)
      {
        localSendMessageHandler.a(new njg(this, paramRequestBuilder, paramLong, l, paramBoolean2, paramBoolean3));
        i += 1;
      }
      i = 0;
      label168:
  ...
  {
    return MessageHandlerUtils.a(jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, paramBoolean);
  }
