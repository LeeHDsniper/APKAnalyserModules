...
public class GiftMessageUtils
{
  ...
  public static List a(MessageRecord paramMessageRecord)
  {
    ...
    int i2;
    int i1;
    if (((paramMessageRecord instanceof MessageForStructing)) && ((structingMsg instanceof AbsShareMsg)) && (structingMsg.mMsgServiceID == 52))
    {
      paramMessageRecord = (AbsShareMsg)structingMsg;
