  ...
  extends BaseMessageProcessor
{
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          try
          {
            ...
            paramArrayOfByte = (C2CType0x211_SubC2CType0xb.MsgBody.MsgHeader)msg_msg_header.get();
            if (paramArrayOfByte != null) {
              break label71;
            }
      ...
      return;
      l1 = uint64_to_uin.get();
      l2 = uint64_room_id.get();
      ...
      a.a().sendBroadcast(paramArrayOfByte);
    } while (!QLog.isColorLevel());
  ...
  public nkh a(int paramInt, MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    for (;;)
    {
      return new nkh(null, true);
      if ((paramMsgInfo != null) && (paramSvcReqPushMsg != null))
      {
        a(lUin, vMsg, lFromUin, (int)uMsgTime);
      }
      else
      {
        ...
        if ((paramMsgInfo != null) && (paramSvcReqPushMsg != null))
        {
          boolean bool = AbstractNetChannel.a(vMsg);
          a.a().a(lUin, vMsg, lFromUin, (int)uMsgTime, bool);
        }
        else
        {
          a(getClass().getName(), paramInt);
  ...
  public void a(long paramLong1, byte[] paramArrayOfByte, long paramLong2, int paramInt)
  {
    if ((!VcSystemInfo.e()) || (!VcSystemInfo.f()))
    {
      if (paramArrayOfByte[2] == 1) {
        VideoMsgTools.a(a, 0, 8, true, String.valueOf(paramLong2), String.valueOf(paramLong1), false, null, false, new Object[0]);
      }
      return;
    }
    if (paramArrayOfByte != null) {}
    for (String str = String.valueOf(paramArrayOfByte[2]);; str = "null")
    {
      ...
      Friends localFriends = ((FriendsManager)a.getManager(50)).c(String.valueOf(paramLong2));
      boolean bool = false;
      Object localObject2;
      Object localObject1;
      short s;
      ...
      for (;;)
      {
        ...
        ((Intent)localObject2).setClassName(a.getApplication().getPackageName(), "com.tencent.av.VideoMsgBroadcastReceiver");
        ...
        ((Intent)localObject2).putExtra("isPttRecordingOrPlaying", a.q());
        a.a().sendBroadcast((Intent)localObject2);
        if (!QLog.isColorLevel()) {
          break;
        }
