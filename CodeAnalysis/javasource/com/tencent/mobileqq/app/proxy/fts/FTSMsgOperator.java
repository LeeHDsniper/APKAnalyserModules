  ...
  extends FTSIndexOperator
{
  ...
  public ArrayList a(long paramLong, Pair paramPair)
  {
    if ((jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      localObject = jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a((FTSQueryArgs)localObject);
      if ((paramPair != null) && (localObject != null) && (!((ArrayList)localObject).isEmpty()))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          {
            matchTitle = ((CharSequence)first);
            matchSecondTitle = ((CharSequence)second);
          }
        }
      }
      return localObject;
  ...
  public ArrayList a(String paramString1, Class paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString2)
  {
    if ((jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      return jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a(paramString1);
    }
    if (QLog.isColorLevel()) {
      QLog.e("Q.fts.FTSMsgOperator", 2, "ftsDatabase not init");
    }
  ...
  public void a(MsgQueueItem paramMsgQueueItem, EntityManager paramEntityManager)
  {
    ...
    {
      if (jdField_a_of_type_AndroidContentContentValues == null) {
        return;
      }
      localObject1 = "SELECT * FROM " + b + " WHERE " + c + ";";
      localObject2 = new String[jdField_a_of_type_ArrayOfJavaLangString.length];
      int i = 0;
      while (i < jdField_a_of_type_ArrayOfJavaLangString.length)
      {
        localObject2[i] = jdField_a_of_type_ArrayOfJavaLangString[i];
        i += 1;
      }
      localObject1 = a().a((String)localObject1, b, c, (String[])localObject2, jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if ((localObject1 != null) && (SQLiteFTSUtils.a(jdField_a_of_type_AndroidContentContentValues))) {
    ...
    while (paramMsgQueueItem.hasNext())
    {
      ...
      if ((((MessageRecord)localObject1).isSupportFTS()) && (isValid) && (msgtype != 63530))
      {
        ...
        continue;
        if ((localObject1 != null) && (SQLiteFTSUtils.b(jdField_a_of_type_AndroidContentContentValues)))
        {
          localObject1 = ((List)localObject1).iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (MessageRecord)((Iterator)localObject1).next();
            if ((((MessageRecord)localObject2).isSupportFTS()) && (isValid) && (msgtype != 63530))
            {
              ...
              localObject2 = SQLiteFTSUtils.a(jdField_a_of_type_AndroidContentContentValues, (MessageRecord)localObject2);
  ...
  {
    if (((paramEntity instanceof MessageRecord)) && (((MessageRecord)paramEntity).isSupportFTS()) && (isValid) && (msgtype != 63530))
    {
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        ...
        if (paramBoolean)
        {
          ...
          jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a(paramFTSEntity);
          return;
        }
        jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramFTSEntity);
        if (d)
        {
          if (QLog.isColorLevel()) {
      ...
      } while ((!jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Pause) && (ReflectionUtil.a(BaseApplicationImpl.a)));
      if (QLog.isColorLevel()) {
  ...
  public boolean a(FTSDatatbase paramFTSDatatbase)
  {
    ...
    jdField_a_of_type_ComTencentMobileqqAppProxyFtsFTSUpgrader = new FTSMsgUpgrader(jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
    return jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a("IndexContent", true);
  }
  ...
  public void b(MsgQueueItem paramMsgQueueItem, EntityManager paramEntityManager)
  {
    ...
    if ((c != null) && (!TextUtils.isEmpty(c)))
    {
      localObject = "SELECT * FROM " + b + " WHERE " + c + ";";
      String[] arrayOfString = new String[jdField_a_of_type_ArrayOfJavaLangString.length];
      int i = 0;
      while (i < jdField_a_of_type_ArrayOfJavaLangString.length)
      {
        arrayOfString[i] = jdField_a_of_type_ArrayOfJavaLangString[i];
        i += 1;
      }
      paramMsgQueueItem = a().a((String)localObject, b, c, arrayOfString, jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    else
    {
      while (paramMsgQueueItem.hasNext())
      {
        ...
        if ((((MessageRecord)localObject).isSupportFTS()) && (isValid) && (msgtype != 63530))
        {
          ...
          mType = 1;
          mContent = "DELETE TABLE";
          mOId = Long.MIN_VALUE;
          uin = CharacterUtil.a(jdField_a_of_type_JavaLangString);
          istroop = h;
          ((FTSMessage)localObject).deleteOpt();
          paramEntityManager.b(FTSMessageCodec.a((FTSMessage)localObject));
        }
  ...
  {
    super.c();
    if (1 == SQLiteFTSUtils.b(jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      jdField_a_of_type_ComTencentMobileqqAppProxyFtsFTSSyncHandler.obtainMessage(1, this).sendToTarget();
    }
  }
  ...
  public void c(FTSEntity paramFTSEntity, boolean paramBoolean)
  {
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        ...
        {
          paramFTSEntity.preWrite();
          jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.b(paramFTSEntity);
          return;
        }
        jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramFTSEntity);
        if (d)
  ...
  public boolean c()
  {
    if (!b) {
      try
      {
        boolean bool = jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.b("SyncCursor");
        if (!bool) {
          if (!jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a("SyncCursor")) {
            return false;
          }
        }
      }
    ...
    for (int i = 0;; i = -1)
    {
      int j = i;
      if (i != 1) {
        j = jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a("SyncCursor");
      }
  ...
  {
    int j = 0;
    if ((!FTSDBManager.a) && (SQLiteFTSUtils.d(jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.fts.FTSMsgOperator", 2, "transToDatabase ENABLE = " + FTSDBManager.a + ", FTSUpgradeFlag = " + SQLiteFTSUtils.d(jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      }
    }
    label217:
    label296:
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          {
            return;
            jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a("msg_sync_log", "_id<=?", new String[] { String.valueOf(jdField_a_of_type_Int) });
            localObject = jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager();
            List localList = ((EntityManager)localObject).a(FTSMessageSync.class, "msg_sync_log", false, "_id>?", new String[] { String.valueOf(jdField_a_of_type_Int) }, null, null, "_id", "800");
            ...
            else
            {
              ...
              if ((mType != -1) && ((mOpt == 16) || (!TextUtils.isEmpty(mContent))) && (mOId != -1L)) {
                break label296;
              }
            }
            for (;;)
            {
              ...
              try
              {
                jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localObject);
              }
          ...
          {
            if (jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.isEmpty()) {
              break label456;
            }
        ...
        i = jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a(localArrayList);
      } while (i == -1);
