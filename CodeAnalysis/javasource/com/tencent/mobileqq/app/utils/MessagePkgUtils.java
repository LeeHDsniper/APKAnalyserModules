...
public class MessagePkgUtils
{
  ...
  public static byte[] a(MarkFaceMessage paramMarkFaceMessage, String paramString)
  {
    ...
    do
    {
      ...
      PkgTools.b(arrayOfByte2, 3, dwMSGItemType);
      arrayOfByte2[7] = ((byte)cFaceInfo);
      PkgTools.a(arrayOfByte2, 8, (short)wSize);
      i = sbufID.length;
      PkgTools.a(arrayOfByte2, 10, sbufID, i);
      PkgTools.a(arrayOfByte2, 26, dwTabID);
      arrayOfByte2[30] = ((byte)cSubType);
      i = sbfKey.length;
      PkgTools.a(arrayOfByte2, 31, sbfKey, i);
