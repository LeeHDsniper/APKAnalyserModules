  ...
  implements ImgConfHandler
{
  ...
  public PicAndAdConf(short paramShort, byte paramByte)
  {
    ...
    jdField_a_of_type_JavaUtilHashMap = new HashMap(8);
  }
  ...
  private boolean a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   145: ireturn
    //   146: aload_2
    //   147: invokevirtual 58	java/io/File:delete	()Z
    //   150: pop
    //   151: aload_2
    //   152: invokevirtual 76	java/io/File:createNewFile	()Z
    //   155: pop
    //   156: goto -47 -> 109
    //   159: astore_1
    //   160: aload 4
    ...
    //   166: ifnull -22 -> 144
    //   169: aload_1
    //   170: invokevirtual 92	java/io/FileOutputStream:close	()V
    //   173: iconst_0
    //   174: ireturn
    //   175: astore_1
    //   176: aload_1
    //   177: invokevirtual 166	java/io/IOException:printStackTrace	()V
    //   180: iconst_0
    //   181: ireturn
    //   182: astore_1
    //   183: aload_1
    //   184: invokevirtual 166	java/io/IOException:printStackTrace	()V
    //   187: iconst_1
    //   188: ireturn
    //   189: astore_1
    //   190: aload 5
    ...
    //   194: ifnull +7 -> 201
    //   197: aload_2
    //   198: invokevirtual 92	java/io/FileOutputStream:close	()V
    //   201: aload_1
    //   202: athrow
    //   203: astore_2
    //   204: aload_2
  ...
  private boolean b(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   101: astore_2
    //   102: aload 6
    //   104: invokevirtual 52	java/io/File:exists	()Z
    //   107: ifne +12 -> 119
    //   110: aload 4
    //   112: astore_2
    //   113: aload 6
    //   115: invokevirtual 160	java/io/File:mkdirs	()Z
    //   118: pop
    //   119: aload 4
    //   121: astore_2
    //   122: aload 7
    //   124: invokevirtual 52	java/io/File:exists	()Z
    //   127: ifne +57 -> 184
    //   130: aload 4
    //   132: astore_2
    //   133: aload 7
    //   135: invokevirtual 76	java/io/File:createNewFile	()Z
    //   138: pop
    //   139: aload 4
    //   141: astore_2
    //   142: new 78	java/io/FileOutputStream
    //   145: dup
    //   146: aload 7
    //   148: iconst_1
    //   149: invokespecial 81	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   152: astore 4
    //   154: aload 4
    //   156: aload_1
    //   157: invokevirtual 85	java/io/FileOutputStream:write	([B)V
    //   160: aload 4
    //   162: invokevirtual 89	java/io/FileOutputStream:flush	()V
    //   165: aload 4
    //   167: invokevirtual 92	java/io/FileOutputStream:close	()V
    //   170: iconst_0
    //   171: ifeq +11 -> 182
    //   174: new 162	java/lang/NullPointerException
    //   177: dup
    //   178: invokespecial 163	java/lang/NullPointerException:<init>	()V
    //   181: athrow
    //   182: iload_3
    //   183: ireturn
    //   184: aload 4
    //   186: astore_2
    //   187: aload 7
    //   189: invokevirtual 58	java/io/File:delete	()Z
    //   192: pop
    //   193: aload 4
    //   195: astore_2
    //   196: aload 7
    //   198: invokevirtual 76	java/io/File:createNewFile	()Z
    //   201: pop
    //   202: goto -63 -> 139
    //   205: astore 4
    //   207: aload 5
    ...
    //   210: aload_1
    //   211: astore_2
    //   212: invokestatic 126	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   215: ifeq +15 -> 230
    //   218: aload_1
    //   219: astore_2
    //   220: ldc 13
    ...
    //   223: ldc -84
    //   225: aload 4
    //   227: invokestatic 175	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   230: iconst_0
    //   231: istore_3
    //   232: aload_1
    //   233: ifnull -51 -> 182
    //   236: aload_1
    //   237: invokevirtual 92	java/io/FileOutputStream:close	()V
    //   240: iconst_0
    //   241: ireturn
    //   242: astore_1
    //   243: aload_1
    //   244: invokevirtual 166	java/io/IOException:printStackTrace	()V
    //   247: iconst_0
    //   248: ireturn
    //   249: astore_1
    //   250: aload_1
    //   251: invokevirtual 166	java/io/IOException:printStackTrace	()V
    //   254: iconst_1
    //   255: ireturn
    //   256: astore_1
    //   257: aload_2
    //   258: ifnull +7 -> 265
    //   261: aload_2
    //   262: invokevirtual 92	java/io/FileOutputStream:close	()V
    //   265: aload_1
    //   266: athrow
    //   267: astore_2
    //   268: aload_2
    //   269: invokevirtual 166	java/io/IOException:printStackTrace	()V
    //   272: goto -7 -> 265
    //   275: astore_1
    //   276: aload 4
    //   278: astore_2
  ...
  {
    if ((paramInt < 0) || (paramInt >= jdField_a_of_type_JavaUtilArrayList.size())) {
      return 0L;
    }
    return jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Long;
  }
  ...
  public android.graphics.Bitmap a(int paramInt)
  {
    ...
    //   17: iload_1
    //   18: aload_0
    //   19: getfield 179	com/tencent/mobileqq/config/struct/PicAndAdConf:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   22: invokevirtual 185	java/util/ArrayList:size	()I
    //   25: if_icmplt +10 -> 35
    //   28: aload 4
    //   30: astore 5
    //   32: aload 5
    ...
    //   37: astore 5
    //   39: aload_0
    //   40: getfield 179	com/tencent/mobileqq/config/struct/PicAndAdConf:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   43: iload_1
    //   44: invokevirtual 189	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   47: checkcast 191	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct
    //   50: astore 8
    //   52: aload 7
    //   54: astore 5
    //   56: aload 8
    //   58: getfield 201	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:jdField_a_of_type_Byte	B
    //   61: istore_2
    //   62: aload 4
    //   64: astore 5
    //   66: iload_2
    ...
    //   96: astore 5
    //   98: aload 8
    //   100: getfield 203	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:b	Ljava/lang/String;
    //   103: invokestatic 208	com/tencent/mobileqq/util/BitmapManager:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   106: astore 4
    //   108: aload 4
    //   110: areturn
    //   111: aload 7
    //   113: astore 5
    //   115: aload_0
    //   116: getfield 179	com/tencent/mobileqq/config/struct/PicAndAdConf:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   119: iload_1
    //   120: invokevirtual 189	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   123: checkcast 191	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct
    //   126: getfield 211	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:jdField_a_of_type_ArrayOfByte	[B
    //   129: astore 9
    //   131: aload 7
    //   133: astore 5
    //   135: aload_0
    //   136: getfield 179	com/tencent/mobileqq/config/struct/PicAndAdConf:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   139: iload_1
    //   140: invokevirtual 189	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   143: checkcast 191	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct
    //   146: getfield 213	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:c	Ljava/lang/String;
    //   149: astore 10
    //   151: aload 10
    //   153: ifnull +47 -> 200
    //   156: aload 7
    //   158: astore 5
    //   160: aload_0
    //   161: getfield 216	com/tencent/mobileqq/config/struct/PicAndAdConf:a_	B
    //   164: iconst_1
    //   165: if_icmpne +35 -> 200
    //   168: aload 7
    //   170: astore 5
    //   172: aload_0
    //   173: invokevirtual 218	com/tencent/mobileqq/config/struct/PicAndAdConf:a	()Z
    //   176: ifne +24 -> 200
    //   179: aload 7
    //   181: astore 5
    //   183: aload_0
    //   184: invokevirtual 220	com/tencent/mobileqq/config/struct/PicAndAdConf:b	()Z
    //   187: ifne +13 -> 200
    //   190: aload 7
    //   192: astore 5
    //   194: aload 10
    //   196: invokestatic 208	com/tencent/mobileqq/util/BitmapManager:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   199: areturn
    //   200: aload 10
    //   202: ifnull +94 -> 296
    //   205: aload 7
    //   207: astore 5
    //   209: aload_0
    //   210: getfield 216	com/tencent/mobileqq/config/struct/PicAndAdConf:a_	B
    //   213: ifne +83 -> 296
    //   216: aload 7
    //   218: astore 5
    //   220: new 48	java/io/File
    //   223: dup
    //   224: aload 10
    //   226: invokespecial 73	java/io/File:<init>	(Ljava/lang/String;)V
    //   229: invokevirtual 52	java/io/File:exists	()Z
    //   232: ifeq +45 -> 277
    //   235: aload 7
    //   237: astore 5
    //   239: aload 10
    //   241: invokestatic 225	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   244: astore 4
    //   246: aload 4
    //   248: ifnonnull +261 -> 509
    //   251: aload 8
    //   253: getfield 226	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:jdField_a_of_type_Boolean	Z
    //   256: ifeq +253 -> 509
    //   259: aload 8
    //   261: iconst_0
    //   262: putfield 226	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:jdField_a_of_type_Boolean	Z
    //   265: aload_0
    //   266: aload 8
    //   268: getfield 203	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:b	Ljava/lang/String;
    //   271: invokevirtual 229	com/tencent/mobileqq/config/struct/PicAndAdConf:b_	(Ljava/lang/String;)V
    //   274: aload 4
    //   276: areturn
    //   277: aload 7
    //   279: astore 5
    //   281: aload_0
    //   282: aload 8
    //   284: getfield 203	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:b	Ljava/lang/String;
    //   287: invokevirtual 229	com/tencent/mobileqq/config/struct/PicAndAdConf:b_	(Ljava/lang/String;)V
    //   290: aconst_null
    //   291: astore 4
    //   293: goto -19 -> 274
    //   296: aload 7
    //   298: astore 5
    //   300: aload 10
    //   302: invokestatic 235	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   305: ifne +143 -> 448
    //   308: aload 7
    //   310: astore 5
    //   312: aload_0
    //   313: getfield 216	com/tencent/mobileqq/config/struct/PicAndAdConf:a_	B
    //   316: iconst_2
    ...
    //   327: dup
    //   328: aload 10
    //   330: invokespecial 73	java/io/File:<init>	(Ljava/lang/String;)V
    //   333: invokevirtual 52	java/io/File:exists	()Z
    //   336: istore_3
    //   337: aload 6
    //   339: astore 4
    //   341: iload_3
    ...
    //   347: astore 5
    //   349: aload 10
    //   351: invokestatic 225	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   354: astore 4
    //   356: aload 4
    //   358: astore 5
    //   360: aload 4
    ...
    //   369: aload_0
    //   370: aload 8
    //   372: getfield 203	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:b	Ljava/lang/String;
    //   375: invokevirtual 229	com/tencent/mobileqq/config/struct/PicAndAdConf:b_	(Ljava/lang/String;)V
    //   378: aload 4
    //   380: areturn
    //   381: astore 6
    //   383: aload 5
    ...
    //   387: aload 4
    //   389: astore 5
    //   391: invokestatic 126	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   394: ifeq -362 -> 32
    //   397: ldc -19
    //   399: iconst_2
    //   400: aload 6
    //   402: invokestatic 241	com/tencent/qphone/base/util/QLog:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   405: invokestatic 244	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   408: aload 4
    //   410: areturn
    //   411: astore 9
    //   413: aload 6
    ...
    //   417: aload 7
    //   419: astore 5
    //   421: invokestatic 126	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   424: ifeq -68 -> 356
    //   427: aload 7
    //   429: astore 5
    //   431: ldc 13
    ...
    //   434: ldc -10
    //   436: aload 9
    //   438: invokestatic 175	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   441: aload 6
    //   443: astore 4
    //   445: goto -89 -> 356
    //   448: aload 4
    ...
    //   476: aload 9
    //   478: arraylength
    //   479: invokestatic 250	android/graphics/BitmapFactory:decodeByteArray	([BII)Landroid/graphics/Bitmap;
    //   482: astore 4
    //   484: aload 4
    //   486: areturn
    //   487: astore 4
    ...
    //   7	478	4	localObject1	Object
    //   487	1	4	localOutOfMemoryError	OutOfMemoryError
    //   491	1	4	localThrowable1	Throwable
    //   501	1	4	localException1	Exception
    //   505	1	4	localThrowable2	Throwable
    //   11	457	5	localObject2	Object
    //   1	337	6	localObject3	Object
    //   381	109	6	localThrowable3	Throwable
    //   496	1	6	localThrowable4	Throwable
    //   4	454	7	localObject4	Object
  ...
  public String a(int paramInt)
  {
    ...
    return jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_JavaLangString;
  }
    ...
    for (;;)
    {
      ...
      if (!paramString.startsWith("/"))
      {
        ...
        if ((paramString.startsWith("http://")) && (!paramString.endsWith(".png")))
        {
          ...
          } else if ((a_ == 1) && (paramString.contains("[]"))) {
  ...
  public short a(int paramInt)
  {
    ...
    return jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Short;
  }
  ...
  {
    jdField_a_of_type_Short = paramDataInputStream.readShort();
    jdField_a_of_type_Long = paramDataInputStream.readLong();
    b = paramDataInputStream.readLong();
    c = paramDataInputStream.readLong();
    a_ = paramDataInputStream.readByte();
  ...
  {
    paramDataOutputStream.writeShort(jdField_a_of_type_Short);
    paramDataOutputStream.writeLong(jdField_a_of_type_Long);
    paramDataOutputStream.writeLong(b);
    paramDataOutputStream.writeLong(c);
    paramDataOutputStream.writeByte(a_);
    ...
    if (j < k)
    {
      localPicStruct = (PicAndAdConf.PicStruct)jdField_a_of_type_JavaUtilArrayList.get(j);
      if (a_ != 2) {
        break label117;
      }
  ...
  public void a(String paramString, byte[] arg2)
  {
    if ((??? == null) || (???.length <= 0) || (paramString == null) || (paramString.length() <= 0))
    {
      if (!TextUtils.isEmpty(paramString)) {
        ...
        {
          jdField_a_of_type_JavaUtilHashMap.put(paramString, Long.valueOf(System.currentTimeMillis()));
          return;
        }
      }
    }
    else
    {
      ...
      while (j < jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        if (paramString.startsWith(b))
        {
          if (a_ == 1)
          {
            c = (BaseApplication.getContext().getFilesDir().getAbsolutePath() + "/" + "flashlogo.png");
            a(???, c, b);
            ...
            while (???.hasNext()) {
              ((ConfigListener)???.next()).a(true, jdField_a_of_type_Short, j, paramString);
            }
          }
          if (a_ == 0)
          {
            ...
            {
              ??? = new File(c);
              if (!MD5.getFileMD5(???).equalsIgnoreCase(f))
              {
                ???.delete();
          ...
          for (;;)
          {
            try
            {
              ...
              QLog.d("PicAndAdConf", 2, "handle download NearbyBanner image, cid = " + jdField_a_of_type_Long + ", md5 is " + paramString.equalsIgnoreCase(f));
              return;
            }
            ...
            QLog.d("PicAndAdConf", 2, "handleImgData exception, item md5 = " + f, paramString);
            return;
            label517:
            synchronized (jdField_a_of_type_JavaUtilHashMap)
            {
              jdField_a_of_type_JavaUtilHashMap.put(b, Long.valueOf(System.currentTimeMillis()));
            }
          }
        }
        j += 1;
  ...
  public String b(int paramInt)
  {
    ...
    return jdField_a_of_type_JavaUtilArrayList.get(paramInt)).e;
  }
  ...
  public void b(HttpMsg paramHttpMsg1, HttpMsg paramHttpMsg2)
  {
    ...
    while (j < jdField_a_of_type_JavaUtilArrayList.size())
    {
      paramHttpMsg2 = (PicAndAdConf.PicStruct)jdField_a_of_type_JavaUtilArrayList.get(j);
      if (paramHttpMsg1.a().startsWith(b))
      {
        ...
        while (paramHttpMsg2.hasNext()) {
          ((ConfigListener)paramHttpMsg2.next()).a(false, jdField_a_of_type_Short, j, paramHttpMsg1.a());
        }
      }
      j += 1;
    }
  ...
  public void b_(String paramString)
  {
    ...
    do
    {
      ...
      if (a_ == 2) {
        synchronized (jdField_a_of_type_JavaUtilHashMap)
        {
          if ((jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)) && (Math.abs(System.currentTimeMillis() - ((Long)jdField_a_of_type_JavaUtilHashMap.get(paramString)).longValue()) < 36000L))
          {
            if (QLog.isColorLevel()) {
  ...
  public String c(int paramInt)
  {
    ...
    return jdField_a_of_type_JavaUtilArrayList.get(paramInt)).f;
  }
  ...
  public String d(int paramInt)
  {
    ...
    return jdField_a_of_type_JavaUtilArrayList.get(paramInt)).d;
  }
    ...
    if (a_ == 2)
    {
      ...
      if (j < jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        for (;;)
        {
          ...
          break;
          label92:
          localStringBuilder.append(" | ").append(jdField_a_of_type_Long);
          ThreadManager.a(new nuo(this, localPicStruct), 5, null, false);
        }
      }
      if (QLog.isColorLevel()) {
