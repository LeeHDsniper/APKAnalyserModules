  ...
  implements Observer
{
  ...
  private void a(Object paramObject)
  {
    ...
    case 39: 
      if (((Boolean)paramObject[1]).booleanValue())
      {
        ...
        jdField_a_of_type_JavaLangObject = context;
        jdField_a_of_type_JavaLangString = fileId;
        b = filePath;
        jdField_a_of_type_Int = type.ordinal();
        QLog.i("FMObserver<FileAssistant>", 1, "OnThumbDownLoadSuccess,fileId[" + jdField_a_of_type_JavaLangString + "],filePath[" + b + "]");
        if ((jdField_a_of_type_JavaLangObject != null) && (filePath != null) && (filePath.length() > 0))
        {
          if (!(jdField_a_of_type_JavaLangObject instanceof WeiYunFileInfo)) {
            break label3262;
          }
          context).g = filePath;
        }
        for (;;)
        {
          a(paramObject);
          return;
          if ((jdField_a_of_type_JavaLangObject instanceof OfflineFileInfo)) {
            context).c = filePath;
          } else if ((jdField_a_of_type_JavaLangObject instanceof FileManagerEntity)) {
            context).strThumbPath = filePath;
          }
        }
      }
      localObject1 = (Object[])paramObject[2];
      ...
      jdField_a_of_type_JavaLangObject = localObject1[1];
      localObject1 = new Handler();
      QLog.i("FMObserver<FileAssistant>", 1, "OnThumbDownLoadSuccess(faild),fileId[" + jdField_a_of_type_JavaLangString + "],delay 1000ms");
      ((Handler)localObject1).postDelayed(new orh(this, paramObject), 1000L);
      return;
    case 40: 
      if (((Boolean)paramObject[1]).booleanValue())
      {
    ...
    case 50: 
      ...
      if (bool)
      {
        ...
        jdField_a_of_type_JavaLangString = Uuid;
        b = strThumbPath;
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    {
      new Handler(paramObservable).post(new org(this, paramObject));
      return;
    }
    a(paramObject);
  }
