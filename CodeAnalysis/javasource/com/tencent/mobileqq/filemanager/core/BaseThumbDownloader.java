  ...
  implements ThumbHttpDownloader.WhatHappen
{
  ...
  protected final BaseThumbDownloader.Session a(long paramLong)
  {
    ...
    {
      BaseThumbDownloader.Session localSession = (BaseThumbDownloader.Session)jdField_a_of_type_JavaUtilLinkedHashMap.get(Long.valueOf(paramLong));
      return localSession;
    }
  }
  ...
  public final void a(long paramLong, boolean paramBoolean, String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramLong, paramBoolean, paramString1, paramInt, paramString2, paramString3);
  }
  ...
  protected final void a(BaseThumbDownloader.Session paramSession)
  {
    ...
    synchronized (jdField_a_of_type_JavaUtilLinkedHashMap)
    {
      QLog.i("BaseThumbDownloader<FileAssistant>", 2, "[downloadThumb]  ID[" + a + "] addSession");
      jdField_a_of_type_JavaUtilLinkedHashMap.put(Long.valueOf(a), paramSession);
      return;
    }
  }
  ...
  {
    a = jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString, this);
    a(paramSession);
    jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a();
  }
