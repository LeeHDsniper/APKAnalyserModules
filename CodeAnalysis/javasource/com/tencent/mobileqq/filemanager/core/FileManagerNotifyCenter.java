  ...
  extends Observable
{
  ...
  public FileManagerNotifyCenter(QQAppInterface paramQQAppInterface)
  {
    ...
    jdField_a_of_type_MqqOsMqqHandler = new osc(this, Looper.getMainLooper());
    jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.a(getClass(), jdField_a_of_type_MqqOsMqqHandler);
  }
  ...
  private void b(FileManagerEntity paramFileManagerEntity, int paramInt, String paramString)
  {
    ...
    ((HashMap)localObject).put("peerUin", String.valueOf(peerUin));
    ((HashMap)localObject).put("fileType", FileUtil.a(fileName));
    switch (paramInt)
    {
    default: 
      QLog.e("FileManagerNotifyCenter<FileAssistant>", 1, "what type is report?!nSessionId[" + String.valueOf(nSessionId) + "],may be not report!");
      return;
    case 5: 
      return;
    case 6: 
    ...
    for (;;)
    {
      FileManagerUtil.a(jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, nSessionId, (String)localObject, 1L, paramString, peerUin, Uuid, strFileMd5, 0L, 0L, fileSize, 0, null);
      return;
  ...
  public void a(FileManagerEntity paramFileManagerEntity, int paramInt, String paramString)
  {
    ...
    ThreadManager.a(new osd(this, paramFileManagerEntity, paramInt), 8, null, true);
  }
