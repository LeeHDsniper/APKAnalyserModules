...
public class PrivacyInfoUtil
{
  ...
  public PrivacyInfoUtil()
  {
    ...
    jdField_a_of_type_JavaLangString = "PrivacyInfoUtil";
    jdField_b_of_type_JavaLangString = "DESede/ECB/PKCS5Padding";
    jdField_c_of_type_JavaLangString = "random";
    jdField_a_of_type_JavaUtilArrayList = new ArrayList(10);
    jdField_a_of_type_Byte = 0;
    jdField_a_of_type_ArrayOfByte = "gavinhuangdaydayup_happy".getBytes();
    jdField_b_of_type_ArrayOfByte = "doscarlettmarryrenzzhang".getBytes();
    jdField_c_of_type_ArrayOfByte = "wangpeilin_georgewangson".getBytes();
    jdField_d_of_type_ArrayOfByte = "georgebirthdayis19790526".getBytes();
    e = "qlinkwillthebestfunction".getBytes();
    f = "qqwillbebetterthanwechat".getBytes();
    g = "whowillbethenextbigtiger".getBytes();
    h = "whenwillwefindmahang_370".getBytes();
    i = "whenwillchinagetworldcap".getBytes();
    ...
    j = null;
    jdField_a_of_type_JavaUtilArrayList.add(jdField_a_of_type_ArrayOfByte);
    jdField_a_of_type_JavaUtilArrayList.add(jdField_b_of_type_ArrayOfByte);
    jdField_a_of_type_JavaUtilArrayList.add(jdField_c_of_type_ArrayOfByte);
    jdField_a_of_type_JavaUtilArrayList.add(jdField_d_of_type_ArrayOfByte);
  ...
  {
    String str = (String)jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
    if (str != null) {
      return str;
    }
    ...
    jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), str);
    return str;
  }
