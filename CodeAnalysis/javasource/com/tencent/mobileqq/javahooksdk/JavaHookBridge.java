...
public class JavaHookBridge
{
    ...
    throws Throwable
  {
    ...
    for (;;)
    {
      ...
      {
        throwable = paramMember.getTargetException();
        continue;
      }
      catch (Exception paramMember)
      {
        throwable = paramMember;
        continue;
      }
      ...
      break;
      result = invokeOriginMethod(paramMember, paramObject, paramArrayOfObject);
    }
    label202:
    return result;
  }
    ...
    throws InvocationTargetException
  {
    ...
    if (localObject != null) {
      return invokeOriginMethodNative(paramMember, getMethodId(paramMember), paramObject, paramArrayOfObject, paramTypes, returnType);
    }
    localObject = null;
