...
class a
{
  ...
  public SimpleAccount p()
  {
    ...
    localSimpleAccount.setUin(c);
    localSimpleAccount.setAttribute("_isLogined", String.valueOf(w));
    localSimpleAccount.setAttribute("_loginTime", String.valueOf(v));
    localSimpleAccount.setAttribute("_loginedProcess", y);
  ...
  public String q()
  {
    ...
    localStringBuilder.append(",uin=").append(c);
    if (n() > 0L) {
      localStringBuilder.append(",loginTime=").append(n());
    }
    localStringBuilder.append(",active=").append(w);
    ...
    localStringBuilder.append(",loginedProcess=").append(y);
