...
public class d
{
  ...
  {
    long l1 = e.a.getWtLoginCenter().a(paramString, 64);
    long l2 = e.a.getWtLoginCenter().a(paramString, 262144);
    if (l1 > l2) {
      return l2;
    }
    return l1;
  ...
  {
    long l1 = e.a.getWtLoginCenter().a(paramString, 4096);
    long l4 = e.a.getWtLoginCenter().a(paramString, 524288);
    long l3 = e.a.getWtLoginCenter().a(paramString, 131072);
    long l2 = e.a.getWtLoginCenter().a(paramString, 32);
    long l5 = e.a.getWtLoginCenter().a(paramString, 1048576);
    if (l1 > l4)
    {
      l1 = l4;
      if (l1 <= l3) {
  ...
  public void a()
  {
    ...
    while ((l1 < l) || (l1 - l >= com.tencent.mobileqq.msf.core.a.a.A()))
    {
      do
      {
        String str;
      ...
      } while (l1 - l >= com.tencent.mobileqq.msf.core.a.a.A());
      return;
    }
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          Iterator localIterator = SigList.iterator();
          ...
          while (localIterator.hasNext())
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d("MSF.C.TokenChecker", 2, "onChangeTokenResult, content.ulSigType=" + ulSigType + ", uin=" + str);
            }
            QLog.d("MSF.C.TokenChecker", 1, "iSimplified for " + MsfSdkUtils.getShortUin(str));
            if (ulSigType == 0L) {
              localObject = SigContent;
            } else if (ulSigType == 18L) {
              paramFromServiceMsg = SigContent;
            } else if (ulSigType == 20L) {
              paramToServiceMsg = SigContent;
            }
          }
        } while ((localObject == null) || (paramFromServiceMsg == null) || (paramToServiceMsg == null));
        l1 = System.currentTimeMillis();
      } while (l1 - e.n(str).A() <= 1800000L);
      if (QLog.isColorLevel()) {
        QLog.d("MSF.C.TokenChecker", 2, "renew A2 D2 succ, uin=" + str);
      }
      e.a(str, (byte[])localObject, paramFromServiceMsg, paramToServiceMsg, l1);
  ...
  void c()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      {
        l4 = a(str);
        long l2 = com.tencent.mobileqq.msf.core.a.a.ab();
        l1 = l2;
        if (l2 <= 0L) {
          l1 = 604800000L;
        }
        ...
        if (l3 - l4 > l1 + d())
        {
          ...
          e.a.changeTokenAfterLogin((ToServiceMsg)localObject, true);
          n = 1;
          m = n;
          if (QLog.isColorLevel())
          {
        ...
        l4 = b(str);
        l2 = com.tencent.mobileqq.msf.core.a.a.ac();
        l1 = l2;
        if (l2 <= 0L) {
          l1 = 21600000L;
        }
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        if ((!h) || (l3 - l4 > l1) || (e.a.getWtLoginCenter().b(str)))
        {
        ...
        try
        {
          Thread.sleep(com.tencent.mobileqq.msf.core.a.a.B());
        }
