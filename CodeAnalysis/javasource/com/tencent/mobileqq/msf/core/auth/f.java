...
public class f
{
  ...
  public void a(UniPacket paramUniPacket, a paramA)
  {
    ...
    if (localObject != null)
    {
      ...
      if (i1 < SigList.size())
      {
        CustomSigContent localCustomSigContent = (CustomSigContent)SigList.get(i1);
        if (ulSigType == 1L) {
          paramA.l(SigContent);
        }
        for (;;)
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, UniPacket paramUniPacket, k paramK)
  {
    ...
    wupSeq = paramUniPacket.getRequestId();
    if (b == 0)
    {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("MSF.C.AuthCoder", 2, "rece loginVerifyCode seq:" + paramFromServiceMsg.getRequestSsoSeq() + " uin:" + paramFromServiceMsg.getUin() + " cmd:" + paramFromServiceMsg.getServiceCmd() + " svrseqNo:" + svrSeqNo + " vipsid:" + vpicSid + " wupSeq:" + wupSeq);
      }
      if (QLog.isColorLevel()) {
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, k paramK)
  {
    ...
    for (;;)
    {
      try
      {
        n.a.getWtLoginCenter().a(localA, true);
        n.a.sender.a(paramFromServiceMsg.getAppId(), paramFromServiceMsg.getUin());
        paramFromServiceMsg.addAttribute("resp_simpleAccount", localA.p().toStoreString());
        n.a.addRespToQuque(paramToServiceMsg, paramFromServiceMsg);
        return;
      }
  ...
  public byte[] a(int paramInt, String paramString, VerifyCodeInfo paramVerifyCodeInfo)
  {
    ...
    localUniPacket.setRequestId(wupSeq);
    return localUniPacket.encode();
  }
  ...
  public byte[] a(int paramInt, String paramString1, String paramString2, VerifyCodeInfo paramVerifyCodeInfo)
  {
    ...
    localUniPacket.put("RequestVerifyPic", new com.tencent.msf.service.protocol.security.h(vpicSid, paramString2));
    localUniPacket.setRequestId(wupSeq);
    return localUniPacket.encode();
  }
  ...
  public byte[] a(int paramInt1, String paramString, byte[] paramArrayOfByte1, int paramInt2, int paramInt3, byte[] paramArrayOfByte2)
  {
    ...
    localUniPacket.setFuncName("cmdstr");
    n.b(paramString);
    a localA = (a)n.b.get(paramString);
    ...
    paramString = new c();
    a = ((int)(System.currentTimeMillis() / 1000L) + n.e());
