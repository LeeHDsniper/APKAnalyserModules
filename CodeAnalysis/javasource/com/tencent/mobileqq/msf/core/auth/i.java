...
public class i
{
  ...
  public static int a(WUserSigInfo paramWUserSigInfo, String paramString1, String paramString2, byte[] paramArrayOfByte, int paramInt, boolean paramBoolean, WtloginMsfListener paramWtloginMsfListener)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MSF.C.WTLoginCenter.MsfProvider", 2, "SendData uin:" + paramString1 + " serviceCmd:" + paramString2 + " timeout:" + paramInt + " isWTSendSelf:" + paramBoolean + " wUserSigInfo:" + HexUtil.bytes2HexStr(_reserveData));
    }
    Object localObject;
    ...
    if (!paramBoolean)
    {
      ...
      c = paramWtloginMsfListener;
      localToServiceMsg2 = d;
      if ((localToServiceMsg2.getMsfCommand() == MsfCommand.wt_name2uin) && (paramString2.equals("wtlogin.login"))) {
        e.getAccountCenter().a(localToServiceMsg2.getUin(), paramString1);
      }
    ...
    for (;;)
    {
      ...
      return e.sendSsoMsg(localToServiceMsg1);
      label347:
      paramWtloginMsfListener = (WtloginMsfListener)localObject;
      paramWUserSigInfo = localMsfCommand;
      localToServiceMsg1 = localToServiceMsg2;
  ...
  static k a(MsfCore paramMsfCore, ToServiceMsg paramToServiceMsg)
  {
    try
    {
      ...
      d = paramToServiceMsg;
      paramMsfCore = (MsfCore)localObject;
      b.put(Integer.valueOf(d.getRequestSsoSeq()), localObject);
      return localObject;
    }
    catch (Exception paramToServiceMsg)
    {
  ...
  public static void a(MsfCore paramMsfCore, WtloginHelper paramWtloginHelper, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, String paramString, WUserSigInfo paramWUserSigInfo)
  {
    ...
    for (String str = String.valueOf(_uin);; str = paramString)
    {
      ...
      if (paramWtloginHelper.GetBasicUserInfo(paramString, localWloginSimpleInfo).booleanValue())
      {
        ((a)localObject).b(_age[0]);
        ((a)localObject).n(_nick);
        if (_gender[0] == 1)
        {
          i = 1;
          ((a)localObject).c(i);
          ((a)localObject).a(util.buf_to_int16(_face, 0));
        }
      }
      else
      {
  ...
  public static void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      c.onReceiveData(paramFromServiceMsg.getUin(), paramFromServiceMsg.getServiceCmd(), (byte[])localObject);
      return;
    }
    c.onReceiveFail(paramFromServiceMsg.getUin(), paramFromServiceMsg.getServiceCmd(), paramFromServiceMsg.getBusinessFailCode());
  }
  ...
  public static void a(String paramString1, MsfCore paramMsfCore, long paramLong, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, String paramString2)
  {
    try
    {
      ...
      if (paramFromServiceMsg.getAttribute("timeLimit") != null) {
        TimeLimit = ((Integer)paramFromServiceMsg.getAttribute("timeLimit")).intValue();
      }
      if ((paramString1 != null) && (QLog.isColorLevel()) && (QLog.isColorLevel())) {
        QLog.d("MSF.C.WTLoginCenter.MsfProvider", 2, "GetDevLockInfo: " + Mobile + " " + DevSetup);
      }
  ...
  public static WUserSigInfo b(int paramInt)
  {
    try
    {
      ...
      _reserveData = MsfSdkUtils.convertInt2Bytes(paramInt);
  ...
  public static void b(String paramString1, MsfCore paramMsfCore, long paramLong, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, String paramString2)
  {
    try
    {
      ...
      VerifyCodeInfo localVerifyCodeInfo = new VerifyCodeInfo();
      ssoSeq = paramFromServiceMsg.getRequestSsoSeq();
      verifyimage = arrayOfByte;
      try
      {
        verifyNote = a(paramString1, h.e.GetPicturePrompt(paramString1, paramLong));
        VerifyCodeInfo.putVerifyCodeInfo(paramFromServiceMsg, localVerifyCodeInfo);
  ...
  public static int c(WUserSigInfo paramWUserSigInfo)
  {
    try
    {
      int i = MsfSdkUtils.convertBytes2Int(_reserveData);
      return i;
    }
    catch (Exception localException)
    {
  ...
  {
    // Byte code:
    //   0: invokestatic 606	com/tencent/mobileqq/msf/core/a/a:aY	()Ljava/util/HashSet;
    //   3: astore_3
    //   4: new 60	oicq/wlogin_sdk/request/WUserSigInfo
    //   7: dup
    //   8: invokespecial 562	oicq/wlogin_sdk/request/WUserSigInfo:<init>	()V
    //   11: astore_2
    //   12: aload_2
    //   13: iload_0
    //   14: invokestatic 566	com/tencent/mobileqq/msf/sdk/MsfSdkUtils:convertInt2Bytes	(I)[B
    ...
    //   23: ifnull +68 -> 91
    //   26: aload_3
    //   27: invokevirtual 612	java/util/HashSet:iterator	()Ljava/util/Iterator;
    //   30: astore_3
    //   31: aload_2
    //   32: astore_1
    //   33: aload_3
    //   34: invokeinterface 617 1 0
    //   39: ifeq +52 -> 91
    //   42: aload_2
    //   43: getfield 621	oicq/wlogin_sdk/request/WUserSigInfo:_domains	Ljava/util/List;
    //   46: aload_3
    //   47: invokeinterface 625 1 0
    //   52: invokeinterface 630 2 0
    //   57: pop
    //   58: goto -27 -> 31
    //   61: astore_1
    //   62: ldc 8
    ...
    //   85: aload_1
    //   86: invokestatic 570	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   89: aconst_null
    //   90: astore_1
    //   91: aload_1
    //   92: areturn
