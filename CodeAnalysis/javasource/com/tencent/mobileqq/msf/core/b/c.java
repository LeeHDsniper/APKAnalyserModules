  ...
  extends BroadcastReceiver
{
  ...
  {
    n = (MsfSdkUtils.getProcessName(paramContext) + "_" + getClass().hashCode());
    paramContext = new IntentFilter();
    paramContext.addAction(n);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("MSF.C.MonitorNetFlowStore", 2, "write data : " + b.size() + " | read data : " + c.size() + ", starting to store.");
      }
      ...
      while (localIterator.hasNext())
      {
        ...
        localA = (a)b.get(str);
        if (QLog.isColorLevel()) {
          QLog.d("MSF.C.MonitorNetFlowStore", 2, "mType|" + h + "|" + b + "|" + d + "|write|" + f + "|" + g + "|" + i + "|" + a);
        }
        q.execSQL("insert into dataflow(processName, uin, ip, refer, port, flag, buffersize, networktype, mType, curtime, status) values(?,?,?,?,?,?,?,?,?,?,?)", new Object[] { a, k.sender.e(), b, c, Integer.valueOf(d), Integer.valueOf(e), Long.valueOf(f), Integer.valueOf(g), h, Long.valueOf(l1), Byte.valueOf(i) });
        i1 = (int)(i1 + b.get(str)).f);
        b.remove(str);
      }
      ...
      while (localIterator.hasNext())
      {
        ...
        localA = (a)c.get(str);
        if (QLog.isColorLevel()) {
          QLog.d("MSF.C.MonitorNetFlowStore", 2, "mType|" + h + "|" + b + "|" + d + "|read|" + f + "|" + g + "|" + i + "|" + a);
        }
        q.execSQL("insert into dataflow(processName, uin, ip, refer, port, flag, buffersize, networktype, mType, curtime, status) values(?,?,?,?,?,?,?,?,?,?,?)", new Object[] { a, k.sender.e(), b, c, Integer.valueOf(d), Integer.valueOf(e), Long.valueOf(f), Integer.valueOf(g), h, Long.valueOf(l1), Byte.valueOf(i) });
        long l2 = i2;
        i2 = (int)(c.get(str)).f + l2);
        c.remove(str);
      }
  ...
  public void a(long paramLong)
  {
    ...
    localIntent.setAction(n);
    o = PendingIntent.getBroadcast(BaseApplication.getContext(), 0, localIntent, 0);
    m = ((AlarmManager)BaseApplication.getContext().getSystemService("alarm"));
    if (QLog.isColorLevel()) {
      m.setRepeating(0, paramLong, 300000L, o);
    }
    for (;;)
    {
      QLog.d("MSF.C.MonitorNetFlowStore", 1, "register " + n.hashCode() + " alarm alive send at " + i.format(Long.valueOf(paramLong)));
      return;
      m.setRepeating(0, paramLong, 600000L, o);
    }
  }
  ...
  public void a(a paramA)
  {
    try
    {
      ...
      {
      case 0: 
        localA = (a)b.get(h + g + i);
        if (localA != null)
        {
          b.put(h + g + i, localA.a(f));
          return;
        }
        break;
      }
    ...
    b.put(h + g + i, paramA);
    return;
    a localA = (a)c.get(h + g + i);
    if (localA != null)
    {
      c.put(h + g + i, localA.a(f));
      return;
    }
    c.put(h + g + i, paramA);
    return;
  ...
  public void a(ToServiceMsg paramToServiceMsg)
  {
    for (;;)
    {
      try
      {
        ...
        a = paramToServiceMsg.getString("processName");
        i = paramToServiceMsg.getByte("status");
        ...
        if (i1 != -1)
        {
          ...
          {
            h = paramToServiceMsg.getString("mType");
            a(localA);
            return;
          }
          h = paramToServiceMsg.getString("mType").substring(0, i1);
          continue;
        }
        h = paramToServiceMsg.getString("mType");
      }
  ...
  public java.util.HashMap b(long paramLong, boolean paramBoolean)
  {
    ...
    //   548	534	16	localStringBuilder	StringBuilder
    // Exception table:
    //   from	to	target	type
