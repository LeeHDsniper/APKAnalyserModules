  ...
  public void run()
  {
      ...
      if ((localObject1 != null) && (((String)localObject1).length() > 0)) {
        try
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            i.c.a("actNetworkFlowCollection", true, 0L, b, c, false, false);
            localObject6 = c.entrySet().iterator();
            while (((Iterator)localObject6).hasNext())
            {
              localObject7 = (Map.Entry)((Iterator)localObject6).next();
              if (!((String)((Map.Entry)localObject7).getKey()).equals("uin")) {
                QLog.d("MSF.C.NetworkTraffic", 1, "reportRDM for " + MsfSdkUtils.getShortUin(a) + " " + (String)((Map.Entry)localObject7).getKey() + ":" + (String)((Map.Entry)localObject7).getValue());
              }
            }
          }
          try
          {
            localIterator = aa.entrySet().iterator();
            if (localIterator.hasNext())
            {
              localObject5 = (Map.Entry)localIterator.next();
              localObject6 = new StringBuffer();
              localObject7 = getValuec.entrySet().iterator();
      ...
      if ((localObject2 != null) && (((String)localObject2).length() > 0)) {
        try
        {
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            i.c.a("monitorNetFlowResultReportRDM", true, 0L, b, c, false, false);
            localObject6 = c.entrySet().iterator();
            while (((Iterator)localObject6).hasNext())
            {
              localObject7 = (Map.Entry)((Iterator)localObject6).next();
              if (!((String)((Map.Entry)localObject7).getKey()).equals("uin")) {
                QLog.d("MSF.C.MonitorNetFlowStore", 1, "reportRDM new netflow for " + MsfSdkUtils.getShortUin(a) + " " + (String)((Map.Entry)localObject7).getKey() + ":" + (String)((Map.Entry)localObject7).getValue());
              }
            }
          }
      ...
      if ((localObject3 != null) && (((String)localObject3).length() > 0)) {
        try
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            i.c.a("monitorNetFlowCautionReportRDM", true, 0L, b, c, false, false);
            localObject6 = c.entrySet().iterator();
            while (((Iterator)localObject6).hasNext())
            {
              localObject7 = (Map.Entry)((Iterator)localObject6).next();
              if (!((String)((Map.Entry)localObject7).getKey()).equals("uin")) {
                QLog.d("MSF.C.MonitorNetFlowStore", 1, "reportRDM caution netflow for " + MsfSdkUtils.getShortUin(a) + " " + (String)((Map.Entry)localObject7).getKey() + ":" + (String)((Map.Entry)localObject7).getValue());
              }
            }
          }
    ...
    try
    {
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        i.c.a("monitorNetFlowResultReportRDMWithStatus", true, 0L, b, c, false, false);
        localObject6 = c.entrySet().iterator();
        while (((Iterator)localObject6).hasNext())
        {
          localObject7 = (Map.Entry)((Iterator)localObject6).next();
          if (!((String)((Map.Entry)localObject7).getKey()).equals("uin")) {
            QLog.d("MSF.C.MonitorNetFlowStore", 1, "reportRDM new netflow with status for " + MsfSdkUtils.getShortUin(a) + " " + (String)((Map.Entry)localObject7).getKey() + ":" + (String)((Map.Entry)localObject7).getValue());
          }
        }
      }
      return;
