...
public class g
{
    ...
    throws Exception
  {
    ...
    //   15: aload_0
    //   16: getfield 36	com/tencent/mobileqq/msf/core/net/b/g:f	I
  ...
  public a a()
  {
    String str1 = "Traceroute start host: " + c + " maxTTL: " + e + " timeout: " + f + "s";
    if (b) {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((c.equals(str1)) || (d.equals(str1)))
        {
          ...
          str1 = "Traceroute succ host: " + c + "(" + d + ") TTL: " + g.a;
          localStringBuilder.append(str1).append("\n");
          if (b) {
            QLog.d("Traceroute", 1, str1);
          }
      ...
      break;
      label420:
      String str2 = "Traceroute fail host: " + c + "(" + d + ") TTL: " + g.a;
    }
  }
