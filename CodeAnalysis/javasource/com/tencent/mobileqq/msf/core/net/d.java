...
public class d
{
  ...
  public void a()
  {
    QLog.d("LightHttpEngine", 1, "LightHttpEngine disconn " + b + " ssoseq:" + f);
    if (g != null)
    {
      g.disconnect();
      g = null;
  ...
  public boolean a(String paramString1, int paramInt, String paramString2, f paramF)
  {
    ...
    try
    {
      ...
      l1 = l2;
      b = (paramString1 + b(paramString1));
      l1 = l2;
      b = MsfSdkUtils.insertMtype(paramString2, b);
      l1 = l2;
      QLog.d("LightHttpEngine", 1, "LightHttpEngine try connect " + b + " timeout:" + d + " ssoseq:" + f);
      l1 = l2;
      ...
      c = new URL(b);
      l1 = l2;
      g = ((HttpURLConnection)c.openConnection());
      l1 = l2;
      g.setDoOutput(true);
      l1 = l2;
      g.setDoInput(true);
      ...
      l1 = l2;
      g.setRequestProperty("User-Agent", "aqq");
      l1 = l2;
      g.setRequestProperty("content-type", "oct");
      l1 = l2;
      g.setConnectTimeout(d);
      l1 = l2;
      g.setRequestProperty("Connection", "close");
      l1 = l2;
      g.setRequestProperty("Accept-Encoding", "");
      l1 = l2;
      g.connect();
      l1 = l2;
      long l3 = SystemClock.elapsedRealtime();
      l1 = l2;
      QLog.d("LightHttpEngine", 1, "LightHttpEngine connect " + b + " succ costtime:" + (l3 - l2) + " ssoseq:" + f + " readTimeout:" + e);
      return true;
    }
    ...
    try
    {
      ...
      paramString2 = new StringBuilder(l);
      paramString2.append("|").append(paramString1);
      l = paramString2.toString();
      QLog.d("LightHttpEngine", 1, "LightHttpEngine connect " + b + " fail costtime:" + (l2 - l1) + " ssoseq:" + f + " reason:" + paramString1);
      return false;
    }
  ...
  public byte[] a(byte[] paramArrayOfByte, f paramF)
  {
    ...
    //   27: aload 8
    //   29: aload_1
    //   30: invokevirtual 314	java/io/OutputStream:write	([B)V
    //   33: aload 8
    //   35: invokevirtual 317	java/io/OutputStream:flush	()V
    //   38: ldc 8
    //   40: iconst_1
    ...
    //   83: invokevirtual 324	java/net/HttpURLConnection:getResponseCode	()I
    //   86: putfield 326	com/tencent/mobileqq/msf/core/net/d:h	I
    //   89: aload_0
    //   90: aload_0
    //   91: getfield 178	com/tencent/mobileqq/msf/core/net/d:g	Ljava/net/HttpURLConnection;
    //   94: invokevirtual 330	java/net/HttpURLConnection:getURL	()Ljava/net/URL;
    //   97: invokevirtual 333	java/net/URL:getHost	()Ljava/lang/String;
    //   100: putfield 335	com/tencent/mobileqq/msf/core/net/d:i	Ljava/lang/String;
    //   103: aload_0
    //   104: getfield 178	com/tencent/mobileqq/msf/core/net/d:g	Ljava/net/HttpURLConnection;
    //   107: invokevirtual 339	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   110: astore_1
    //   111: aload_1
    //   112: astore 10
    //   114: aload 8
    //   116: astore 9
    //   118: new 341	java/io/BufferedInputStream
    //   121: dup
    //   122: aload_1
    //   123: invokespecial 344	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   126: astore 11
    //   128: aload_1
    //   129: astore 10
    //   131: aload 8
    //   133: astore 9
    //   135: new 346	org/apache/http/util/ByteArrayBuffer
    //   138: dup
    //   139: sipush 1024
    //   142: invokespecial 348	org/apache/http/util/ByteArrayBuffer:<init>	(I)V
    //   145: astore 14
    //   147: aload_1
    //   148: astore 10
    //   150: aload 8
    ...
    //   167: aload 11
    //   169: aload 15
    //   171: invokevirtual 352	java/io/BufferedInputStream:read	([B)I
    //   174: istore_3
    //   175: iload_3
    //   176: iconst_m1
    ...
    //   228: aload 14
    //   230: invokevirtual 357	org/apache/http/util/ByteArrayBuffer:length	()I
    ...
    //   244: lload 6
    //   246: lsub
    //   247: invokevirtual 281	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    ...
    //   261: astore 9
    //   263: aload 14
    //   265: invokevirtual 363	org/apache/http/util/ByteArrayBuffer:toByteArray	()[B
    //   268: astore 11
    //   270: aload 11
    //   272: astore_2
    //   273: aload 8
    //   275: ifnull +8 -> 283
    //   278: aload 8
    //   280: invokevirtual 365	java/io/OutputStream:close	()V
    //   283: aload_2
    //   284: astore 8
    //   286: aload_1
    //   287: ifnull +10 -> 297
    //   290: aload_1
    //   291: invokevirtual 368	java/io/InputStream:close	()V
    //   294: aload_2
    //   295: astore 8
    //   297: aload 8
    //   299: areturn
    ...
    //   311: iconst_0
    //   312: iload_3
    //   313: invokevirtual 371	org/apache/http/util/ByteArrayBuffer:append	([BII)V
    //   316: goto -156 -> 160
    //   319: astore 11
    //   321: lload 6
    //   323: lstore 4
    ...
    //   342: astore 9
    //   344: aload 11
    //   346: invokevirtual 286	java/lang/Throwable:printStackTrace	()V
    //   349: aload_1
    //   350: astore 10
    //   352: aload 8
    //   354: astore 9
    //   356: aload_2
    //   357: aload 11
    //   359: invokevirtual 287	java/lang/Throwable:toString	()Ljava/lang/String;
    //   362: putfield 373	com/tencent/mobileqq/msf/core/quicksend/f:h	Ljava/lang/String;
    //   365: aload_1
    //   366: astore 10
    //   368: aload 8
    //   370: astore 9
    ...
    //   403: lload 4
    //   405: lsub
    //   406: invokevirtual 281	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   409: ldc_w 303
    //   412: invokevirtual 140	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   415: aload 11
    //   417: invokevirtual 287	java/lang/Throwable:toString	()Ljava/lang/String;
    ...
    //   431: ifnull +8 -> 439
    //   434: aload 8
    //   436: invokevirtual 365	java/io/OutputStream:close	()V
    //   439: aload 13
    //   441: astore 8
    //   443: aload_1
    //   444: ifnull -147 -> 297
    //   447: aload_1
    //   448: invokevirtual 368	java/io/InputStream:close	()V
    //   451: aconst_null
    //   452: areturn
    //   453: astore_1
    //   454: aload 12
    //   456: astore_2
    //   457: aload_1
    //   458: invokevirtual 286	java/lang/Throwable:printStackTrace	()V
    //   461: aload_2
    //   462: areturn
    //   463: astore_1
    //   464: aconst_null
    ...
    //   472: ifnull +8 -> 480
    //   475: aload 8
    //   477: invokevirtual 365	java/io/OutputStream:close	()V
    //   480: aload 10
    //   482: ifnull +8 -> 490
    //   485: aload 10
    //   487: invokevirtual 368	java/io/InputStream:close	()V
    //   490: aload_1
    //   491: athrow
    //   492: astore_2
    //   493: aload_2
    //   494: invokevirtual 286	java/lang/Throwable:printStackTrace	()V
    //   497: goto -7 -> 490
    //   500: astore_1
    //   501: goto -44 -> 457
    //   504: astore_1
