...
public class BadgeUtilImpl
{
  ...
  public static void changeOPPOBadge(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          QLog.d("BadgeUtilImpl", 2, "OPPOBadge badge get a  crash" + paramContext.toString());
          return;
        }
      }
    }
      ...
      try
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (activityInfo.applicationInfo.packageName.equalsIgnoreCase(paramContext.getPackageName()))
            {
  ...
  public static boolean isMIUI6()
  {
    ...
    //   0: iconst_0
    //   1: istore_0
    //   2: getstatic 98	com/tencent/mobileqq/msf/core/push/BadgeUtilImpl:miui6Flag	I
    //   5: ifne +101 -> 106
    //   8: iconst_m1
    //   9: putstatic 98	com/tencent/mobileqq/msf/core/push/BadgeUtilImpl:miui6Flag	I
    //   12: ldc 90
    //   14: astore 4
    //   16: aconst_null
    //   17: astore 5
    //   19: aconst_null
    //   20: astore_3
    //   21: new 367	java/io/BufferedReader
    //   24: dup
    //   25: new 369	java/io/InputStreamReader
    //   28: dup
    //   29: new 371	java/lang/ProcessBuilder
    //   32: dup
    //   33: iconst_2
    //   34: anewarray 78	java/lang/String
    //   37: dup
    //   38: iconst_0
    //   39: ldc_w 373
    //   42: aastore
    ...
    //   45: ldc_w 375
    //   48: aastore
    //   49: invokespecial 378	java/lang/ProcessBuilder:<init>	([Ljava/lang/String;)V
    //   52: invokevirtual 382	java/lang/ProcessBuilder:start	()Ljava/lang/Process;
    //   55: invokevirtual 388	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   58: invokespecial 391	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   61: sipush 1024
    //   64: invokespecial 394	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   67: astore_2
    //   68: aload_2
    //   69: invokevirtual 397	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   72: astore_3
    //   73: aload_2
    //   74: invokevirtual 400	java/io/BufferedReader:close	()V
    //   77: aload_2
    //   78: ifnull +7 -> 85
    //   81: aload_2
    //   82: invokevirtual 400	java/io/BufferedReader:close	()V
    //   85: aload_3
    //   86: invokestatic 297	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   89: ifne +17 -> 106
    //   92: aload_3
    //   93: invokestatic 404	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   96: istore_0
    //   97: iload_0
    //   98: iconst_3
    //   99: if_icmple +7 -> 106
    //   102: iconst_1
    //   103: putstatic 98	com/tencent/mobileqq/msf/core/push/BadgeUtilImpl:miui6Flag	I
    //   106: getstatic 98	com/tencent/mobileqq/msf/core/push/BadgeUtilImpl:miui6Flag	I
    //   109: iconst_1
    ...
    //   117: ifnull +7 -> 124
    //   120: aload_3
    //   121: invokevirtual 400	java/io/BufferedReader:close	()V
    //   124: aload 4
    //   126: invokestatic 297	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   129: ifne +20 -> 149
    //   132: aload 4
    //   134: invokestatic 404	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   137: istore_1
    //   138: iload_1
    //   139: istore_0
    //   140: iload_0
    ...
    //   142: if_icmple +7 -> 149
    //   145: iconst_1
    //   146: putstatic 98	com/tencent/mobileqq/msf/core/push/BadgeUtilImpl:miui6Flag	I
    //   149: aload_2
    //   150: athrow
    //   151: iconst_0
    //   152: ireturn
    ...
    //   160: ifnull +7 -> 167
    //   163: aload_2
    //   164: invokevirtual 400	java/io/BufferedReader:close	()V
    //   167: aload_3
    //   168: invokestatic 297	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   171: ifne -65 -> 106
    //   174: aload_3
    //   175: invokestatic 404	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   178: istore_0
    //   179: iload_0
    //   180: iconst_3
    ...
    //   191: astore_2
    //   192: aload_2
    //   193: invokevirtual 405	java/lang/NumberFormatException:printStackTrace	()V
    //   196: iconst_0
    //   197: istore_0
    //   198: goto -19 -> 179
    //   201: astore_2
    ...
    //   206: ifnull +7 -> 213
    //   209: aload_2
    //   210: invokevirtual 400	java/io/BufferedReader:close	()V
    //   213: aload 4
    //   215: invokestatic 297	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   218: ifne -112 -> 106
    //   221: aload 4
    //   223: invokestatic 404	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   226: istore_0
    //   227: iload_0
    //   228: iconst_3
    ...
    //   239: astore_2
    //   240: aload_2
    //   241: invokevirtual 405	java/lang/NumberFormatException:printStackTrace	()V
    //   244: iconst_0
    //   245: istore_0
    //   246: goto -19 -> 227
    //   249: astore_3
    ...
    //   253: astore_3
    //   254: aload_3
    //   255: invokevirtual 405	java/lang/NumberFormatException:printStackTrace	()V
    //   258: goto -118 -> 140
    //   261: astore_2
    //   262: goto -177 -> 85
    //   265: astore_2
    //   266: aload_2
    //   267: invokevirtual 405	java/lang/NumberFormatException:printStackTrace	()V
    //   270: iconst_0
    //   271: istore_0
    //   272: goto -175 -> 97
    //   275: astore 5
  ...
  public static boolean islenovoLanucher(String paramString)
  {
    ...
    try
    {
      ...
      if (Float.valueOf(Float.parseFloat(packmaggetPackageInfo0versionName.substring(0, 3))).floatValue() >= 6.7F)
      {
        haslenovoLanucher = 1;
        return true;
      }
  ...
  public static void setLenovoBadge(Context paramContext, int paramInt)
  {
    ...
    //   18: ldc_w 501
    //   21: invokevirtual 176	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   24: iload_1
    //   25: invokevirtual 179	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   28: invokevirtual 183	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   31: invokestatic 187	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   34: new 503	android/content/ContentValues
    //   37: dup
    //   38: invokespecial 504	android/content/ContentValues:<init>	()V
    //   41: astore 4
    //   43: aload_0
    //   44: invokestatic 485	com/tencent/mobileqq/msf/core/push/BadgeUtilImpl:getLauncherClassName	(Landroid/content/Context;)Ljava/lang/String;
    //   47: astore_3
    //   48: aload_3
    //   49: ifnonnull +4 -> 53
    //   52: return
    ...
    //   55: ldc_w 487
    //   58: aload_0
    //   59: invokevirtual 349	android/content/Context:getPackageName	()Ljava/lang/String;
    //   62: invokevirtual 507	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   65: aload 4
    //   67: ldc_w 493
    //   70: aload_3
    //   71: invokevirtual 507	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   74: aload 4
    //   76: ldc_w 509
    //   79: iload_1
    //   80: invokestatic 152	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   83: invokevirtual 512	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   86: aload 4
    //   88: ldc_w 514
    //   91: ldc 90
    //   93: invokevirtual 507	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   96: aload_0
    //   97: invokevirtual 236	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   100: astore_3
    //   101: ldc 47
    //   103: invokestatic 244	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   106: astore 5
    //   108: aload_0
    //   109: invokevirtual 349	android/content/Context:getPackageName	()Ljava/lang/String;
    //   112: astore 6
    //   114: aload_3
    //   115: aload 5
    //   117: iconst_4
    //   118: anewarray 78	java/lang/String
    //   121: dup
    //   122: iconst_0
    //   123: ldc_w 487
    //   126: aastore
    ...
    //   145: ldc_w 516
    //   148: iconst_1
    //   149: anewarray 78	java/lang/String
    //   152: dup
    //   153: iconst_0
    //   154: aload 6
    //   156: aastore
    //   157: aconst_null
    //   158: invokevirtual 520	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   161: astore_3
    //   162: aload_3
    //   163: astore_2
    //   164: aload_2
    ...
    //   174: ifle +52 -> 226
    //   177: aload_2
    //   178: invokeinterface 529 1 0
    //   183: ifeq +32 -> 215
    //   186: aload_0
    //   187: invokevirtual 236	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   190: ldc 47
    //   192: invokestatic 244	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   195: aload 4
    //   197: ldc_w 516
    //   200: iconst_1
    //   201: anewarray 78	java/lang/String
    //   204: dup
    //   205: iconst_0
    //   206: aload_0
    //   207: invokevirtual 349	android/content/Context:getPackageName	()Ljava/lang/String;
    //   210: aastore
    //   211: invokevirtual 533	android/content/ContentResolver:update	(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    //   214: pop
    //   215: aload_2
    //   216: ifnull -164 -> 52
    //   219: aload_2
    ...
    //   225: return
    //   226: invokestatic 167	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   229: ifeq +12 -> 241
    //   232: ldc 29
    //   234: iconst_2
    //   235: ldc_w 536
    ...
    //   241: aload_0
    //   242: invokevirtual 236	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   245: ldc 47
    //   247: invokestatic 244	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   250: aload 4
    //   252: invokevirtual 540	android/content/ContentResolver:insert	(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    //   255: pop
    //   256: aload_2
    //   257: ifnull -205 -> 52
    //   260: goto -41 -> 219
  ...
  public static void setSamsungBadge(Context paramContext, int paramInt)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: getstatic 73	com/tencent/mobileqq/msf/core/push/BadgeUtilImpl:haveprovider	Ljava/lang/Boolean;
    //   6: ifnonnull +272 -> 278
    //   9: ldc_w 554
    //   12: invokestatic 244	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   15: astore_3
    //   16: aload_0
    ...
    //   23: aconst_null
    //   24: aconst_null
    //   25: invokevirtual 520	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   28: astore_3
    //   29: aload_3
    //   30: ifnonnull +27 -> 57
    //   33: aload_3
    ...
    //   37: astore 5
    //   39: iconst_0
    //   40: invokestatic 559	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   43: putstatic 73	com/tencent/mobileqq/msf/core/push/BadgeUtilImpl:haveprovider	Ljava/lang/Boolean;
    //   46: aload_3
    //   47: ifnull +9 -> 56
    //   50: aload_3
    //   51: invokeinterface 534 1 0
    //   56: return
    //   57: aload_3
    //   58: astore 4
    //   60: aload_3
    //   61: astore 5
    //   63: iconst_1
    //   64: invokestatic 559	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   67: putstatic 73	com/tencent/mobileqq/msf/core/push/BadgeUtilImpl:haveprovider	Ljava/lang/Boolean;
    //   70: aload_3
    //   71: astore 4
    //   73: aload_3
    //   74: astore 5
    //   76: invokestatic 167	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   79: ifeq +35 -> 114
    //   82: aload_3
    //   83: astore 4
    //   85: aload_3
    ...
    //   104: iload_1
    //   105: invokevirtual 179	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   108: invokevirtual 183	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   111: invokestatic 187	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   114: aload_3
    //   115: astore 4
    //   117: aload_3
    //   118: astore 5
    //   120: getstatic 73	com/tencent/mobileqq/msf/core/push/BadgeUtilImpl:haveprovider	Ljava/lang/Boolean;
    //   123: invokevirtual 564	java/lang/Boolean:booleanValue	()Z
    //   126: ifeq +109 -> 235
    //   129: aload_3
    //   130: astore 4
    //   132: aload_3
    //   133: astore 5
    //   135: aload_0
    //   136: invokestatic 485	com/tencent/mobileqq/msf/core/push/BadgeUtilImpl:getLauncherClassName	(Landroid/content/Context;)Ljava/lang/String;
    //   139: astore 6
    //   141: aload 6
    ...
    //   156: aload_3
    //   157: astore 5
    //   159: new 201	android/content/Intent
    //   162: dup
    //   163: ldc_w 566
    //   166: invokespecial 204	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   169: astore 7
    //   171: aload_3
    //   172: astore 4
    //   174: aload_3
    ...
    //   179: ldc_w 568
    //   182: iload_2
    //   183: invokevirtual 571	android/content/Intent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   186: pop
    //   187: aload_3
    //   188: astore 4
    //   190: aload_3
    ...
    //   195: ldc_w 573
    //   198: aload_0
    //   199: invokevirtual 349	android/content/Context:getPackageName	()Ljava/lang/String;
    //   202: invokevirtual 210	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   205: pop
    //   206: aload_3
    //   207: astore 4
    //   209: aload_3
    ...
    //   214: ldc_w 575
    //   217: aload 6
    //   219: invokevirtual 210	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   222: pop
    //   223: aload_3
    //   224: astore 4
    //   226: aload_3
    ...
    //   229: aload_0
    //   230: aload 7
    //   232: invokevirtual 218	android/content/Context:sendBroadcast	(Landroid/content/Intent;)V
    //   235: aload_3
    //   236: ifnull -180 -> 56
    //   239: goto -189 -> 50
    //   242: astore_0
