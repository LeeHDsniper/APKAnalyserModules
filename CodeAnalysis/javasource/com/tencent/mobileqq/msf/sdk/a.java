...
public class a
{
  ...
  public static void a(Context paramContext, INetEventHandler paramINetEventHandler)
  {
    try
    {
      ...
      if (e == null)
      {
        QLog.d(m, 1, "AppNetInfoImpl handler is null");
        d = new a("nethandlerthread4");
        d.start();
        e = new Handler(d.getLooper(), d);
      }
      paramContext = e.obtainMessage();
      what = 2;
      obj = paramINetEventHandler;
  ...
  public static void a(Context paramContext, INetInfoHandler paramINetInfoHandler)
  {
    try
    {
      ...
      {
        QLog.d(m, 1, "AppNetInfoImpl handler is null");
        d = new a("nethandlerthread2");
        d.start();
        e = new Handler(d.getLooper(), d);
      }
      paramContext = e.obtainMessage();
      what = 1;
      obj = paramINetInfoHandler;
      e.sendMessage(paramContext);
      return;
    }
    catch (Exception paramContext)
  ...
  {
    // Byte code:
    //   0: invokestatic 420	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   3: ldc -40
    //   5: invokevirtual 425	com/tencent/qphone/base/util/BaseApplication:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   8: checkcast 224	android/net/ConnectivityManager
    //   11: iconst_0
    //   12: invokevirtual 235	android/net/ConnectivityManager:getNetworkInfo	(I)Landroid/net/NetworkInfo;
    //   15: astore_0
    //   16: aload_0
    //   17: ifnull +11 -> 28
    //   20: aload_0
    //   21: invokevirtual 240	android/net/NetworkInfo:getExtraInfo	()Ljava/lang/String;
    //   24: putstatic 93	com/tencent/mobileqq/msf/sdk/a:i	Ljava/lang/String;
    //   27: return
    //   28: invokestatic 420	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   31: invokevirtual 441	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   34: getstatic 107	com/tencent/mobileqq/msf/sdk/a:v	Landroid/net/Uri;
    //   37: aconst_null
    //   38: aconst_null
    //   39: aconst_null
    //   40: aconst_null
    //   41: invokevirtual 447	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   44: astore_1
    //   45: aload_1
    //   46: ifnull +98 -> 144
    //   49: aload_1
    ...
    //   72: invokeinterface 461 2 0
    //   77: putstatic 93	com/tencent/mobileqq/msf/sdk/a:i	Ljava/lang/String;
    //   80: goto -35 -> 45
    //   83: astore_2
    //   84: aload_1
    //   85: astore_0
    //   86: aload_2
    //   87: invokevirtual 464	java/lang/Throwable:printStackTrace	()V
    //   90: aload_1
    //   91: ifnull -64 -> 27
    //   94: aload_1
    //   95: invokeinterface 465 1 0
    //   100: return
    //   101: astore_0
    //   102: getstatic 54	com/tencent/mobileqq/msf/sdk/a:m	Ljava/lang/String;
    //   105: iconst_1
    //   106: new 196	java/lang/StringBuilder
    //   109: dup
    //   110: invokespecial 197	java/lang/StringBuilder:<init>	()V
    //   113: ldc -14
    //   115: invokevirtual 203	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   118: aload_0
    //   119: invokevirtual 245	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   122: invokevirtual 207	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   125: invokestatic 210	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   128: return
    //   129: astore_1
    //   130: aconst_null
    //   131: astore_0
    ...
    //   133: ifnull +9 -> 142
    //   136: aload_0
    //   137: invokeinterface 465 1 0
    //   142: aload_1
    //   143: athrow
    //   144: aload_1
    //   145: ifnull -118 -> 27
    //   148: aload_1
    //   149: invokeinterface 465 1 0
    //   154: return
    //   155: astore_1
    //   156: goto -24 -> 132
    //   159: astore_2
    ...
    public boolean handleMessage(Message paramMessage)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          try
          {
            paramMessage = (INetInfoHandler)obj;
            a.a.add(paramMessage);
            return false;
          }
          catch (Exception paramMessage)
          {
            QLog.d(a.j(), 1, "failed to handle msg " + i);
            return false;
          }
          paramMessage = (INetEventHandler)obj;
        ...
        QLog.d(a.j(), 2, "no change in connectivity");
        return false;
        if (a.f())
        {
          a.k();
