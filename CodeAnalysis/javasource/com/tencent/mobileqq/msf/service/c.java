...
public class c
{
  ...
  public static void a(String paramString, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramString.equals("*"))
    {
      ...
      while (paramString.hasNext())
      {
        ...
        getValueg.add(new MsfMessagePair(paramToServiceMsg, paramFromServiceMsg));
      }
    }
  ...
  public static void a(HashMap paramHashMap)
  {
    ...
    paramHashMap.put("availMem", String.valueOf(availMem));
    paramHashMap.put("lowMemory", String.valueOf(lowMemory));
  }
