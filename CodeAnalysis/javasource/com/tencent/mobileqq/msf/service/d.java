  ...
  extends IBaseService.Stub
{
    ...
    throws RemoteException
  {
    ...
    try
    {
      ...
      {
        a.handleAccountSyncRequest(a, paramToServiceMsg, j);
      }
      else
      {
        f.a();
        if (MsfService.isSamePackage(a, j, paramToServiceMsg.getServiceCmd())) {
          MsfService.msfServiceReqHandler.a(a, paramToServiceMsg, j);
        }
      }
    }
