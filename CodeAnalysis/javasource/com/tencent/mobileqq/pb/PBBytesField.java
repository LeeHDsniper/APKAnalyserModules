  ...
  extends PBPrimitiveField<ByteStringMicro>
{
  ...
  public void clear(Object paramObject)
  {
    ...
    for (value = ((ByteStringMicro)paramObject);; value = ByteStringMicro.EMPTY)
    {
      setHasFlag(false);
      return;
    }
  ...
  {
    if (has()) {
      return CodedOutputStreamMicro.computeBytesSize(paramInt, value);
    }
    return 0;
  }
  ...
  public void readFrom(CodedInputStreamMicro paramCodedInputStreamMicro)
    throws IOException
  {
    value = paramCodedInputStreamMicro.readBytes();
    setHasFlag(true);
  }
  ...
  {
    if (has()) {
      paramCodedOutputStreamMicro.writeBytes(paramInt, value);
    }
  }
