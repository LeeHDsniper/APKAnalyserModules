  ...
  extends PBPrimitiveField<Long>
{
  ...
  {
    if (has()) {
      return CodedOutputStreamMicro.computeFixed64Size(paramInt, value);
    }
    return 0;
  }
  ...
  public void readFrom(CodedInputStreamMicro paramCodedInputStreamMicro)
    throws IOException
  {
    value = paramCodedInputStreamMicro.readFixed64();
    setHasFlag(true);
  }
  ...
  {
    if (has()) {
      paramCodedOutputStreamMicro.writeFixed64(paramInt, value);
    }
  }
