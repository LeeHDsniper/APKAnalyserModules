  ...
  extends PBPrimitiveField<Integer>
{
  ...
  {
    if (has()) {
      return CodedOutputStreamMicro.computeInt32Size(paramInt, value);
    }
    return 0;
  }
  ...
  public void readFrom(CodedInputStreamMicro paramCodedInputStreamMicro)
    throws IOException
  {
    value = paramCodedInputStreamMicro.readInt32();
    setHasFlag(true);
  }
  ...
  {
    if (has()) {
      paramCodedOutputStreamMicro.writeInt32(paramInt, value);
    }
  }
