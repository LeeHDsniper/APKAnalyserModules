  ...
  extends PBPrimitiveField<Long>
{
  ...
  {
    if (has()) {
      return CodedOutputStreamMicro.computeSInt64Size(paramInt, value);
    }
    return 0;
  }
  ...
  public void readFrom(CodedInputStreamMicro paramCodedInputStreamMicro)
    throws IOException
  {
    value = paramCodedInputStreamMicro.readSInt64();
    setHasFlag(true);
  }
  ...
  {
    if (has()) {
      paramCodedOutputStreamMicro.writeSInt64(paramInt, value);
    }
  }
