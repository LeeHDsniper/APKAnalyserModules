  ...
  extends PBPrimitiveField<Long>
{
  ...
  {
    if (has()) {
      return CodedOutputStreamMicro.computeUInt64Size(paramInt, value);
    }
    return 0;
  }
  ...
  public void readFrom(CodedInputStreamMicro paramCodedInputStreamMicro)
    throws IOException
  {
    value = paramCodedInputStreamMicro.readUInt64();
    setHasFlag(true);
  }
  ...
  {
    if (has()) {
      paramCodedOutputStreamMicro.writeUInt64(paramInt, value);
    }
  }
