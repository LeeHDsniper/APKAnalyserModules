...
public class EntityManager
{
  ...
  private Cursor a(boolean paramBoolean, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4, String paramString5, String paramString6, int paramInt)
  {
    try
    {
      if (d(paramString1))
      {
        paramString1 = jdField_a_of_type_ComTencentMobileqqAppSQLiteOpenHelper.b().a(paramString1, paramArrayOfString1, paramString2, paramArrayOfString2, paramString5, paramString6);
        return paramString1;
      }
    }
  ...
  private boolean a(String paramString, Entity paramEntity, boolean paramBoolean)
  {
    ...
    if (!bool1)
    {
      ...
      bool1 = jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(TableBuilder.a(paramEntity));
      paramEntity = TableBuilder.b(paramEntity);
      if (paramEntity != null) {
        jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramEntity);
      }
      ...
      if (bool1)
      {
        jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramString);
        bool2 = bool1;
      }
    }
    return bool2;
  ...
  {
    if (jdField_a_of_type_ComTencentMobileqqPersistenceEntityTransaction == null) {
      jdField_a_of_type_ComTencentMobileqqPersistenceEntityTransaction = new EntityTransaction(jdField_a_of_type_ComTencentMobileqqAppSQLiteOpenHelper);
    }
    return jdField_a_of_type_ComTencentMobileqqPersistenceEntityTransaction;
  }
  ...
  public List a(Class paramClass, String paramString1, String paramString2, String paramString3, String[] paramArrayOfString)
  {
    ...
    //   15: aload 4
    //   17: aload 5
    //   19: invokevirtual 454	com/tencent/mobileqq/app/SQLiteDatabase:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   22: astore_2
    //   23: aload 7
    //   25: astore_3
    //   26: aload_2
    ...
    //   34: aconst_null
    //   35: aload_2
    //   36: invokevirtual 456	com/tencent/mobileqq/persistence/EntityManager:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;)Ljava/util/List;
    //   39: astore_1
    //   40: aload_1
    //   41: astore_3
    //   42: aload_3
  ...
  public List a(Class paramClass, String paramString, String[] paramArrayOfString)
  {
    ...
    //   30: aconst_null
    //   31: aload_2
    //   32: invokevirtual 456	com/tencent/mobileqq/persistence/EntityManager:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;)Ljava/util/List;
    //   35: astore_1
    //   36: aload_1
    //   37: astore_3
    //   38: aload_3
  ...
  protected void a(Entity paramEntity, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        l1 = jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.b(str, null, localContentValues);
        l2 = l1;
        if (l1 == -1L)
        {
          l2 = l1;
          if (a(str, paramEntity, true))
          {
            ...
            l2 = jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.b(str, null, localContentValues);
          }
        }
        if (l2 != -1L)
        {
      ...
      return;
      l1 = jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(str, null, localContentValues);
      continue;
      l2 = jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(str, null, localContentValues);
    }
  }
  ...
  public boolean a(Entity paramEntity)
  {
    ...
    try
    {
      if ((_status == 1001) || (_status == 1002))
      {
        ContentValues localContentValues = a(paramEntity);
        int i = jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramEntity.getTableName(), localContentValues, "_id=?", new String[] { String.valueOf(_id) });
        return i > 0;
      }
    }
    catch (Exception localException)
  ...
  public boolean a(Entity paramEntity, String paramString, String[] paramArrayOfString)
  {
    ...
    {
      bool1 = bool2;
      if (jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramEntity.getTableName(), paramString, paramArrayOfString) > 0) {
        bool1 = true;
      }
      _status = 1003;
    }
  ...
  public boolean a(Class paramClass)
  {
    ...
    try
    {
      ...
      jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a("DROP TABLE IF EXISTS " + paramClass);
      jdField_a_of_type_JavaUtilHashtable.remove(paramClass);
      jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.b(paramClass);
      return true;
    }
    catch (Exception paramClass)
    {
  ...
  public boolean a(String paramString)
  {
    ...
    try
    {
      jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a("DROP TABLE IF EXISTS " + paramString);
      jdField_a_of_type_JavaUtilHashtable.remove(paramString);
      jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.b(paramString);
      return true;
    }
  ...
  public boolean a(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString)
  {
    ...
    {
      jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase = jdField_a_of_type_ComTencentMobileqqAppSQLiteOpenHelper.a();
      int i = jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramString1, paramContentValues, paramString2, paramArrayOfString);
      if (i > 0) {
        bool = true;
      }
    }
  ...
  public boolean a(String paramString, Object[] paramArrayOfObject)
  {
    ...
    {
      jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase = jdField_a_of_type_ComTencentMobileqqAppSQLiteOpenHelper.a();
      jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramString, paramArrayOfObject);
      return false;
    }
  ...
  public boolean b(Entity paramEntity)
  {
    ...
    paramEntity.prewrite();
    if (_status == 1001) {
      if (jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramEntity.getTableName(), "_id=?", new String[] { String.valueOf(_id) }) > 0) {
        _status = 1003;
      }
    }
    for (;;)
  ...
  public boolean b(String paramString)
  {
    try
    {
      jdField_a_of_type_ComTencentMobileqqAppSQLiteOpenHelper.b().a(paramString);
      return true;
    }
    catch (Exception paramString)
    {
  ...
  public void c(Entity paramEntity)
  {
    ...
    {
      ContentValues localContentValues = a(paramEntity);
      jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a("delete from " + str);
      long l2 = jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(str, null, localContentValues);
      long l1 = l2;
      if (l2 == -1L)
      {
        l1 = l2;
  ...
  public boolean d(String paramString)
  {
    ...
    do
    {
      ...
      localSQLiteDatabase = jdField_a_of_type_ComTencentMobileqqAppSQLiteOpenHelper.b();
