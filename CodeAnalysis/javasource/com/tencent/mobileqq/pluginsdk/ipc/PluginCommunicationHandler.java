...
public final class PluginCommunicationHandler
{
  ...
  {
    if (b == null) {
      b = new PluginCommunicationChannelImpl();
    }
    return b;
  }
  ...
  public void register(RemoteCommand paramRemoteCommand)
  {
    ...
    synchronized (a)
    {
      a.put(paramRemoteCommand.getCmd(), paramRemoteCommand);
      return;
    }
  }
  ...
  {
    d = paramAbstractPluginCommunicationChannel;
  }
    ...
    extends PluginCommunicationChannel.Stub
  {
      ...
      implements Runnable
    {
      ...
      {
        b = paramString;
        c = paramRemoteCallback;
        d = paramBundle;
        if (d != null) {
          d.setClassLoader(MobileQQ.sMobileQQ.getClassLoader());
        }
        if (c != null) {
          e = new b(this, PluginCommunicationHandler.PluginCommunicationChannelImpl.this);
        }
      }
      ...
      public void run()
      {
        do
        {
          synchronized (PluginCommunicationHandler.c(PluginCommunicationHandler.this))
          {
            RemoteCommand localRemoteCommand = (RemoteCommand)PluginCommunicationHandler.c(PluginCommunicationHandler.this).get(b);
            if (QLog.isColorLevel()) {
          ...
          ??? = PluginCommunicationHandler.PluginCommunicationChannelImpl.a(PluginCommunicationHandler.PluginCommunicationChannelImpl.this, b, d);
          if (??? != null) {}
          try
          {
            ((Bundle)???).setClassLoader(MobileQQ.sMobileQQ.getClassLoader());
            c.onRemoteCallback((Bundle)???);
            return;
          }
