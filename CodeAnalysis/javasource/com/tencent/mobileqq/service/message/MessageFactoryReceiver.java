...
public class MessageFactoryReceiver
{
  ...
  public MessageFactoryReceiver()
  {
    ...
    b = MessageHandler.class.getSimpleName();
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, int paramInt, String paramString, long paramLong)
  {
    ...
    extraData.putLong("ServerReplyCode", paramLong);
  ...
  private Object c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ((localRespGetSign == null) || (iReplyCode != 0))
    {
      if (localRespGetSign == null) {}
      for (long l = 2139062143L;; l = iReplyCode)
      {
        a(paramToServiceMsg, l);
        extraData.putLong("ServerReplyCode", l);
        return null;
      }
    }
    return new MessageFactoryReceiver.SigStruct(this, vKey, vSign);
  }
  ...
  private Object d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    paramFromServiceMsg = stStreamInfo;
    return new MessageFactoryReceiver.UploadStreamStruct(StreamDataManager.a(iMsgId, 0), shResetSeq, shFlowLayer, paramFromServiceMsg, result);
  }
  ...
  private Object e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    paramFromServiceMsg = stStreamInfo;
    StreamData localStreamData = stStreamData;
    long l = lKey;
    Object[] arrayOfObject = new Object[4];
    arrayOfObject[0] = Long.valueOf(l);
    arrayOfObject[1] = paramFromServiceMsg;
    arrayOfObject[2] = localStreamData;
    arrayOfObject[3] = Long.valueOf(bubbleID);
    if (QLog.isColorLevel()) {
      QLog.d(b, 2, "decodeServerPushStream: vipBubbleID:" + arrayOfObject[3]);
    }
  ...
  private Object i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    extraData.putString("insertUin", extraData.getString("insertUin"));
    paramToServiceMsg = localRespInsertBlackList;
    if (stHeader.eReplyCode != 0) {
  ...
  private Object j(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    extraData.putString("deleteUin", extraData.getString("deleteUin"));
  ...
  private Object o(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramToServiceMsg != null)
    {
      ReportLog.a("Video", "Receive message packet: seq = " + paramFromServiceMsg.getRequestSsoSeq() + " " + "size = " + vMsgInfos.size());
      return paramToServiceMsg;
    }
    return null;
  }
  ...
  private Object q(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    extraData.getLong("msgTime");
    byte b1 = extraData.getByte("type");
    extraData.getString("friendUin");
    if ((localRespOffFilePack == null) || (iReplyCode != 0))
    {
      paramToServiceMsg = extraData;
      if (localRespOffFilePack == null) {}
      for (l1 = 2139062143L;; l1 = iReplyCode)
      {
    ...
    byte b2 = vBody[0];
    long l1 = PkgTools.a(vBody, 1);
    int i = PkgTools.a(vBody, 5);
    paramFromServiceMsg = new byte[i];
    PkgTools.a(paramFromServiceMsg, 0, vBody, 7, i);
    paramFromServiceMsg = PkgTools.a(paramFromServiceMsg, 0, i);
    i += 7;
    if (QLog.isColorLevel()) {
      QLog.d(b, 2, "<<<<decodeGetOffLineFileResp cSubCmd:" + b2);
    }
    long l2;
    long l3;
    long l4;
    ...
    default: 
      return null;
    case 1: 
      l2 = PkgTools.c(vBody, i);
      i += 8;
      l3 = PkgTools.c(vBody, i);
      i += 8;
      l4 = PkgTools.a(vBody, i);
      i += 4;
      l5 = PkgTools.a(vBody, i);
      i += 4;
      short s = PkgTools.a(vBody, i);
      j = i + 2;
      i = PkgTools.a(vBody, j);
      j += 2;
      paramToServiceMsg = new byte[i];
      PkgTools.a(paramToServiceMsg, 0, vBody, j, paramToServiceMsg.length);
      j += paramToServiceMsg.length;
      i = PkgTools.a(vBody, j);
      j += 2;
      arrayOfByte = new byte[i];
      PkgTools.a(arrayOfByte, 0, vBody, j, arrayOfByte.length);
      i = j + arrayOfByte.length;
      byte b3 = vBody[i];
      i += 1;
      long l6 = PkgTools.a(vBody, i);
      if (QLog.isColorLevel()) {
    ...
    case 3: 
      ...
      j = vBody[i];
      i += 1;
      l2 = PkgTools.a(vBody, i);
      j = i + 4;
      i = PkgTools.a(vBody, j);
      j += 2;
      PkgTools.a(new byte[i], 0, vBody, j, i);
      j += i;
      i = PkgTools.a(vBody, j);
      j += 2;
      arrayOfByte = new byte[i];
      PkgTools.a(arrayOfByte, 0, vBody, j, i);
      j += i;
      i = vBody[j];
      j += 1;
      PkgTools.a(new byte[i], 0, vBody, j, i);
      ...
      PkgTools.a((byte[])localObject, 0, vBody, j, i);
      localObject = PkgTools.a((byte[])localObject, 0, i);
      i = j + i;
      j = vBody[i];
      i += 1;
      l3 = PkgTools.a(vBody, i);
      i += 4;
      l4 = PkgTools.a(vBody, i);
      i += 4;
      PkgTools.a(vBody, i);
      ...
      l5 = PkgTools.a(vBody, i);
      if (QLog.isColorLevel()) {
        QLog.i(b, 2, "<<<<decodeGetOffLineFileResp dwUploadTime = " + l5);
      }
      return new MessageFactoryReceiver.OffLineFileInfo(this, l1, paramFromServiceMsg, b2, b1, l2, HexUtil.bytes2HexStr(arrayOfByte), l4, extraData.getLong("msgTime"), extraData.getShort("msgSeq"), l3, (String)localObject, extraData.getLong("delUin"));
    }
    int j = PkgTools.a(vBody, i);
    paramToServiceMsg = new byte[j];
    PkgTools.a(paramToServiceMsg, 0, vBody, i + 2, j);
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(b, 2, "decodeRespMsg cmd: " + str);
    }
