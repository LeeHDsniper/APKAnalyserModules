  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    case 2: 
      ...
      try
      {
        ...
        logstring = new HashMap((Map)localObject3);
        encoding = 2;
    ...
    case 8: 
      ...
      logstring = new HashMap((Map)localObject5);
      encoding = 2;
      paramPacket.setSSOCommand("CliLogSvc.UploadReq");
      paramPacket.setServantName("QQService.CliLogSvc.MainServantObj");
      paramPacket.setFuncName("UploadReq");
    ...
    case 4: 
      ...
      eventName = paramPacket;
      elapse = l1;
      size = l2;
      isSucceed = Boolean.valueOf(bool1).booleanValue();
      isRealTime = Boolean.valueOf(bool2).booleanValue();
      params = ((Map)localObject1);
    ...
    logstring = new HashMap((Map)localObject6);
    encoding = 2;
    seqno = paramIntent.getExtras().getInt("seqKey");
    paramPacket.setSSOCommand("CliLogSvc.UploadReq");
    paramPacket.setServantName("QQService.CliLogSvc.MainServantObj");
    paramPacket.setFuncName("UploadReq");
