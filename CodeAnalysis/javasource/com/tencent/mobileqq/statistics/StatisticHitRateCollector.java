...
public class StatisticHitRateCollector
{
  ...
  public StatisticHitRateCollector(String paramString)
  {
    ...
    d = ("StatisticHitRateCollector_" + paramString);
  }
  ...
  {
    Boolean localBoolean = (Boolean)jdField_a_of_type_JavaUtilMap.get(paramString2);
    if ((localBoolean == null) || (!localBoolean.booleanValue()))
    {
      localBoolean = (Boolean)b.get(paramString2);
      if ((localBoolean != null) && (localBoolean.booleanValue()))
      {
        jdField_a_of_type_JavaUtilMap.put(paramString2, Boolean.valueOf(true));
        if (QLog.isColorLevel()) {
          QLog.d(d, 2, "hitEnd sucess action = " + paramString2 + " , hit = true" + ", uin = " + paramString1);
        }
        StatisticCollector.a(BaseApplicationImpl.getContext()).a(paramString1, paramString2, true, 0L, 0L, null, null);
        jdField_a_of_type_JavaUtilMap.remove(paramString2);
        b.remove(paramString2);
      }
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(d, 2, "preloadMark preloadAction = " + paramString + " , flag = " + paramBoolean);
    }
    if (paramBoolean) {
      b(a(), paramString);
    }
    jdField_a_of_type_JavaUtilMap.put(paramString, Boolean.valueOf(false));
    ...
    if (paramString2 != null)
    {
      ...
      if ((localBoolean == null) || (!localBoolean.booleanValue()))
      {
        ...
        if ((localBoolean != null) && (localBoolean.booleanValue()))
        {
          jdField_a_of_type_JavaUtilMap.put(paramString2, Boolean.valueOf(true));
          if (QLog.isColorLevel()) {
            QLog.d(d, 2, "hitEnd action = " + paramString2 + " , hit = false" + ", uin = " + paramString1);
          }
