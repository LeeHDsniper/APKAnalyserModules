  ...
  implements SharedPreferences
{
  ...
  public n(WeakReference paramWeakReference, String paramString, int paramInt)
  {
    ...
    for (a = new f(paramWeakReference, paramString);; a = new k((Context)paramWeakReference.get(), paramString, paramInt))
    {
      b = new o(this, (byte)0);
      return;
    }
  ...
  {
    return ((Boolean)a.a(paramString, d.c, Boolean.valueOf(false))).booleanValue();
  }
  ...
  {
    return ((Boolean)a.a(paramString, d.h, Boolean.valueOf(paramBoolean))).booleanValue();
  }
  
  public final float getFloat(String paramString, float paramFloat)
  {
    return ((Float)a.a(paramString, d.f, Float.valueOf(paramFloat))).floatValue();
  }
  
  public final int getInt(String paramString, int paramInt)
  {
    return ((Integer)a.a(paramString, d.d, Integer.valueOf(paramInt))).intValue();
  }
  
  public final long getLong(String paramString, long paramLong)
  {
    return ((Long)a.a(paramString, d.e, Long.valueOf(paramLong))).longValue();
  }
  
  public final String getString(String paramString1, String paramString2)
  {
    return (String)a.a(paramString1, d.g, paramString2);
  }
  
  public final Set getStringSet(String paramString, Set paramSet)
  {
    paramString = a.a(paramString, d.i, paramSet);
  ...
  public final void registerOnSharedPreferenceChangeListener(SharedPreferences.OnSharedPreferenceChangeListener paramOnSharedPreferenceChangeListener)
  {
    try
    {
      ...
      c.add(paramOnSharedPreferenceChangeListener);
      return;
    }
    finally {}
  }
  ...
  public final void unregisterOnSharedPreferenceChangeListener(SharedPreferences.OnSharedPreferenceChangeListener paramOnSharedPreferenceChangeListener)
  {
    ...
    {
      if (c != null) {
        c.remove(paramOnSharedPreferenceChangeListener);
      }
      return;
    }
    finally
