...
public class SimpleAccount
{
      ...
      for (;;)
      {
        ...
        try
        {
          if (paramString.length == 2)
          {
            ...
            attributes.put(paramString[0], str);
          }
          i += 1;
        }
  ...
  {
    if (attributes.containsKey(paramString1)) {
      return (String)attributes.get(paramString1);
    }
    return paramString2;
  }
  ...
  {
    return (String)attributes.remove(paramString);
  }
  ...
  public String toStoreString()
  {
    ...
    Object localObject2 = attributes.keySet().iterator();
    while (((Iterator)localObject2).hasNext()) {
      try
      {
        String str1 = (String)((Iterator)localObject2).next();
        String str2 = (String)attributes.get(str1);
        if (str2 != null) {
