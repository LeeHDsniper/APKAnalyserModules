...
public class MD5
{
  ...
  public static byte[] getPartfileMd5(String paramString, long paramLong)
  {
    ...
    //   16: astore 7
    //   18: aload_0
    //   19: invokevirtual 61	java/lang/String:length	()I
    //   22: ifeq +13 -> 35
    //   25: lload_1
    //   26: lconst_0
    //   27: lcmp
    ...
    //   35: aload 7
    //   37: areturn
    //   38: new 84	java/io/FileInputStream
    //   41: dup
    //   42: aload_0
    //   43: invokespecial 85	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   46: astore 8
    //   48: aload 8
    //   50: astore 7
    //   52: new 63	java/io/File
    //   55: dup
    //   56: aload_0
    //   57: invokespecial 66	java/io/File:<init>	(Ljava/lang/String;)V
    //   60: astore_0
    //   61: aload 8
    //   63: astore 7
    //   65: aload_0
    //   66: invokevirtual 70	java/io/File:exists	()Z
    //   69: ifeq +126 -> 195
    //   72: aload 8
    //   74: astore 7
    //   76: aload_0
    ...
    //   104: aload 8
    //   106: lload_3
    //   107: invokestatic 89	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   110: astore_0
    //   111: aload_0
    //   112: astore 7
    //   114: aload 8
    //   116: ifnull -81 -> 35
    //   119: aload 8
    //   121: invokevirtual 92	java/io/FileInputStream:close	()V
    //   124: aload_0
    //   125: areturn
    //   126: astore 7
    //   128: aload 7
    ...
    //   140: astore 7
    //   142: aload 9
    //   144: invokevirtual 80	java/lang/Exception:printStackTrace	()V
    //   147: aload 11
    //   149: astore 7
    //   151: aload_0
    //   152: ifnull -117 -> 35
    //   155: aload_0
    //   156: invokevirtual 92	java/io/FileInputStream:close	()V
    //   159: aconst_null
    //   160: areturn
    //   161: astore 7
    //   163: aload 10
    ...
    //   175: ifnull +8 -> 183
    //   178: aload 7
    //   180: invokevirtual 92	java/io/FileInputStream:close	()V
    //   183: aload_0
    //   184: athrow
    //   185: astore 7
    //   187: aload 7
    //   189: invokevirtual 93	java/io/IOException:printStackTrace	()V
    //   192: goto -9 -> 183
    //   195: aload 11
    //   197: astore 7
    //   199: aload 8
  ...
  public static byte[] sysGetStremMd5(InputStream paramInputStream, long paramLong)
  {
    ...
    //   60: iconst_0
    //   61: iload_3
    //   62: invokevirtual 121	java/io/InputStream:read	([BII)I
    //   65: istore_3
    //   66: iload_3
    //   67: iflt -57 -> 10
    //   70: aload 6
    ...
    //   74: iconst_0
    //   75: iload_3
    //   76: invokevirtual 109	java/security/MessageDigest:update	([BII)V
    //   79: lload 4
    //   81: iload_3
    //   82: i2l
    //   83: ladd
    ...
    //   86: goto -54 -> 32
    //   89: aload_0
    //   90: invokevirtual 122	java/io/InputStream:close	()V
    //   93: aload 6
    //   95: invokevirtual 112	java/security/MessageDigest:digest	()[B
    //   98: astore_0
    //   99: aload_0
    //   100: areturn
    //   101: astore_0
    //   102: aload_0
    //   103: invokevirtual 113	java/security/NoSuchAlgorithmException:printStackTrace	()V
    //   106: aconst_null
    //   107: areturn
    //   108: astore_0
    //   109: aload_0
    //   110: invokevirtual 93	java/io/IOException:printStackTrace	()V
    //   113: aconst_null
    //   114: areturn
    //   115: astore_0
    //   116: goto -23 -> 93
