  ...
  extends BroadcastReceiver
{
  ...
  public SkinnableActivityProcesser(Activity paramActivity, Callback paramCallback)
  {
    ...
    try
    {
      a.registerReceiver(this, new IntentFilter("com.tencent.qplus.THEME_INVALIDATE"), "com.tencent.msg.permission.pushnotify", null);
      return;
    }
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        try
        {
          paramContext = a.getWindow().getDecorView();
