  ...
  extends ColorStateList
{
  ...
  public SkinnableColorStateList(int[][] paramArrayOfInt, int[] paramArrayOfInt1)
  {
    ...
    {
      f = paramArrayOfInt1[0];
      while (i < paramArrayOfInt.length)
      {
        if (paramArrayOfInt[i].length == 0) {
          f = paramArrayOfInt1[i];
        }
        i += 1;
      }
    }
    ...
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      e = new int[n];
      d = new int[n][];
      System.arraycopy(localObject1, 0, e, 0, n);
      System.arraycopy(paramResources, 0, d, 0, n);
      return;
      label1075:
      i3 = j;
      j = k;
  ...
  {
    return "ColorStateList{mStateSpecs=" + Arrays.deepToString(d) + "mColors=" + Arrays.toString(e) + "mDefaultColor=" + f + '}';
  }
  
  public ColorStateList withAlpha(int paramInt)
  {
    int[] arrayOfInt = new int[e.length];
    int j = arrayOfInt.length;
    int i = 0;
    while (i < j)
    {
      arrayOfInt[i] = (e[i] & 0xFFFFFF | paramInt << 24);
      i += 1;
    }
    return new ColorStateList(d, arrayOfInt);
  }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    while (paramInt < i)
    {
      paramParcel.writeIntArray(d[paramInt]);
      paramInt += 1;
    }
