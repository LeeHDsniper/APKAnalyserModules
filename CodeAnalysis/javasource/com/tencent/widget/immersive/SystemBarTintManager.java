  ...
  implements Handler.Callback
{
  ...
  public SystemBarTintManager(Window paramWindow, boolean paramBoolean)
  {
    ...
    jdField_a_of_type_ComTencentWidgetImmersiveSystemBarTintManager$SystemBarConfig = new SystemBarTintManager.SystemBarConfig(paramWindow, c, null);
    if (c) {
  ...
  {
    jdField_a_of_type_AndroidViewView = new View(paramWindow.getContext());
    paramWindow = new FrameLayout.LayoutParams(-1, jdField_a_of_type_ComTencentWidgetImmersiveSystemBarTintManager$SystemBarConfig.a());
    gravity = 48;
    jdField_a_of_type_AndroidViewView.setLayoutParams(paramWindow);
    try
    {
      IphoneTitleBarActivity.setLayerType(jdField_a_of_type_AndroidViewView);
      jdField_a_of_type_AndroidViewView.setVisibility(8);
      paramViewGroup.addView(jdField_a_of_type_AndroidViewView);
      return;
    }
  ...
  {
    return jdField_a_of_type_ComTencentWidgetImmersiveSystemBarTintManager$SystemBarConfig;
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (c)
    {
      localView = jdField_a_of_type_AndroidViewView;
      if (!paramBoolean) {
        break label62;
      }
    }
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(0, paramInt);
      return;
    }
    jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(1, paramInt);
  }
  ...
  public void b(float paramFloat)
  {
    ...
    {
      jdField_a_of_type_AndroidViewView.setAlpha(paramFloat);
      return;
    }
    AlphaAnimation localAlphaAnimation = new AlphaAnimation(paramFloat, paramFloat);
    localAlphaAnimation.setDuration(0L);
    localAlphaAnimation.setFillAfter(true);
    jdField_a_of_type_AndroidViewView.startAnimation(localAlphaAnimation);
  }
  ...
  {
    if (c) {
      jdField_a_of_type_AndroidViewView.setBackgroundDrawable(paramDrawable);
    }
  }
  ...
  {
    if (c) {
      jdField_a_of_type_AndroidViewView.setBackgroundColor(paramInt);
    }
  }
  ...
  {
    if (c) {
      jdField_a_of_type_AndroidViewView.setBackgroundResource(paramInt);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("status", 2, "SystemBarTintManager=" + what);
    }
    switch (what)
    {
    default: 
