...
public class QlinkServiceManager
{
  ...
  public QlinkServiceManager(QQAppInterface paramQQAppInterface)
  {
    ...
    jdField_a_of_type_CooperationQlinkQlinkServiceProxy = new QlinkServiceProxy(paramQQAppInterface);
  }
  ...
  private int a(String paramString, Bundle paramBundle, Handler paramHandler, long paramLong)
  {
    ...
    try
    {
      jdField_a_of_type_CooperationQlinkQlinkServiceProxy.a(paramHandler);
      return i;
    }
  ...
  public void a()
  {
    ...
    localPluginCommunicationHandler.register(new ulx(this, "qlink.notify"));
  }
