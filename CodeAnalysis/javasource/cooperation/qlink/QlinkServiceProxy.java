...
public class QlinkServiceProxy
{
  ...
  public QlinkServiceProxy(AppRuntime paramAppRuntime)
  {
    ...
    jdField_a_of_type_AndroidContentServiceConnection = new uly(this);
    jdField_a_of_type_MqqAppAppRuntime = paramAppRuntime;
  }
  
  private boolean a()
  {
    return jdField_a_of_type_CooperationQlinkIQlinkService != null;
  }
  
  private void b()
  {
    ulz localUlz = new ulz(this);
    localUlz.setName("handleWaitSendProxyMsgThread");
    localUlz.start();
  }
  
  private void b(SendMsg paramSendMsg)
  {
    jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(paramSendMsg);
  }
  
  private void c(SendMsg paramSendMsg)
  {
    jdField_a_of_type_CooperationQlinkIQlinkService.a(paramSendMsg);
  }
  
  public void a()
  {
    long l = System.currentTimeMillis();
    if ((jdField_a_of_type_Long == -1L) || (l - jdField_a_of_type_Long > 10000L))
    {
      jdField_a_of_type_Long = l;
      QlinkPluginProxyService.a(jdField_a_of_type_MqqAppAppRuntime, jdField_a_of_type_AndroidContentServiceConnection);
      return;
    }
  ...
  public void a(SendMsg paramSendMsg)
  {
    ...
    //   14: aload_0
    //   15: aload_1
    //   16: invokespecial 62	cooperation/qlink/QlinkServiceProxy:c	(Lcooperation/qlink/SendMsg;)V
    //   19: aload_2
    //   20: monitorexit
    //   21: return
    //   22: aload_0
    //   23: getfield 38	cooperation/qlink/QlinkServiceProxy:jdField_a_of_type_Boolean	Z
    //   26: ifeq +23 -> 49
    //   29: aload_0
    //   30: aload_1
    ...
    //   49: aload_0
    //   50: iconst_1
    //   51: putfield 38	cooperation/qlink/QlinkServiceProxy:jdField_a_of_type_Boolean	Z
    //   54: aload_0
    //   55: aload_1
    ...
    //   66: astore_2
    //   67: aload_0
    //   68: getfield 52	cooperation/qlink/QlinkServiceProxy:jdField_a_of_type_CooperationQlinkIQlinkService	Lcooperation/qlink/IQlinkService;
    //   71: ifnonnull +9 -> 80
    //   74: aload_0
    //   75: aload_1
