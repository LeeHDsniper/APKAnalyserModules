...
public class LocalMultiProcConfig
{
  ...
  private static final String h = "QZ_QQ_shared_preference";
  ...
  private static SharedPreferences a(String paramString)
  {
    ...
    for (int i = 4;; i = 0) {
      return localBaseApplication.getSharedPreferences(paramString, i);
    }
  }
  ...
  {
    ThreadManager.a(new uqp(paramString1, paramString2, paramBoolean), 8, null, true);
  }
