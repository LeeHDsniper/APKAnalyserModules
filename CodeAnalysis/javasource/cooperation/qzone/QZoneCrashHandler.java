  ...
  extends CrashHandler
{
  ...
  public static void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    //   0: aconst_null
    //   1: astore 5
    //   3: new 95	java/io/File
    //   6: dup
    //   7: getstatic 100	com/tencent/mobileqq/app/AppConstants:bh	Ljava/lang/String;
    ...
    //   20: ifne +9 -> 29
    //   23: aload 4
    //   25: invokevirtual 108	java/io/File:mkdirs	()Z
    //   28: pop
    //   29: new 95	java/io/File
    //   32: dup
    //   33: new 110	java/lang/StringBuilder
    //   36: dup
    //   37: invokespecial 111	java/lang/StringBuilder:<init>	()V
    //   40: getstatic 100	com/tencent/mobileqq/app/AppConstants:bh	Ljava/lang/String;
    ...
    //   54: invokespecial 102	java/io/File:<init>	(Ljava/lang/String;)V
    //   57: astore 4
    //   59: aload 4
    //   61: invokevirtual 105	java/io/File:exists	()Z
    //   64: ifne +231 -> 295
    //   67: iconst_1
    //   68: istore_3
    //   69: new 122	java/io/FileWriter
    //   72: dup
    //   73: aload 4
    //   75: iconst_1
    //   76: invokespecial 125	java/io/FileWriter:<init>	(Ljava/io/File;Z)V
    //   79: astore 4
    //   81: iload_3
    //   82: ifeq +105 -> 187
    //   85: aload 4
    //   87: new 110	java/lang/StringBuilder
    //   90: dup
    //   91: invokespecial 111	java/lang/StringBuilder:<init>	()V
    //   94: ldc 127
    //   96: invokevirtual 115	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   99: getstatic 132	android/os/Build:MODEL	Ljava/lang/String;
    ...
    //   110: getstatic 137	android/os/Build$VERSION:RELEASE	Ljava/lang/String;
    ...
    //   119: invokevirtual 140	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   122: aload 4
    //   124: ldc -114
    //   126: invokevirtual 140	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   129: new 144	android/text/format/Time
    //   132: dup
    //   133: invokespecial 145	android/text/format/Time:<init>	()V
    //   136: astore 5
    //   138: aload 5
    //   140: invokevirtual 148	android/text/format/Time:setToNow	()V
    //   143: aload 4
    //   145: new 110	java/lang/StringBuilder
    //   148: dup
    //   149: invokespecial 111	java/lang/StringBuilder:<init>	()V
    //   152: aload 5
    //   154: ldc -106
    //   156: invokevirtual 154	android/text/format/Time:format	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   170: invokevirtual 140	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   173: aload 4
    //   175: ldc -98
    //   177: invokevirtual 140	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   180: aload 4
    //   182: ldc -114
    //   184: invokevirtual 140	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   187: new 144	android/text/format/Time
    //   190: dup
    //   191: invokespecial 145	android/text/format/Time:<init>	()V
    //   194: astore 5
    //   196: aload 5
    //   198: invokevirtual 148	android/text/format/Time:setToNow	()V
    //   201: aload 4
    ...
    //   210: aload 5
    //   212: ldc -106
    //   214: invokevirtual 154	android/text/format/Time:format	(Ljava/lang/String;)Ljava/lang/String;
    //   217: invokevirtual 115	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   220: ldc -100
    ...
    //   228: invokevirtual 140	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   231: aload_0
    //   232: ifnull +32 -> 264
    //   235: aload 4
    //   237: new 110	java/lang/StringBuilder
    //   240: dup
    //   241: invokespecial 111	java/lang/StringBuilder:<init>	()V
    //   244: ldc -96
    //   246: invokevirtual 115	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   249: aload_0
    ...
    //   261: invokevirtual 140	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   264: aload 4
    //   266: aload_1
    //   267: invokevirtual 140	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   270: aload 4
    //   272: ldc -114
    //   274: invokevirtual 140	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   277: aload 4
    //   279: invokevirtual 165	java/io/FileWriter:close	()V
    //   282: iconst_0
    //   283: ifeq +11 -> 294
    //   286: new 167	java/lang/NullPointerException
    //   289: dup
    //   290: invokespecial 168	java/lang/NullPointerException:<init>	()V
    //   293: athrow
    //   294: return
    //   295: iconst_0
    //   296: istore_3
    //   297: goto -228 -> 69
    //   300: astore_0
    //   301: invokestatic 173	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   304: ifeq -10 -> 294
    //   307: ldc -81
    //   309: iconst_1
    //   310: new 110	java/lang/StringBuilder
    //   313: dup
    //   314: invokespecial 111	java/lang/StringBuilder:<init>	()V
    //   317: ldc -79
    //   319: invokevirtual 115	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   322: aload_0
    //   323: invokevirtual 180	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   332: invokestatic 184	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   335: return
    //   336: astore_1
    //   337: aload 5
    //   339: astore_0
    //   340: aload_1
    //   341: invokevirtual 187	java/lang/Exception:printStackTrace	()V
    //   344: aload_0
    //   345: ifnull -51 -> 294
    //   348: aload_0
    //   349: invokevirtual 165	java/io/FileWriter:close	()V
    //   352: return
    //   353: astore_0
    //   354: invokestatic 173	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   357: ifeq -63 -> 294
    //   360: ldc -81
    //   362: iconst_1
    ...
    //   375: aload_0
    //   376: invokevirtual 180	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   379: invokevirtual 115	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   382: invokevirtual 120	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   385: invokestatic 184	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   388: return
    //   389: astore_0
    //   390: aconst_null
    //   391: astore_1
    ...
    //   393: ifnull +7 -> 400
    //   396: aload_1
    //   397: invokevirtual 165	java/io/FileWriter:close	()V
    //   400: aload_0
    //   401: athrow
    //   402: astore_1
    //   403: invokestatic 173	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   406: ifeq -6 -> 400
    //   409: ldc -81
    //   411: iconst_1
    //   412: new 110	java/lang/StringBuilder
    //   415: dup
    //   416: invokespecial 111	java/lang/StringBuilder:<init>	()V
    //   419: ldc -79
    //   421: invokevirtual 115	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   424: aload_1
    //   425: invokevirtual 180	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   428: invokevirtual 115	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   431: invokevirtual 120	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   434: invokestatic 184	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   437: goto -37 -> 400
    //   440: astore_0
    //   441: aload 4
    //   443: astore_1
