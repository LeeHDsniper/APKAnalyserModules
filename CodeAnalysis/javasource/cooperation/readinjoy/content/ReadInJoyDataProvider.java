  ...
  extends AppContentProvider
{
  ...
  private SQLiteDatabase a(Uri paramUri, boolean paramBoolean)
  {
    ...
    return null;
    if ((jdField_a_of_type_CooperationReadinjoyContentReadInJoyDataProvider$ReadInJoyDBHelper == null) || (!jdField_a_of_type_CooperationReadinjoyContentReadInJoyDataProvider$ReadInJoyDBHelper.f.equals(str2)))
    {
      jdField_a_of_type_CooperationReadinjoyContentReadInJoyDataProvider$ReadInJoyDBHelper = new ReadInJoyDataProvider.ReadInJoyDBHelper(this, localAppRuntime.getApplication().getApplicationContext(), str1);
      jdField_a_of_type_CooperationReadinjoyContentReadInJoyDataProvider$ReadInJoyDBHelper.f = str2;
    }
    if (paramBoolean) {
      return jdField_a_of_type_CooperationReadinjoyContentReadInJoyDataProvider$ReadInJoyDBHelper.getReadableDatabase();
    }
    return jdField_a_of_type_CooperationReadinjoyContentReadInJoyDataProvider$ReadInJoyDBHelper.getWritableDatabase();
  }
  ...
  public boolean onCreate()
  {
    ...
    jdField_a_of_type_AndroidContentUriMatcher.addURI("qq.readinjoy", "subscribe_msg_records", 2000);
    jdField_a_of_type_AndroidContentUriMatcher.addURI("qq.readinjoy", "notify_msg_records", 2001);
    jdField_a_of_type_AndroidContentUriMatcher.addURI("qq.readinjoy", "recent_data", 2002);
    jdField_a_of_type_AndroidContentUriMatcher.addURI("qq.readinjoy", "feeds_msg_records", 2003);
    jdField_a_of_type_AndroidContentUriMatcher.addURI("qq.readinjoy", "common_records", 2004);
    return true;
  }
