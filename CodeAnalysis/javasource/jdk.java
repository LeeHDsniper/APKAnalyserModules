  ...
  extends AsyncTask
{
  ...
  public jdk(JumpActivity paramJumpActivity, Intent paramIntent)
  {
  ...
  protected Uri a(Object... paramVarArgs)
  {
    ...
    //   29: astore 14
    //   31: getstatic 38	com/tencent/mobileqq/app/AppConstants:bv	Ljava/lang/String;
    //   34: astore 12
    //   36: aload 13
    ...
    //   96: astore 4
    //   98: aload 12
    //   100: invokestatic 70	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/lang/String;)Z
    //   103: ifne +22 -> 125
    //   106: aload_1
    //   107: astore 5
    //   109: aload_1
    //   110: astore 4
    //   112: new 72	java/io/File
    //   115: dup
    //   116: aload 12
    //   118: invokespecial 75	java/io/File:<init>	(Ljava/lang/String;)V
    //   121: invokevirtual 78	java/io/File:mkdirs	()Z
    //   124: pop
    //   125: aload_1
    //   126: astore 5
    //   128: aload_1
    //   129: astore 4
    //   131: new 80	java/io/FileOutputStream
    //   134: dup
    //   135: new 72	java/io/File
    //   138: dup
    //   139: new 82	java/lang/StringBuilder
    //   142: dup
    //   143: invokespecial 83	java/lang/StringBuilder:<init>	()V
    //   146: aload 12
    ...
    //   155: invokevirtual 91	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   158: invokespecial 75	java/io/File:<init>	(Ljava/lang/String;)V
    //   161: invokespecial 94	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   164: astore 8
    //   166: aload 7
    //   168: astore 4
    //   170: aload 10
    ...
    //   179: aload 14
    //   181: ldc 96
    //   183: invokevirtual 100	android/content/ContentResolver:openAssetFileDescriptor	(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    //   186: astore 9
    //   188: aload 11
    //   190: astore 6
    //   192: aload 9
    ...
    //   203: astore 5
    //   205: aload 9
    //   207: invokevirtual 106	android/content/res/AssetFileDescriptor:createInputStream	()Ljava/io/FileInputStream;
    //   210: astore 6
    //   212: aload 6
    //   214: astore 4
    //   216: aload 6
    ...
    //   235: aload 6
    //   237: aload 7
    //   239: invokevirtual 112	java/io/InputStream:read	([B)I
    //   242: istore_2
    //   243: iload_2
    //   244: iconst_m1
    ...
    //   260: iconst_0
    //   261: iload_2
    //   262: invokevirtual 116	java/io/FileOutputStream:write	([BII)V
    //   265: goto -38 -> 227
    //   268: astore 7
    //   270: aload_3
    //   271: astore 5
    ...
    //   307: ifnull +8 -> 315
    //   310: aload 6
    //   312: invokevirtual 120	java/io/InputStream:close	()V
    //   315: aload 4
    //   317: ifnull +8 -> 325
    //   320: aload 4
    //   322: invokevirtual 121	java/io/FileOutputStream:close	()V
    ...
    //   342: aload_3
    //   343: invokevirtual 87	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   346: invokevirtual 91	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   349: invokestatic 127	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   352: areturn
    //   353: aload 6
    //   355: astore 4
    //   357: aload 6
    //   359: astore 5
    //   361: aload 8
    //   363: invokevirtual 130	java/io/FileOutputStream:flush	()V
    //   366: aload_3
    //   367: ifnull +9 -> 376
    //   370: aload_3
    ...
    //   378: ifnull +8 -> 386
    //   381: aload 6
    //   383: invokevirtual 120	java/io/InputStream:close	()V
    //   386: aload 8
    //   388: ifnull +8 -> 396
    //   391: aload 8
    //   393: invokevirtual 121	java/io/FileOutputStream:close	()V
    //   396: new 82	java/lang/StringBuilder
    //   399: dup
    //   400: invokespecial 83	java/lang/StringBuilder:<init>	()V
    //   403: ldc 123
    ...
    //   417: invokevirtual 91	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   420: invokestatic 127	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   423: areturn
    //   424: astore_3
    //   425: aload_3
    //   426: invokevirtual 131	java/io/IOException:printStackTrace	()V
    //   429: goto -43 -> 386
    //   432: astore_3
    //   433: aload_3
    //   434: invokevirtual 131	java/io/IOException:printStackTrace	()V
    //   437: goto -41 -> 396
    //   440: astore_1
    //   441: aload_1
    //   442: invokevirtual 131	java/io/IOException:printStackTrace	()V
    //   445: goto -130 -> 315
    //   448: astore_1
    //   449: aload_1
    //   450: invokevirtual 131	java/io/IOException:printStackTrace	()V
    //   453: goto -128 -> 325
    //   456: astore 4
    //   458: aconst_null
    //   459: astore 7
    ...
    //   484: ifnull +8 -> 492
    //   487: aload 5
    //   489: invokevirtual 120	java/io/InputStream:close	()V
    //   492: aload_3
    //   493: ifnull +7 -> 500
    //   496: aload_3
    //   497: invokevirtual 121	java/io/FileOutputStream:close	()V
    //   500: new 82	java/lang/StringBuilder
    //   503: dup
    //   504: invokespecial 83	java/lang/StringBuilder:<init>	()V
    //   507: ldc 123
    //   509: invokevirtual 87	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   512: aload 12
    //   514: invokevirtual 87	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   517: aload_1
    //   518: invokevirtual 87	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   521: invokevirtual 91	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   524: invokestatic 127	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   527: pop
    //   528: aload 4
    //   530: athrow
    //   531: astore 5
    //   533: aload 5
    //   535: invokevirtual 131	java/io/IOException:printStackTrace	()V
    //   538: goto -46 -> 492
    //   541: astore_3
    //   542: aload_3
    //   543: invokevirtual 131	java/io/IOException:printStackTrace	()V
    //   546: goto -46 -> 500
    //   549: astore 4
    //   551: ldc -123
    //   553: astore_1
  ...
  {
    jdField_a_of_type_AndroidContentIntent.setData(paramUri);
    ForwardBaseOption.a(jdField_a_of_type_ComTencentMobileqqActivityJumpActivity, jdField_a_of_type_AndroidContentIntent);
