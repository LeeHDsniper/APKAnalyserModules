...
public class lvt
  implements Runnable
{
  public lvt(C2CMessageResultAdapter paramC2CMessageResultAdapter, String paramString, long paramLong)
  {
  ...
  public void run()
  {
    ...
    if ((localObject != null) && (mSearchData1 != null) && (!mSearchData1.isEmpty()))
    {
      ...
      while (i < mSearchData1.size())
      {
        ...
        if (jdField_a_of_type_ComTencentMobileqqActivityMessagesearchC2CMessageResultAdapter.a(localMessageRecord))
        {
          ...
          jdField_a_of_type_ComTencentMobileqqActivityMessagesearchC2CMessageResultAdapter.jdField_a_of_type_JavaUtilSet.add(Long.valueOf(shmsgseq));
        }
        i += 1;
      }
    }
    ...
    jdField_a_of_type_ComTencentMobileqqActivityMessagesearchC2CMessageResultAdapter.jdField_a_of_type_ComTencentUtilMqqWeakReferenceHandler.obtainMessage(8, localObject).sendToTarget();
  }
}
