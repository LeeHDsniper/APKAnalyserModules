...
public class mdx
  implements Runnable
{
  public mdx(TransactionActivity paramTransactionActivity)
  {
  ...
  public void run()
  {
    ...
    TransactionActivity.a(a).dispatchTouchEvent(localMotionEvent1);
    MotionEvent localMotionEvent2 = MotionEvent.obtain(SystemClock.uptimeMillis(), SystemClock.uptimeMillis(), 1, 0.0F, 0.0F, 0);
    TransactionActivity.a(a).dispatchTouchEvent(localMotionEvent2);
