  ...
  extends Servlet
{
  ...
  {
    Intent localIntent = (Intent)mIntents.remove(Integer.valueOf(paramFromServiceMsg.getAppSeq()));
  ...
  {
    return (Intent)mIntents.remove(Integer.valueOf(paramInt));
  }
  ...
  protected void sendToMSF(Intent paramIntent, ToServiceMsg paramToServiceMsg)
  {
    ...
    if ((paramToServiceMsg.isNeedCallback()) && (paramIntent != null)) {
      mIntents.put(Integer.valueOf(paramToServiceMsg.getAppSeq()), paramIntent);
    }
