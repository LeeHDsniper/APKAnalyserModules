  ...
  implements Constants.Action
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      localBundle.putString("userAccount", (String)attributes.get("userAccount"));
      localBundle.putLong("dwAppid", ((Long)attributes.get("dwAppid")).longValue());
      localBundle.putInt("dwMainSigMap", ((Integer)attributes.get("dwMainSigMap")).intValue());
      localBundle.putLong("dwSubDstAppid", ((Long)attributes.get("dwSubDstAppid")).longValue());
      localBundle.putString("userPasswd", (String)attributes.get("userPasswd"));
      localBundle.putByteArray("pictureData", (byte[])attributes.get("pictureData"));
      localBundle.putParcelable("userSigInfo", (Parcelable)attributes.get("userSigInfo"));
      localBundle.putInt("ret", ((Integer)attributes.get("ret")).intValue());
      localBundle.putParcelable("lastError", (ErrMsg)attributes.get("lastError"));
    }
    ...
    {
      localBundle.putString("userAccount", (String)attributes.get("userAccount"));
      localBundle.putLong("dwSrcAppid", ((Long)attributes.get("dwSrcAppid")).longValue());
      localBundle.putLong("dwDstAppid", ((Long)attributes.get("dwDstAppid")).longValue());
      localBundle.putInt("dwMainSigMap", ((Integer)attributes.get("dwMainSigMap")).intValue());
      localBundle.putLong("dwSubDstAppid", ((Long)attributes.get("dwSubDstAppid")).longValue());
      localBundle.putParcelable("userSigInfo", (Parcelable)attributes.get("userSigInfo"));
      localBundle.putInt("ret", ((Integer)attributes.get("ret")).intValue());
    ...
    {
      localBundle.putString("userAccount", (String)attributes.get("userAccount"));
      localBundle.putByteArray("userInput", (byte[])attributes.get("userInput"));
      localBundle.putByteArray("pictureData", (byte[])attributes.get("pictureData"));
      localBundle.putParcelable("userSigInfo", (Parcelable)attributes.get("userSigInfo"));
      localBundle.putInt("ret", ((Integer)attributes.get("ret")).intValue());
      localBundle.putParcelable("lastError", (ErrMsg)attributes.get("lastError"));
    ...
    {
      localBundle.putString("userAccount", (String)attributes.get("userAccount"));
      localBundle.putByteArray("appName", (byte[])attributes.get("appName"));
      localBundle.putLong("time", ((Long)attributes.get("time")).longValue());
      localBundle.putStringArrayList("data", (ArrayList)attributes.get("data"));
      localBundle.putByteArray("errMsg", (byte[])attributes.get("errMsg"));
      localBundle.putInt("ret", ((Integer)attributes.get("ret")).intValue());
      localBundle.putParcelable("lastError", (ErrMsg)attributes.get("lastError"));
    }
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      localBundle.putLong("dwSrcAppid", ((Long)attributes.get("dwSrcAppid")).longValue());
      localBundle.putInt("dwMainSigMap", ((Integer)attributes.get("dwMainSigMap")).intValue());
      localBundle.putLong("dwSubSrcAppid", ((Long)attributes.get("dwSubSrcAppid")).longValue());
      localBundle.putByteArray("dstAppName", (byte[])attributes.get("dstAppName"));
      localBundle.putLong("dwDstSsoVer", ((Long)attributes.get("dwDstSsoVer")).longValue());
      localBundle.putLong("dwSubDstAppid", ((Long)attributes.get("dwSubDstAppid")).longValue());
      localBundle.putLong("dwSubDstAppid", ((Long)attributes.get("dwSubDstAppid")).longValue());
      localBundle.putByteArray("dstAppVer", (byte[])attributes.get("dstAppVer"));
      localBundle.putByteArray("dstAppSign", (byte[])attributes.get("dstAppSign"));
      localBundle.putParcelable("userSigInfo", (WUserSigInfo)attributes.get("userSigInfo"));
      localBundle.putParcelable("fastLoginInfo", (WFastLoginInfo)attributes.get("fastLoginInfo"));
      localBundle.putInt("ret", ((Integer)attributes.get("ret")).intValue());
      localBundle.putParcelable("lastError", (ErrMsg)attributes.get("lastError"));
    }
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      localBundle.putParcelable("sigInfo", (Parcelable)attributes.get("sigInfo"));
      localBundle.putParcelable("devLockInfo", (Parcelable)attributes.get("devLockInfo"));
      localBundle.putInt("ret", ((Integer)attributes.get("ret")).intValue());
      localBundle.putParcelable("lastError", (ErrMsg)attributes.get("lastError"));
    }
    ...
    {
      localBundle.putString("userAccount", (String)attributes.get("userAccount"));
      localBundle.putLong("smsAppid", ((Long)attributes.get("smsAppid")).longValue());
      localBundle.putParcelable("sigInfo", (Parcelable)attributes.get("sigInfo"));
      localBundle.putInt("remainMsgCnt", ((Integer)attributes.get("remainMsgCnt")).intValue());
      localBundle.putInt("timeLimit", ((Integer)attributes.get("timeLimit")).intValue());
      localBundle.putInt("ret", ((Integer)attributes.get("ret")).intValue());
      localBundle.putParcelable("lastError", (ErrMsg)attributes.get("lastError"));
    }
    ...
    return;
    localBundle.putString("error", (String)attributes.get("error"));
    localBundle.putInt("cmd", ((Integer)attributes.get("cmd")).intValue());
    ...
    if (attributes != null)
    {
      ...
      localBundle.putByteArray("supersig", (byte[])attributes.get("supersig"));
      localBundle.putByteArray("contactssig", (byte[])attributes.get("contactssig"));
      localBundle.putByteArray("msg", (byte[])attributes.get("msg"));
    ...
    if (attributes != null)
    {
      localBundle.putString("countryCode", (String)attributes.get("countryCode"));
      localBundle.putString("mobile", (String)attributes.get("mobile"));
      localBundle.putParcelable("errMsg", (ErrMsg)attributes.get("errMsg"));
      localBundle.putString("msg", (String)attributes.get("msg"));
      localObject3 = paramFromServiceMsg.getAttribute("ret");
      localObject2 = Integer.valueOf(paramFromServiceMsg.getBusinessFailCode());
      localObject1 = localObject2;
      if (localObject3 != null)
    ...
    if (attributes != null)
    {
      localBundle.putString("msgCode", (String)attributes.get("msgCode"));
      localBundle.putString("mobile", (String)attributes.get("mobile"));
      localBundle.putParcelable("errMsg", (ErrMsg)attributes.get("errMsg"));
      localObject3 = paramFromServiceMsg.getAttribute("ret");
      localObject2 = Integer.valueOf(paramFromServiceMsg.getBusinessFailCode());
    ...
    if (attributes != null)
    {
      ...
      localObject1 = attributes.get("ret");
      i = j;
    ...
    Object localObject1 = attributes.get("ret");
    i = j;
    if (localObject1 != null)
    {
      i = j;
  ...
  public void service(Intent paramIntent)
  {
    ...
    case 2105: 
      ...
      return;
    case 2106: 
      WFastLoginInfo localWFastLoginInfo = (WFastLoginInfo)intentMap.get("fastLoginInfo");
