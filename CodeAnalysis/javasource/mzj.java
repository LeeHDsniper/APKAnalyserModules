  ...
  implements Runnable
{
  ...
  public mzj(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
  ...
  public void run()
  {
    for (;;)
    {
      ...
      try
      {
        boolean bool = jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.i;
        if (bool) {
          return;
        }
      ...
      catch (Throwable localThrowable)
      {
        ...
        QLog.e("Q.Memory.MemoryManager", 2, "AlertMemoryRunner exception, actionType=" + jdField_a_of_type_Int, localThrowable);
        ...
        l3 = ajdField_a_of_type_Int * l2 / 100L;
        if (l1 < l3) {
          continue;
        }
        return;
        Object localObject1 = jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getSharedPreferences("MemoryInfomation", 0);
        ...
        Iterator localIterator = ((ActivityManager)jdField_a_of_type_AndroidContentContext.getSystemService("activity")).getRunningAppProcesses().iterator();
        if (!localIterator.hasNext()) {
          break label637;
        }
        ActivityManager.RunningAppProcessInfo localRunningAppProcessInfo = (ActivityManager.RunningAppProcessInfo)localIterator.next();
        String str = processName;
        if ((importance == 100) || ((importance == 200) && ((importance != 200) || (importanceReasonCode == 0))) || (a(str))) {
          continue;
        }
        ((ArrayList)localObject4).add(Pair.create(str, Long.valueOf(DeviceInfoUtil.a(pid))));
        continue;
      }
      finally
      {
      ...
      l2 = l2 * ajdField_a_of_type_Int / 100L;
      if (l1 >= l2)
      {
        jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = null;
        jdField_a_of_type_AndroidContentContext = null;
      ...
      localIntent = new Intent(jdField_a_of_type_AndroidContentContext, NotificationActivity.class);
      ...
      Object localObject4 = (ActivityManager)jdField_a_of_type_AndroidContentContext.getSystemService("activity");
