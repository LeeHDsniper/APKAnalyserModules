...
{
  public nky(SystemMessageProcessor paramSystemMessageProcessor, long paramLong1, long paramLong2, long paramLong3)
  {
  ...
  public void a(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Q.systemmsg.", 2, "clearFriendSystemMsgResp reqSeq=" + jdField_a_of_type_Long + ";resultCode=" + i + ";latestFriendSeq=" + b + ";latestGroupSeq=" + c);
      }
      return;
    }
