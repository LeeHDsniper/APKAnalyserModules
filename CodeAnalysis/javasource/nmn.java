  ...
  extends MessageObserver
{
  ...
  public nmn(MessageRoamHandler paramMessageRoamHandler, int paramInt)
  {
  ...
  {
    if (jdField_a_of_type_ComTencentMobileqqAppUtilsMessageRoamHandler.jdField_a_of_type_Int != jdField_a_of_type_Int) {
      return;
    }
    MqqHandler localMqqHandler = jdField_a_of_type_ComTencentMobileqqAppUtilsMessageRoamHandler.b.a(ChatHistoryForC2C.class);
    if (!paramBoolean)
    {
  ...
  protected void b(boolean paramBoolean, Object paramObject)
  {
    ...
    {
      ThreadManager.b().post(new nmo(this, l, j, (String)localObject, bool2));
      return;
    }
    paramObject = jdField_a_of_type_ComTencentMobileqqAppUtilsMessageRoamHandler.b.a(ChatHistoryForC2C.class);
    int i = 1;
    if (!paramBoolean) {
      if (bool1) {
        i = 2;
    ...
    for (;;)
    {
      ...
      for (i = 1;; i = 0)
      {
        ...
        return;
        localObject = (MessageRoamManager)jdField_a_of_type_ComTencentMobileqqAppUtilsMessageRoamHandler.b.getManager(91);
  ...
  protected void c(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      localObject1 = jdField_a_of_type_ComTencentMobileqqAppUtilsMessageRoamHandler.b.a(C2CMessageSearchDialog.class);
      if (!paramBoolean)
      {
