...
public class h
{
  ...
  public h(u paramU, int paramInt1, int paramInt2, ErrMsg paramErrMsg)
  {
    a = paramU;
    b = paramInt1;
    c = paramInt2;
  ...
  int a(byte[] paramArrayOfByte)
  {
    ...
    localObject1 = null;
    util.LOGI("notice len " + paramArrayOfByte.length, a.f + "");
    ...
    catch (Exception localException1)
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          d.setMessage(new String(arrayOfByte));
          d.setType(257);
          continue;
          d.setTitle(new String((byte[])localObject1));
        }
      }
      return d.getType();
    }
  ...
  byte[] a(int paramInt)
  {
    Object localObject1 = ByteBuffer.allocate("6.3.1.1521".length() + 24 + 2 + 2 + 1 + 4);
    Object localObject2 = u.b(a.h);
    ((ByteBuffer)localObject1).put(u.ab);
    ((ByteBuffer)localObject1).putInt((int)_sappid);
    ((ByteBuffer)localObject1).putInt((int)_sub_appid);
    ((ByteBuffer)localObject1).putShort((short)0);
    ((ByteBuffer)localObject1).putLong(a.f);
    ((ByteBuffer)localObject1).putShort((short)"6.3.1.1521".length());
    ((ByteBuffer)localObject1).put("6.3.1.1521".getBytes());
    ((ByteBuffer)localObject1).putShort((short)b);
    ((ByteBuffer)localObject1).putShort((short)c);
    if (paramInt == 64536) {}
    for (int i = 1;; i = 0)
    {
      ((ByteBuffer)localObject1).put((byte)i);
      ((ByteBuffer)localObject1).putInt(paramInt);
      localObject2 = new cq().a(0, u.s, 0);
      ...
      localObject2 = cryptor.encrypt(localByteBuffer.array(), 0, localByteBuffer.position(), a.c);
      localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = new byte[0];
      }
      localObject2 = ByteBuffer.allocate(a.c.length + 2 + 2 + localObject1.length);
      ((ByteBuffer)localObject2).putShort((short)a.c.length);
      ((ByteBuffer)localObject2).put(a.c);
  ...
  int b(int paramInt)
  {
    ...
    //   171: aload_3
    //   172: getstatic 296	oicq/wlogin_sdk/tlv_type/co:i	I
    //   175: invokevirtual 299	java/net/HttpURLConnection:setConnectTimeout	(I)V
    //   178: aload_3
    //   179: getstatic 296	oicq/wlogin_sdk/tlv_type/co:i	I
    ...
    //   195: aload_3
    //   196: aload_0
    //   197: getfield 18	oicq/wlogin_sdk/request/h:a	Loicq/wlogin_sdk/request/u;
    //   200: getfield 312	oicq/wlogin_sdk/request/u:l	I
    //   203: i2l
    ...
    //   225: aload_0
    //   226: getfield 18	oicq/wlogin_sdk/request/h:a	Loicq/wlogin_sdk/request/u;
    ...
    //   305: aload_0
    //   306: getfield 18	oicq/wlogin_sdk/request/h:a	Loicq/wlogin_sdk/request/u;
    ...
    //   355: aload_0
    //   356: getfield 18	oicq/wlogin_sdk/request/h:a	Loicq/wlogin_sdk/request/u;
