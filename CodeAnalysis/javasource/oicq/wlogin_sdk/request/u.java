...
public class u
{
  ...
  static int ac = 0;
  public static c af = null;
  protected static String ag = "";
  static report_t1 ah = new report_t1();
  public static long ai = 0L;
  public static TreeMap<Long, async_context> aj = new TreeMap();
  ...
  public WloginSigInfo a(long paramLong1, long paramLong2)
  {
    try
    {
      ...
      WloginSigInfo localWloginSigInfo = af.c(paramLong1, paramLong2);
  ...
  public void a(Context paramContext)
  {
    ...
    System.arraycopy(paramContext, 0, c, 0, paramContext.length);
  }
  ...
  public long b(String paramString)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 183	oicq/wlogin_sdk/request/u:af	Loicq/wlogin_sdk/request/c;
    //   5: aload_1
    //   6: iconst_1
    //   7: invokevirtual 578	oicq/wlogin_sdk/request/c:a	(Ljava/lang/String;Z)Loicq/wlogin_sdk/request/UinInfo;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnull +15 -> 27
    //   15: aload_1
    //   16: getfield 584	oicq/wlogin_sdk/request/UinInfo:_uin	Ljava/lang/Long;
    //   19: invokevirtual 587	java/lang/Long:longValue	()J
    //   22: lstore_2
    //   23: aload_0
    //   24: monitorexit
    //   25: lload_2
  ...
  public String e(long paramLong)
  {
    try
    {
      String str = af.a(Long.valueOf(paramLong));
      return str;
    }
    finally
    {
  ...
  public void h()
  {
    ...
    try
    {
      util.LOGD("close_connect", ad.toString());
      ad.close();
      ad = null;
      return;
    }
  ...
  public void i()
  {
    ...
    try
    {
      util.LOGD("close_transport_connect", ae.toString());
      ae.close();
      ae = null;
      return;
    }
