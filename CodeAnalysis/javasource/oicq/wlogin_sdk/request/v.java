  ...
  extends j
{
  ...
  public int c(long paramLong1, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, long paramLong2)
  {
    ...
    if ((a.d != null) && (!u.e.booleanValue()))
    {
      ...
      int j = a.d.f();
      int k = a.d.g();
      util.LOGI("bitmap:" + j + " network:" + k + " local network:" + util.get_network_type(u.r));
      int i = 0;
      if (i < 32)
      {
        if ((1 << i & j) == 0) {}
        while ((k != 0) && ((k != 1) || (util.get_network_type(u.r) != 2)))
        {
          i += 1;
          break;
        }
        ...
        l2 = util.getLogModifyTime(u.r, str);
        if (l2 != 0L) {
          break label339;
        }
      }
    ...
    for (;;)
    {
      paramArrayOfByte1 = util.readLog(u.r, str);
