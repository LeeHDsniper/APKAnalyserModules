...
public class util
{
  ...
  public static final long BUILD_TIME = 1460696337L;
  ...
  public static final String SDK_VERSION = "6.3.1.1521";
  public static final int SSO_VERSION = 5;
  public static final long SVN_VER = 1521L;
  ...
  public static boolean CheckQQMiniHD(Context paramContext)
  {
    ...
    try
    {
      LOGI(getPackageManagergetPackageInfo"com.tencent.minihd.qq"0versionName, "");
      return true;
    }
    catch (Exception paramContext) {}
    return false;
  ...
  public static void LOGI(String paramString1, String paramString2)
  {
    try
    {
      if (LOG_LEVEL >= 1)
      {
        ...
        for (;;)
        {
          b.a(u.r, paramString2, paramString1);
          return;
          if (LOGCAT_OUT) {
  ...
  public static void LOGW(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      if (LOG_LEVEL >= 0)
      {
        ...
        for (;;)
        {
          b.a(u.r, paramString3, paramString1 + ":" + paramString2);
          return;
          if (LOGCAT_OUT) {
            Log.w("wlogin_sdk" + getLineInfo(2), paramString1 + ":" + paramString2);
          }
  ...
  public static String getChannelId(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject3 = getPackageInfo0applicationInfo.sourceDir;
  ...
  public static byte[] getPkgSigFromApkName(Context paramContext, String paramString)
  {
    try
    {
      ...
      paramContext = MD5.toMD5Byte(signatures[0].toByteArray());
      return paramContext;
    }
    catch (Throwable paramContext) {}
    return new byte[0];
  ...
  public static byte[] get_file_imei(Context paramContext)
  {
    ...
    //   77: astore 5
    //   79: aload 4
    //   81: invokevirtual 715	java/io/FileInputStream:available	()I
    //   84: istore_1
    //   85: aload 4
    //   87: astore 5
    //   89: aload_2
    ...
    //   114: aload 4
    //   116: aload_2
    //   117: invokevirtual 722	java/io/FileInputStream:read	([B)I
    //   120: pop
    //   121: aload_2
    //   122: astore_3
    //   123: aload 4
    ...
    //   129: ifnull +8 -> 137
    //   132: aload 5
    //   134: invokevirtual 723	java/io/FileInputStream:close	()V
    //   137: aload_3
    //   138: ifnull +10 -> 148
    //   141: aload_3
    //   142: astore_2
    ...
    //   145: ifgt -139 -> 6
    //   148: aload_0
    //   149: invokestatic 984	oicq/wlogin_sdk/tools/util:get_saved_imei	(Landroid/content/Context;)[B
    //   152: astore_3
    //   153: aload_3
    //   154: astore_2
    //   155: aload_3
    ...
    //   166: aload_0
    //   167: aload_3
    //   168: invokestatic 988	oicq/wlogin_sdk/tools/util:save_file_imei	(Landroid/content/Context;[B)V
    //   171: aload_3
    //   172: areturn
    //   173: astore 6
    //   175: aconst_null
    ...
    //   178: aload 4
    //   180: astore_3
    //   181: getstatic 990	oicq/wlogin_sdk/request/u:W	I
    //   184: ldc_w 991
    //   187: ior
    //   188: putstatic 990	oicq/wlogin_sdk/request/u:W	I
    //   191: aload 4
    //   193: astore_3
    //   194: aload 6
    //   196: ldc -95
    //   198: invokestatic 333	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   201: aload 4
    //   203: ifnull +8 -> 211
    //   206: aload 4
    ...
    //   220: ifnull +7 -> 227
    //   223: aload_3
    //   224: invokevirtual 723	java/io/FileInputStream:close	()V
    //   227: aload_0
    //   228: athrow
    //   229: astore_2
    //   230: aload_2
    ...
    //   250: aload_2
    //   251: ldc -95
    //   253: invokestatic 333	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   256: goto -119 -> 137
    //   259: astore_0
    //   260: goto -41 -> 219
    //   263: astore 6
  ...
  public static boolean loadLibrary(String paramString, Context paramContext)
  {
    ...
    //   80: astore 4
    //   82: aload 4
    //   84: invokevirtual 777	java/io/File:exists	()Z
    //   87: ifne +142 -> 229
    //   90: new 612	java/io/File
    //   93: dup
    //   94: new 363	java/lang/StringBuilder
    //   97: dup
    //   98: invokespecial 364	java/lang/StringBuilder:<init>	()V
    //   101: aload_1
    //   102: invokevirtual 654	android/content/Context:getFilesDir	()Ljava/io/File;
    //   105: invokevirtual 1168	java/io/File:getParent	()Ljava/lang/String;
    //   108: invokevirtual 368	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   111: ldc_w 1174
    //   114: invokevirtual 368	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   117: aload_0
    ...
    //   127: invokevirtual 375	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   130: invokespecial 614	java/io/File:<init>	(Ljava/lang/String;)V
    //   133: astore_1
    //   134: aload_1
    //   135: ifnull +89 -> 224
    //   138: aload_1
    //   139: invokevirtual 777	java/io/File:exists	()Z
    //   142: ifeq +82 -> 224
    //   145: aload_1
    //   146: invokevirtual 643	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   149: invokestatic 1177	java/lang/System:load	(Ljava/lang/String;)V
    //   152: iconst_1
    //   153: istore_2
    //   154: iload_2
    //   155: istore_3
    ...
    //   157: ifne +9 -> 166
    //   160: aload_0
    //   161: invokestatic 1179	java/lang/System:loadLibrary	(Ljava/lang/String;)V
    //   164: iconst_1
    //   165: istore_3
    //   166: iload_3
    //   167: putstatic 167	oicq/wlogin_sdk/tools/util:libwtecdh_loaded	Z
    //   170: new 363	java/lang/StringBuilder
    //   173: dup
    //   174: invokespecial 364	java/lang/StringBuilder:<init>	()V
    //   177: ldc_w 1181
    //   180: invokevirtual 368	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   183: getstatic 167	oicq/wlogin_sdk/tools/util:libwtecdh_loaded	Z
    //   186: invokevirtual 1184	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   189: invokevirtual 375	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   192: ldc -95
    //   194: invokestatic 340	oicq/wlogin_sdk/tools/util:LOGI	(Ljava/lang/String;Ljava/lang/String;)V
    //   197: iload_3
    //   198: ireturn
    //   199: astore_1
    //   200: aconst_null
    ...
    //   0	235	1	paramContext	Context
    //   1	225	2	bool1	boolean
    //   155	59	3	bool2	boolean
    //   80	150	4	localFile	File
    // Exception table:
    //   from	to	target	type
    //   37	82	199	java/lang/Exception
    //   145	152	205	java/lang/UnsatisfiedLinkError
    //   160	164	211	java/lang/UnsatisfiedLinkError
    //   82	134	217	java/lang/Exception
  }
  ...
  public static void writeFile(String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   28: astore_3
    //   29: aload_3
    //   30: invokevirtual 777	java/io/File:exists	()Z
    //   33: ifne +30 -> 63
    //   36: aload_3
    //   37: invokevirtual 1352	java/io/File:getParentFile	()Ljava/io/File;
    //   40: astore 4
    //   42: aload 4
    //   44: ifnull -28 -> 16
    //   47: aload 4
    //   49: invokevirtual 1355	java/io/File:mkdirs	()Z
    //   52: ifne +11 -> 63
    //   55: aload 4
    //   57: invokevirtual 617	java/io/File:isDirectory	()Z
    //   60: ifeq -44 -> 16
    //   63: aload_0
    //   64: invokestatic 1357	oicq/wlogin_sdk/tools/util:getFileSize	(Ljava/lang/String;)I
    //   67: ldc 108
    //   69: if_icmpge -53 -> 16
    //   72: new 1266	java/io/FileOutputStream
    //   75: dup
    //   76: aload_3
    //   77: iconst_1
    //   78: invokespecial 1269	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   81: astore_0
    //   82: aload_0
    //   83: aload_1
    //   84: invokevirtual 1270	java/io/FileOutputStream:write	([B)V
    //   87: aload_0
    //   88: invokevirtual 1274	java/io/FileOutputStream:close	()V
    //   91: goto -75 -> 16
    //   94: astore_0
    //   95: goto -79 -> 16
    //   98: astore_0
