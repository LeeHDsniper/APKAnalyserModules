...
public class tcq
  implements Runnable
{
  public tcq(AppReportReceiver paramAppReportReceiver, Intent paramIntent, Context paramContext)
  {
  ...
  public void run()
  {
    try
    {
      String str1 = jdField_a_of_type_AndroidContentIntent.getAction();
      if (str1 == null) {
        return;
      }
      Object localObject3;
      ...
      {
        Object localObject1 = jdField_a_of_type_AndroidContentIntent.getExtras();
        ...
        localObject1 = ((ActivityManager)jdField_a_of_type_AndroidContentContext.getSystemService("activity")).getRunningTasks(1);
        if (((List)localObject1).size() >= 1)
        {
          localObject1 = get0topActivity.getClassName();
    ...
    catch (Throwable localThrowable)
    {
      try
      {
        ...
        if (!jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qq_mode_foreground", false))
        {
          jdField_a_of_type_ComTencentOpenBusinessBaseAppreportAppReportReceiver.a();
          return;
          ...
          if (QLog.isColorLevel())
          {
            ...
            return;
            bool = jdField_a_of_type_AndroidContentIntent.getBooleanExtra("android.intent.extra.REPLACING", false);
            localObject2 = jdField_a_of_type_AndroidContentIntent.getDataString();
            if ((localObject2 != null) && (((String)localObject2).startsWith("package:")))
            {
              ...
              try
              {
                StaticAnalyz.a(jdField_a_of_type_AndroidContentContext.getApplicationContext(), (String)localObject2);
                do
                {
                  do
                  {
                    ...
                    BaseApplicationImpl.a().registerReceiver(jdField_a_of_type_ComTencentOpenBusinessBaseAppreportAppReportReceiver, (IntentFilter)localObject2);
