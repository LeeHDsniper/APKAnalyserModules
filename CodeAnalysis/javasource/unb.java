...
public class unb
  implements Runnable
{
  public unb(QfavHelper.AsyncFavoritesProvider paramAsyncFavoritesProvider)
  {
  ...
  public void run()
  {
    ...
    long l1 = a.a.getLong("req_opt_type", -1L);
    long l2 = a.a.getLong("req_biz_type", -1L);
    Object localObject1 = a.a.getString("req_biz_key");
    Object localObject3 = a.a.getString("req_fav_uin");
    ...
    Bundle localBundle = new Bundle(a.a);
    if (1L == l1) {
      bool3 = bool4;
    }
    do
