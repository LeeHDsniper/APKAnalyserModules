...
public class AdobeAssetPSMixPage
  extends AdobeAssetFile
{
  public AdobeAssetPackagePages _package;
  public int pageNumber;
  
  public AdobeAssetPSMixPage(String paramString, int paramInt, AdobeDCXComponent paramAdobeDCXComponent, AdobeAssetPackagePages paramAdobeAssetPackagePages)
  {
    name = paramString;
    pageNumber = paramInt;
  ...
  {
    if ((paramObject instanceof AdobeAssetPSMixPage)) {
