...
public class AdobeAssetDrawFile
  extends AdobeAssetPackagePages
{
  public AdobeAssetDrawFile() {}
  
  public AdobeAssetDrawFile(AdobeStorageResourceCollection paramAdobeStorageResourceCollection1, AdobeStorageResourceCollection paramAdobeStorageResourceCollection2)
  {
  ...
  {
    if ((paramObject instanceof AdobeAssetDrawFile)) {
    ...
    super.loadMetadata(new IAdobeRequestCompletionCallback()
    {
      public void onCompletion()
      {
        ...
        while (i < j)
        {
          ...
          if (localObject1 != null) {
            localArrayList1.add(new AdobeAssetDrawPage(((AdobeDCXManifestNode)localObject3).getName(), i, (AdobeDCXComponent)localObject1, jdField_this));
          }
          i += 1;
        }
        label242:
