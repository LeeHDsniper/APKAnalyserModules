  ...
  implements j
{
  ...
  public Bitmap a(Bitmap paramBitmap, float paramFloat)
  {
    ...
    while (i < m)
    {
      paramBitmap.add(new a(arrayOfInt, j, k, (int)paramFloat, m, i, 1));
      localArrayList.add(new a(arrayOfInt, j, k, (int)paramFloat, m, i, 2));
      i += 1;
    }
    try
    {
    ...
    implements Callable<Void>
  {
    ...
    public a(int[] paramArrayOfInt, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
    {
      a = paramArrayOfInt;
      b = paramInt1;
      c = paramInt2;
