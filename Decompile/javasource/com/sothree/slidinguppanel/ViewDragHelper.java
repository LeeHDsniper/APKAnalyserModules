      ...
      if ((mTrackingEdges & j) != 0)
      {
        ...
        else if (mDragState == 2)
        {
          ...
          if (paramMotionEvent == mCapturedView)
          {
            ...
            i = 0;
            int k;
            while ((i < j) && (mInitialMotionX != null) && (mInitialMotionY != null))
            {
              k = MotionEventCompat.getPointerId(paramMotionEvent, i);
              if ((k >= mInitialMotionX.length) || (k >= mInitialMotionY.length))
              {
                label363:
                i += 1;
              }
              else
              {
                ...
                f2 -= mInitialMotionX[k];
                f1 -= mInitialMotionY[k];
            ...
            for (;;)
            {
              ...
              break;
              label430:
              View localView = findTopChildUnder((int)mInitialMotionX[k], (int)mInitialMotionY[k]);
