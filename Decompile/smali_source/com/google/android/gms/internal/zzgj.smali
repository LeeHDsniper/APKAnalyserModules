...
.field private zzBp:Lcom/google/android/gms/ads/internal/util/client/VersionInfoParcel;

.field private zzDn:Ljava/lang/Thread$UncaughtExceptionHandler;

.field private zzDo:Ljava/lang/Thread$UncaughtExceptionHandler;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/gms/ads/internal/util/client/VersionInfoParcel;Ljava/lang/Thread$UncaughtExceptionHandler;Ljava/lang/Thread$UncaughtExceptionHandler;)V
    ...
    iput-object p3, p0, Lcom/google/android/gms/internal/zzgj;->zzDn:Ljava/lang/Thread$UncaughtExceptionHandler;

    iput-object p4, p0, Lcom/google/android/gms/internal/zzgj;->zzDo:Ljava/lang/Thread$UncaughtExceptionHandler;

    iput-object p1, p0, Lcom/google/android/gms/internal/zzgj;->mContext:Landroid/content/Context;

    iput-object p2, p0, Lcom/google/android/gms/internal/zzgj;->zzBp:Lcom/google/android/gms/ads/internal/util/client/VersionInfoParcel;

    return-void
.end method

.method public static zza(Landroid/content/Context;Ljava/lang/Thread;Lcom/google/android/gms/ads/internal/util/client/VersionInfoParcel;)Lcom/google/android/gms/internal/zzgj;
    .registers 7
    ...
    :cond_9
    invoke-static {p0}, Lcom/google/android/gms/internal/zzgj;->zzz(Landroid/content/Context;)Z
    ...
    invoke-direct {v2, p0, p2, v0, v3}, Lcom/google/android/gms/internal/zzgj;-><init>(Landroid/content/Context;Lcom/google/android/gms/ads/internal/util/client/VersionInfoParcel;Ljava/lang/Thread$UncaughtExceptionHandler;Ljava/lang/Thread$UncaughtExceptionHandler;)V

    if-eqz v0, :cond_24

    instance-of v3, v0, Lcom/google/android/gms/internal/zzgj;
...
.method private zzb(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    ...
    invoke-virtual {p0, v11}, Lcom/google/android/gms/internal/zzgj;->zzao(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v11}, Lcom/google/android/gms/internal/zzgj;->zzap(Ljava/lang/String;)Z
...
.method public uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    .prologue
    invoke-virtual {p0, p2}, Lcom/google/android/gms/internal/zzgj;->zza(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p0, p2, v0}, Lcom/google/android/gms/internal/zzgj;->zza(Ljava/lang/Throwable;Z)V
    ...
    :cond_19
    iget-object v0, p0, Lcom/google/android/gms/internal/zzgj;->zzDn:Ljava/lang/Thread$UncaughtExceptionHandler;
    ...
    :cond_23
    iget-object v0, p0, Lcom/google/android/gms/internal/zzgj;->zzDo:Ljava/lang/Thread$UncaughtExceptionHandler;
...
.method public zza(Ljava/lang/Throwable;Z)V
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/zzgj;->zzz(Landroid/content/Context;)Z
    ...
    :cond_9
    invoke-direct {p0, p1}, Lcom/google/android/gms/internal/zzgj;->zzb(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    ...
    invoke-virtual {p0, v0, p2}, Lcom/google/android/gms/internal/zzgj;->zzb(Ljava/lang/Throwable;Z)Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/google/android/gms/internal/zzgj;->zzBp:Lcom/google/android/gms/ads/internal/util/client/VersionInfoParcel;
    ...
    invoke-virtual {v4}, Lcom/google/android/gms/internal/zzhl;->zzgf()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v0, v2, v3, v1, v4}, Lcom/google/android/gms/internal/zzhu;->zza(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;)V
...
.method protected zza(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p0, v8}, Lcom/google/android/gms/internal/zzgj;->zzao(Ljava/lang/String;)Z
...
.method protected zzao(Ljava/lang/String;)Z
    .registers 6
    ...
    const-class v2, Lcom/google/android/gms/internal/zzgk;
...
.method protected zzap(Ljava/lang/String;)Z
    .registers 4
...
.method zzb(Ljava/lang/Throwable;Z)Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/google/android/gms/internal/zzhu;->zzgt()Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/google/android/gms/internal/zzgj;->mContext:Landroid/content/Context;
