...
Permission::Permission(string name,string level,string info,string description)
{
...
Permission* Manifest_Permissions::search(string name)
{
...
Permission* Manifest_Permission_Group::search(string name)
{
	Permission * search_p=NULL;
