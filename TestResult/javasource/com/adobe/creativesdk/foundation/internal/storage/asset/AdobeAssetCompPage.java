...
public class AdobeAssetCompPage
  extends AdobeAssetFile
{
  public AdobeAssetPackagePages _package;
  public int pageNumber;
  
  public AdobeAssetCompPage(String paramString, int paramInt, AdobeDCXComponent paramAdobeDCXComponent, AdobeAssetPackagePages paramAdobeAssetPackagePages)
  {
    name = paramString;
    pageNumber = paramInt;
  ...
  {
    if ((paramObject instanceof AdobeAssetCompPage)) {
