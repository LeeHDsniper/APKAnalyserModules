...
public abstract interface zzeh
  extends IInterface
{
  public abstract zzei zzab(String paramString)
    throws RemoteException;
  
  public abstract boolean zzac(String paramString)
    throws RemoteException;
    ...
    implements zzeh
  {
    ...
    public static zzeh zzE(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        paramParcel1 = zzab(paramParcel1.readString());
      ...
      paramParcel1.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IAdapterCreator");
      boolean bool = zzac(paramParcel1.readString());
      paramParcel2.writeNoException();
      if (bool) {}
      ...
      implements zzeh
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          paramString = zzei.zza.zzF(localParcel2.readStrongBinder());
          return paramString;
        }
        finally
        {
