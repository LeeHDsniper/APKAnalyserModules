 ...
 */
int getElementsByName( TiXmlNode *root, int &sum, TiXmlElement **elementsList, int size, string elemName )
{
	if ( elemName == "" )
 ...
 */
int getAttributeByName( TiXmlElement *element, TiXmlAttribute * &attr, string attrName )
{
